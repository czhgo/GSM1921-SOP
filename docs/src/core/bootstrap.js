...
import { MilestoneStore } from '../services/milestones.js?v=20260901l';
import { getAccentColors, resolveAccentRole } from './constants.js?v=20260901l';
import { CrossPageState } from './cross-page-state.js?v=20260901l';
import { getBasePath } from './utils.js?v=20260901l';
import { enhanceSelects } from '../components/custom-select.js?v=20260901l';
import { registerApiAdapter, init } from './data-adapter.js?v=20260901l';
import { ApiAdapter } from './api-adapter.js?v=20260901l';
import { getCapabilities } from './registry.js?v=20260901l';
