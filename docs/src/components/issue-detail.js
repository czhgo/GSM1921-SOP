...
import { IssueStore, issueDomainLabel, issueDomainSuggest } from '../services/issues.js?v=20260921n';
import { MilestoneStore } from '../services/milestones.js?v=20260921n';
import { AuthStore } from '../services/auth.js?v=20260921n';
import { showToast } from '../core/utils.js?v=20260921n';
import { icon } from '../core/icons.js?v=20260921n';
import { getPersonName } from '../services/person.js?v=20260921n';
import { renderReactions, bindReactions } from './reactions.js?v=20260921n';
import { ISSUE_STATUS_LABELS, ISSUE_CLOSED_REASON_LABELS } from '../core/constants.js?v=20260921n';
import { badgeHtml } from './badges.js?v=20260921n';
