...
import { ROLE_COLORS } from '../../../core/constants.js?v=20260920a';
// 活动「仍在办」口径单一源（2026-09-13 收敛）：替代手写 !archived && status!=='cancelled'
import { isActivityLive } from '../../../core/constants.js?v=20260920a';
import { flashHighlight } from '../../../core/utils.js?v=20260920a';
...
import { deriveActivityLifecycleStatus, ACTIVITY_LIFECYCLE } from '../../../components/inspector.js?v=20260920a';
...
import { listMyProjectTasks } from '../../../services/activity.js?v=20260920a';
