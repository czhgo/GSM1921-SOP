...
import { SignupStore, resolveSignupReviewer, SignupStatus, SIGNUP_ROLE_LABELS, SIGNUP_STATUS_LABELS } from '../../../services/signup.js?v=20260915f';
import { AuthStore } from '../../../services/auth.js?v=20260915f';
import { loadTaskforceReviews, addTaskforceReview } from '../../../services/review.js?v=20260915f';
import { loadInspectionRecords } from '../../../services/inspection.js?v=20260915f'; // IA-C3 收敛单写入口 2026-09-06：saveInspectionRecords 已随考察写入口移除
import { TodoStore, TodoSourceType, TodoCategory, TodoActionType } from '../../../services/todo.js?v=20260915f';
import { NoticeStore } from '../../../services/notice.js?v=20260915f';
import { mockDB, SourceType, ReviewStatus } from '../../../core/domain.js?v=20260915f'; // IA-C3 收敛单写入口 2026-09-06：ParticipationLevel 随考察写入口移除
import { persist } from '../../../core/data-adapter.js?v=20260915f';
import { showToast, escHtml as esc, getBasePath } from '../../../core/utils.js?v=20260915f';
import { generateId } from '../../../core/id.js?v=20260915f';
import { solidAccentStyle } from '../../../core/constants.js?v=20260915f';
// 活动「已结束/已归档」判据单一源（2026-09-13 收敛）：替代手写 `status === 'completed'`
import { isActivityEnded } from '../../../core/constants.js?v=20260915f';
...
import { getPersonName, PersonStore } from '../../../services/person.js?v=20260915f';
