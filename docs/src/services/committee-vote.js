...
import { persist, getAdapter, getAuthToken, getApiBaseUrl, getDataSource } from '../core/data-adapter.js?v=20260921d';
import { AuthStore } from './auth.js?v=20260921d';
import { NoticeStore } from './notice.js?v=20260921d';
import { resolveVoterIds } from './vote-config.js?v=20260921d';
