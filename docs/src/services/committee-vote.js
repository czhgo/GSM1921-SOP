...
import { persist, getAdapter, getAuthToken, getApiBaseUrl, getDataSource } from '../core/data-adapter.js?v=20260920d';
import { AuthStore } from './auth.js?v=20260920d';
import { NoticeStore } from './notice.js?v=20260920d';
import { resolveVoterIds } from './vote-config.js?v=20260920d';
