...
import { PersonStore, findRemovedRecord } from './person.js?v=20260911a';
import { RESIDENCE, getResidenceOf, saveResidenceChange, getDetainedMembers } from './roster.js?v=20260911a';
