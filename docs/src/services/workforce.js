...
import { BranchService } from './runtime.js?v=20260921l';
import { NoticeStore } from './notice.js?v=20260921l';
import { defaultVoteConfig, resolveVoterIds } from './vote-config.js?v=20260921l';
import { ROLE_LABELS } from '../core/constants.js?v=20260921l';
import { POLICY_DEFAULTS } from '../core/policy-defaults.js?v=20260921l';
import { WORK_MAP_MODULES, mergeWorkforceSnapshot, canDisableModule } from '../core/work-map.js?v=20260921l';
import { getPersonName } from './person.js?v=20260921l';
import { AuthStore } from './auth.js?v=20260921l';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260921l';
import { fetchVotesStrict } from './committee-vote.js?v=20260921l';
import { TodoStore, TodoCategory, TodoSourceType, WORK_DOMAIN } from './todo.js?v=20260921l';
