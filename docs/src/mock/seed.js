...
export const SEED_TASKS = [
  ...
  { id: 'tsk-004', activityId: 'act-3', title: '撰写活动总结', status: 'in_progress', createdAt: '2026-03-15T08:00:00Z' },
  { id: 'tsk-005', activityId: 'act-5', title: '联系共建单位确认参访安排', status: 'completed', createdAt: '2026-04-01T08:00:00Z' },
  { id: 'tsk-006', activityId: 'act-5', title: '安排车辆和午餐', status: 'pending', createdAt: '2026-04-05T08:00:00Z' },
...
export const SEED_DELIVERABLES = [
  ...
  { id: 'dlv-003', activityId: 'act-3', type: 'propaganda', owner: 'prop-commissioner', ownerName: '宣传委员', status: 'submitted', submittedAt: '2026-03-18T10:00:00Z', note: '两会精神学习宣传稿' },
  { id: 'dlv-004', activityId: 'act-5', type: 'photography_draft', owner: 'organizer', ownerName: '活动组织者', status: 'submitted', submittedAt: '2026-04-10T10:00:00Z', note: '参访活动照片' },
...
export const SEED_ASSIGNMENTS = [
  ...
  { id: 'assign_seed_004', activityId: 'act-5', workName: '拍摄活动照片', workDescription: '全程拍摄参访活动照片，活动结束后提交', ddl: '2026-04-08T00:00:00Z', assigneeId: 'p5', status: 'in_progress', createdBy: 'p3', createdAt: '2026-04-01T08:00:00Z', completedAt: null },
