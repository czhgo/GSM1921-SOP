...
- **条块二元** — "条"与"块"是理解权责关系的方式：从职能视角看，三委员按专业职能分工（条）；从单元视角看，党小组组长按小组划分（块）。谁做什么，由岗位职责定义决定，不由条块推出；书记是条块间的协调节点
- **扁平化设计** — 组织者和深度参与者之间无上下级，只是分工不同；组织者的分工记录职责是做好分工记录，深度参与者承担具体分工
