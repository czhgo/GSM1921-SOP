...
related_files:
  ...
  - .ctx/logs/archive/2026-07-mid-entries.md
---
...
> 详细内容见 [archive/2026-07-mid-entries.md](archive/2026-07-mid-entries.md)
...
| T118 | 07-19 | P.7决策归档+R7/R8反论→正例简化 | insights§4.5 | 是 |
...
| T130 | 07-22 | insights知识类型标签统一替换 | insights | 是 |
...
[经验沉淀: 是 — 验证教训已沉淀至 KNOWN_PITFALLS.md §11（Subagent 验证虚假确认陷阱）：browser_use subagent 报告"验证通过"不等于真实验证，必须要求截图确认视觉效果]
