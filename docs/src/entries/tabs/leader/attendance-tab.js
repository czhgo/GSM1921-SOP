...
import { loadActiveAttendanceRecords, canUploadAttendance, appendAttendanceRecords, loadAttendanceAppeals, resolveAttendanceAppeal, reconfirmReturnedRecord, MEETING_ATTENDANCE_TYPES } from '../../../services/attendance.js?v=20260922a';
...
import { attendanceToLong } from '../../../services/attendance.js?v=20260922a';
...
import { getMeetingRosterCandidates, getRosterStats } from '../../../services/roster.js?v=20260922a';
import { solidAccentStyle, accDarkVars } from '../../../core/constants.js?v=20260922a';
import { currentLeaderGroup } from './_shared.js?v=20260922a';
