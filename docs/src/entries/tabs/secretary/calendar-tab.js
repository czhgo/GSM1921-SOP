...
import { getAppState, setState } from '../../../core/state.js?v=20260922g';
import { showToast, escHtml as esc } from '../../../core/utils.js?v=20260922g';
import { scrollDetailIntoView } from '../../../components/detail-anchor.js?v=20260922g';
import { populateMonthSelector, renderCalendarByActivities } from '../../../components/calendar.js?v=20260922g';
import { renderInspectorFromState, _draftMaterialCount } from '../../../components/inspector.js?v=20260922g';
import { computeSecretaryStats } from '../../../services/roles.js?v=20260922g';
...
import { DecisionTreeState, renderWorkflowPanel, writeActivityWithSOP } from '../../../services/decision-tree.js?v=20260922g';
import { loadActivities, listBrandProposals } from '../../../services/activity.js?v=20260922g';
import { renderQueryView } from '../../../components/query-view.js?v=20260922g';
import { icon } from '../../../core/icons.js?v=20260922g';
import { loadAttendanceRecords } from '../../../services/attendance.js?v=20260922g';
import { liveMembers, PersonStore } from '../../../services/person.js?v=20260922g';
...
import { ACTIVITY_CLASSIFICATION, classifyActivityType, normalizeActivityType, dotDarkVars, SCENARIO_WRITE_IDS, SCENARIO_LABELS } from '../../../core/constants.js?v=20260922g';
...
import { collectAgendaRows, buildAgendaCandidates, AGENDA_CANDIDATE_GROUPS } from './agenda-form.js?v=20260922g';
import { defaultVoteConfig, isDecisionScenario, resolveVoterIds, isAnonymousForced } from '../../../services/vote-config.js?v=20260922g';
import { AuthStore } from '../../../services/auth.js?v=20260922g';
import { getBranchIdOfPerson, getBranchById, applyWorkflowBlockPolicy } from '../../../services/branch.js?v=20260922g';
// 支部文件读侧收敛点（2026-09-10）：会前草案下拉经 branch-doc 服务读取（按归属支部过滤，跨支部不可见）
import { listDocs as listBranchDocs, isAgendaDraftDoc } from '../../../services/branch-doc.js?v=20260922g';
// L3 S4（2026-09-03）：主题党日工作流块 manifest 驱动试点（入口守卫 + 表单元数据单一源）
import { BLOCK_MANIFESTS, THEME_PARTY_DAY_MANIFEST } from '../../../workflow/blocks/manifests.js?v=20260922g';
...
async function _loadAgendaCandidateSources() {
  ...
  const [{ TaskForceRecordStore }, { IssueStore }, { loadDevStageOverrides }] = await Promise.all([
    import('../../../services/taskforce.js?v=20260922g'),
    import('../../../services/issues.js?v=20260922g'),
    import('../../../services/member-confirmation.js?v=20260922g'),
  ]);
