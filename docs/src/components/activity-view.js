...
import { renderCalendarByActivities } from './calendar.js?v=20260823b';
import { _fmtDate, _currentYearMonth, flashHighlight } from '../core/utils.js?v=20260823b';
import { badgeHtml } from './badge.js?v=20260823b';
import { ROLE_COLORS, dotDarkVars } from '../core/constants.js?v=20260823b';
import { activityLifecycleBadgeHtml } from './inspector.js?v=20260823b';
