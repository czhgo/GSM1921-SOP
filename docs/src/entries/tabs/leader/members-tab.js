...
import { loadMemberProgress, blockersOf, REPORT_KIND } from '../../../services/member-progress.js?v=20260921l';
...
import { reviewStatusSectionHtml, bindReviewStatusSection } from './review-tab.js?v=20260921l';
