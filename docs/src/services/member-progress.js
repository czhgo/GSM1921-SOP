...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260922c';
import { AttendanceStatus } from '../core/domain.js?v=20260922c';
import { isApiMode } from './runtime.js?v=20260922c';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260922c';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260922c'),
      import('./attendance.js?v=20260922c'),
      import('./inspection.js?v=20260922c'),
      import('./issues.js?v=20260922c'),
    ]);
