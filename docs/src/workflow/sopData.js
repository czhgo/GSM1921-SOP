  ...
  scenarios: [
    ...
    },
    {
      ...
      tasks: [
        ...
        { taskId: '1b-5', title: '对接考勤要求与复盘底线',   executor: 'disc-commissioner',supervisor: 'leader',     timeOffset: -2, desc: '纪检委员与活动组织者直接对接，说明考勤要求与复盘底线（截止T+7），无需微信备忘录。月底将参与记录汇总提交组织委员。' },
    ...
    },
    {
      ...
      domain: 'activity', description: '主题党日子类 · 由活动组织者指定是否为品牌活动，网页支持标记',
      tasks: [
