...
test('FLOW_LINKS 键集 与 function-catalog flow id 键集双向一致（防漂移）', () => {
  const groups = grab('docs/src/core/function-catalog.js?v=20260909e', 'FUNCTION_GROUPS');
  const catalog = grab('docs/src/core/function-catalog.js?v=20260909e', 'FUNCTION_CATALOG');
  const flowLinks = grab('docs/src/core/mermaid-sources.js?v=20260909e', 'FLOW_LINKS');
