...
import { ROLE_LABELS, ROLE_COLORS } from '../../../core/constants.js?v=20260912f';
import { dutyCardHtml } from '../../../components/workforce-duty-card.js?v=20260912f';
import { SecretaryOverviewStore } from '../../../services/secretary-overview.js?v=20260912f';
// S1–S4 滞留党员设计（2026-09-06 书记已批）：书记复核卡（只读查看徽标/备注/变更留痕）
import { getDetainedMembers, getRosterStats, getResidenceOf } from '../../../services/roster.js?v=20260912f';
...
import { IssueStore, REPORT_CATEGORIES } from '../../../services/issues.js?v=20260912f';
