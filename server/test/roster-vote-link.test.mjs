...
// ⚠️ 对 docs/src 的相对 import 必须带与源码一致的 ?v=20260914m query（模块缓存键一致性，同 roster.test.mjs）。
...
import { POLICY_DEFAULTS } from '../../docs/src/core/policy-defaults.js?v=20260914m';
import {
  getMeetingRosterCandidates, getMeetingRosterIds, getRosterStats,
  saveResidenceChange, getDetainedMembers, getResidenceOf,
  RESIDENCE_KEY,
} from '../../docs/src/services/roster.js?v=20260914m';
// Q-21-3（2026-09-13）：在册状态枚举单一源 = core/constants.js（原经 roster.js 转出）
import { RESIDENCE } from '../../docs/src/core/constants.js?v=20260914m';
import { defaultVoteConfig, resolveVoterIds } from '../../docs/src/services/vote-config.js?v=20260914m';
