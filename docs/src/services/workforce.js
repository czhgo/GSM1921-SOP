...
import { WORK_MAP_MODULES, mergeWorkforceSnapshot, canDisableModule } from '../core/work-map.js?v=20260913e';
import { getPersonName } from './person.js?v=20260913e';
import { AuthStore } from './auth.js?v=20260913e';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260913e';
import { fetchVotesStrict } from './committee-vote.js?v=20260913e';
import { TodoStore, TodoCategory, TodoSourceType, WORK_DOMAIN } from './todo.js?v=20260913e';
