...
import { SignupStore, resolveSignupReviewer, SignupStatus } from '../../../services/signup.js?v=20260914i';
import { AuthStore } from '../../../services/auth.js?v=20260914i';
import { loadTaskforceReviews, addTaskforceReview } from '../../../services/review.js?v=20260914i';
import { loadInspectionRecords } from '../../../services/inspection.js?v=20260914i'; // IA-C3 收敛单写入口 2026-09-06：saveInspectionRecords 已随考察写入口移除
import { TodoStore, TodoSourceType, TodoCategory, TodoActionType } from '../../../services/todo.js?v=20260914i';
import { NoticeStore } from '../../../services/notice.js?v=20260914i';
import { mockDB, SourceType, ReviewStatus } from '../../../core/domain.js?v=20260914i'; // IA-C3 收敛单写入口 2026-09-06：ParticipationLevel 随考察写入口移除
import { persist } from '../../../core/data-adapter.js?v=20260914i';
import { showToast, escHtml as esc, getBasePath } from '../../../core/utils.js?v=20260914i';
import { generateId } from '../../../core/id.js?v=20260914i';
import { solidAccentStyle } from '../../../core/constants.js?v=20260914i';
// 活动「已结束/已归档」判据单一源（2026-09-13 收敛）：替代手写 `status === 'completed'`
import { isActivityEnded } from '../../../core/constants.js?v=20260914i';
import { icon } from '../../../core/icons.js?v=20260914i';
import { PersonPicker } from '../../../components/person-picker.js?v=20260914i';
import { recordFormShell } from '../../../components/forms.js?v=20260914i';
...
import { renderFilteredList, personKeyword, personFacets, roleLabelOf } from '../../../components/list-filter.js?v=20260914i';
