...
import { ReferencesModule } from '../modules/references.js?v=20260829l';
...
import { registerApiAdapter, setDataSource, init } from '../core/data-adapter.js?v=20260829l';
import { ApiAdapter } from '../core/api-adapter.js?v=20260829l';
