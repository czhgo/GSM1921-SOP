...
import { registerApiAdapter, init as dataInit, setDataSource, notifyDataLoaded, getAdapter, persist } from '../core/data-adapter.js?v=20260922g';
...
import { PersonStore, getPersonName } from '../services/person.js?v=20260922g';
...
import { resolveVoterIds, defaultVoteConfig, optionSetOf, isAnonymousActivity } from '../services/vote-config.js?v=20260922g';
import { fetchVotes, tallyForItem } from '../services/committee-vote.js?v=20260922g';
import { renderVoteWidget } from '../components/vote-widget.js?v=20260922g';
import { renderVoteSummary } from '../components/vote-summary-panel.js?v=20260922g';
...
import { buildAgendaCandidates, AGENDA_CANDIDATE_GROUPS } from '../entries/tabs/secretary/agenda-form.js?v=20260922g';
import { listDocs as listBranchDocs, isAgendaDraftDoc, isInstitutionDraftAgendaItem } from '../services/branch-doc.js?v=20260922g';
import { loadDevStageOverrides } from '../services/member-confirmation.js?v=20260922g';
// 品牌认定提案（2026-09-21 批次 132 · 支书口径二「提案 → 支委会通过后确定」）——判据单一源
import { listBrandProposals } from '../services/activity.js?v=20260922g';
