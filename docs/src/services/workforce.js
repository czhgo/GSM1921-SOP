...
import { defaultVoteConfig, resolveVoterIds } from './vote-config.js?v=20260908d';
import { ROLE_LABELS } from '../core/constants.js?v=20260908d';
import { POLICY_DEFAULTS } from '../core/policy-defaults.js?v=20260908d';
import { WORK_MAP_MODULES, mergeWorkforceSnapshot } from '../core/work-map.js?v=20260908d';
import { getPersonName } from './person.js?v=20260908d';
import { AuthStore } from './auth.js?v=20260908d';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260908d';
import { fetchVotesStrict } from './committee-vote.js?v=20260908d';
