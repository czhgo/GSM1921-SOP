...
} from '../../docs/src/core/work-map.js?v=20260922b';
import { sanitizeConfigWorkforce } from '../../docs/src/core/config-clean.js?v=20260922b';
import { ROLE_KEYS, ROLE_PAGE_MAP } from '../../docs/src/core/constants.js?v=20260922b';
