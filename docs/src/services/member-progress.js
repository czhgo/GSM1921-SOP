...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260919k';
import { AttendanceStatus } from '../core/domain.js?v=20260919k';
import { isApiMode } from './runtime.js?v=20260919k';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260919k';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260919k'),
      import('./attendance.js?v=20260919k'),
      import('./inspection.js?v=20260919k'),
      import('./issues.js?v=20260919k'),
    ]);
