...
import { ReferencesModule } from '../modules/references.js?v=20260913v';
import { renderSidebar } from '../components/sidebar.js?v=20260913v';
import { renderHeader } from '../components/header.js?v=20260913v';
import { BranchService } from '../services/runtime.js?v=20260913v'; // 注册 mock/api 适配器 + BranchService 绑定（loadDB）
