...
import { NoticeStore, resolveNoticeUrl, canReadNotice } from '../services/notice.js?v=20260921d';
...
import { declareOnlineAttend } from '../services/attendance.js?v=20260921d';
