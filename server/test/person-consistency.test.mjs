...
import { PEOPLE } from '../../docs/src/mock/people.js?v=20260922d';
import { MOCK_ACCOUNTS } from '../../docs/src/mock/accounts.js?v=20260922d';
import { ACTIVITIES } from '../../docs/src/mock/activities.js?v=20260922d';
import { ATTENDANCE_RECORDS } from '../../docs/src/mock/attendance.js?v=20260922d';
import { INSPECTION_RECORDS } from '../../docs/src/mock/inspection.js?v=20260922d';
import { THOUGHT_REPORTS } from '../../docs/src/mock/thought-reports.js?v=20260922d';
import { REVIEW_RECORDS, TASKFORCE_REVIEW_RECORDS } from '../../docs/src/mock/review.js?v=20260922d';
import { MOCK_TASKFORCES } from '../../docs/src/mock/taskforces.js?v=20260922d';
import { SEED_ASSIGNMENTS, SEED_SIGNUPS } from '../../docs/src/mock/seed.js?v=20260922d';
