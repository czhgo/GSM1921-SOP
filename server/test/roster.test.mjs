...
import { POLICY_DEFAULTS } from '../../docs/src/core/policy-defaults.js?v=20260922l';
import {
...
import { defaultVoteConfig, resolveVoterIds } from '../../docs/src/services/vote-config.js?v=20260922l';
