...
import { loadAttendanceRecords, loadActiveAttendanceRecords } from './attendance.js?v=20260915d';
import { loadActivities } from './activity.js?v=20260915d';
import { loadInspectionRecords, getOverdueRecords } from './inspection.js?v=20260915d';
import { TaskForceRecordStore } from './taskforce.js?v=20260915d';
import { loadActivityReviews, loadActiveActivityReviews } from './review.js?v=20260915d';
import { NoticeStore } from './notice.js?v=20260915d';
import { TodoStore, seedTodos, TodoCategory, TodoActionType, REALTIME_GROUP_DOMAIN, WORK_DOMAIN } from './todo.js?v=20260915d';
import { tokenOf } from '../core/version-token.js?v=20260915d'; // P0 域缓存失效（spec §二.3/§二.4）
import { PEOPLE } from '../mock/index.js?v=20260915d';
import { getPersonById } from './person.js?v=20260915d';
import { ROLE_LABELS, isActivityEnded, isActivityArchived } from '../core/constants.js?v=20260915d';
import { mockDB, AttendanceStatus, ReviewStatus } from '../core/domain.js?v=20260915d';
