...
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260922b';
import { NoticeStore } from '../services/notice.js?v=20260922b';
import { SignupStore, canCloseActivitySignup, closeActivitySignup, SignupStatus } from '../services/signup.js?v=20260922b';
...
import { canProposeBrand, brandProposalOf, proposeBrandDesignation, withdrawBrandProposal, revokeBrandDesignation } from '../services/activity.js?v=20260922b';
// 追加复盘要求（2026-09-21 批次 135 · 裁定二「按推荐档落」）：支委会可额外要求本场组织者完成复盘；
// 判据与写口单一源 = services/activity.js；另有「交回状态」须读该场复盘记录（services/review.js）。
import { reviewRequestOf, isReviewReturned, isReviewRequestEligibleActivity, requestOrganizerReview, withdrawReviewRequest } from '../services/activity.js?v=20260922b';
import { loadActivityReviews } from '../services/review.js?v=20260922b';
import { getBasePath, escHtml as esc, showToast } from '../core/utils.js?v=20260922b';
import { getActivityTypeColors } from '../core/constants.js?v=20260922b';
import { getAppState } from '../core/state.js?v=20260922b';
import { badgeHtml } from '../components/badges.js?v=20260922b';
// 活动生命周期展示态单一源（2026-09-13 收敛）：徽章/文案不得本地另写一套中文状态映射
import { activityLifecycleBadgeHtml } from '../components/inspector.js?v=20260922b';
import { enhanceSelects } from '../components/custom-select.js?v=20260922b';
import { canSignup as _canSignup, renderSignupSection, renderSignupList, bindSignupEvents, roleLabel } from '../components/signup-panel.js?v=20260922b';
import { renderShareButtonHtml, bindShareButton } from '../components/share-button.js?v=20260922b';
import { renderVoteWidget } from '../components/vote-widget.js?v=20260922b';
import { fetchVotes } from '../services/committee-vote.js?v=20260922b';
// SOP-B-2（批次 83）：本页必须先 hydrate API 数据源再渲染——见 _hydrateData 注释
import { registerApiAdapter, init as dataInit, setDataSource, notifyDataLoaded } from '../core/data-adapter.js?v=20260922b';
import { ApiAdapter } from '../core/api-adapter.js?v=20260922b';
// 批次 123：「关闭报名」后按批次 49「存好了才报成功」同一口径——先结算在途落库再刷新
import { settleWrites } from '../core/pending-writes.js?v=20260922b';
