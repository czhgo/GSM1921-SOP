...
import { fetchVotesStrict, presentIdsForItem, tallyForItem } from './committee-vote.js?v=20260921l';
...
import { isInstitutionDoc, applyInstitutionAgendaResult } from './branch-doc.js?v=20260921l';
...
import { commitBrandDesignationResult } from './activity.js?v=20260921l';
