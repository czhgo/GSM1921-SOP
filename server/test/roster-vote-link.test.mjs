...
// ⚠️ 对 docs/src 的相对 import 必须带与源码一致的 ?v=20260914e query（模块缓存键一致性，同 roster.test.mjs）。
...
import { RESIDENCE } from '../../docs/src/core/constants.js?v=20260914e';
import { defaultVoteConfig, resolveVoterIds } from '../../docs/src/services/vote-config.js?v=20260914e';
