...
import { showToast, escHtml as esc, flashHighlight } from '../../../core/utils.js?v=20260912a';
...
import { TodoStore, seedTodos, TodoCategory, REALTIME_GROUP_DOMAIN, WORK_DOMAIN, WORK_DOMAIN_LABELS, realtimeGroupDomainOf, urgeRolesOf } from '../../../services/todo.js?v=20260912a';
import { SecretaryTodoDeriver } from '../../../services/secretary-overview.js?v=20260912a';
import { badgeHtml } from '../../../components/badges.js?v=20260912a';
import { loadAttendanceRecords, saveAttendanceRecords } from '../../../services/attendance.js?v=20260912a';
import { loadInspectionRecords, saveInspectionRecords } from '../../../services/inspection.js?v=20260912a';
import { updateActivityReview, loadActivityReviews, renderActivityReviewFormHtml, submitActivityReviewForm } from '../../../services/review.js?v=20260912a';
...
import { getPersonById, getPersonName, PersonStore } from '../../../services/person.js?v=20260912a';
import { solidAccentStyle, ROLE_LABELS, isArchiveFallbackPage } from '../../../core/constants.js?v=20260912a';
...
import { TaskForceRecordStore, createTaskforceVoteActivity, findTaskforceVoteActivity } from '../../../services/taskforce.js?v=20260912a';
import { fetchVotes } from '../../../services/committee-vote.js?v=20260912a';
import { resolveVoterIds } from '../../../services/vote-config.js?v=20260912a';
import { renderReportInboxHtml, bindReportInbox } from '../../../components/reporting.js?v=20260912a';
...
import { buildOverdueRemindGroupNow } from '../../../services/resolution-followup.js?v=20260912a';
...
import { listPendingConfirmations, decideConfirmation, shouldShowSemesterDetainedRemind, semesterDetainedWindowsLabel, MC_ACTION_LABEL } from '../../../services/member-confirmation.js?v=20260912a';
import { getDetainedMembers, getResidenceOf } from '../../../services/roster.js?v=20260912a';
import { AuthStore } from '../../../services/auth.js?v=20260912a';
// 逐条催办（2026-09-10 书记裁定）：复用 NoticeStore 通知链路（按责任角色定向通知，不改数据模型）
import { NoticeStore, NOTICE_MODULE_ROLE_PAGES } from '../../../services/notice.js?v=20260912a';
