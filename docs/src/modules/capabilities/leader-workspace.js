...
registerCapability({
  ...
  tabs: () => [
    ...
    { id: 'todo', label: '待办', groupLabel: '工作台', render: (ctx) => import('../../entries/tabs/leader/todo-tab.js?v=20260903c').then(m => m.renderContent(ctx)) },
    { id: 'overview', label: '工作概况', groupLabel: '工作台', render: (ctx) => import('../../entries/tabs/leader/overview-tab.js?v=20260903c').then(m => m.renderContent(ctx)) },
    ...
    { id: 'review', label: '复盘提交', groupLabel: '党建', render: (ctx) => import('../../entries/tabs/leader/review-tab.js?v=20260903c').then(m => m.renderContent(ctx)) },
    ...
    { id: 'my-dispatch', label: '我的处置', groupLabel: '反馈', render: (ctx) => import('../../entries/tabs/leader/my-dispatch-tab.js?v=20260903c').then(m => m.renderContent(ctx)) },
  ],
});
