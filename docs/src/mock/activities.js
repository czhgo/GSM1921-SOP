export const ACTIVITIES = [
  ...
  { id: 'act-19', title: '7月组织生活会', date: '2026-07-19', type: '党小组会', organizer: 'p4', direction: 'top-down', location: '光华1号楼203会议室', status: 'completed', scenarioId: 'party-group-meeting', domain: 'party-building', assignments: [{ personId: 'p4', role: 'organizer' }, { personId: 'p1', role: 'deep' }, { personId: 'p2', role: 'deep' }, { personId: 'p3', role: 'deep' }] },
