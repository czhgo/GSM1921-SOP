...
import { loadActiveAttendanceRecords, loadAttendanceRecords, saveAttendanceRecords } from '../../../services/attendance.js?v=20260901l';
import { loadMakeupTasks } from '../../../services/makeup.js?v=20260901l';
...
import { getPersonById, getPersonName, PEOPLE, attendanceToLong } from '../../../mock/index.js?v=20260901l';
...
import { solidAccentStyle, accDarkVars } from '../../../core/constants.js?v=20260901l';
import { currentLeaderGroup } from './_shared.js?v=20260901l';
