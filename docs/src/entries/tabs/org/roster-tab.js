...
import { getRosterStats, getResidenceOf } from '../../../services/roster.js?v=20260922d';
import { listPendingConfirmations } from '../../../services/member-confirmation.js?v=20260922d';
import { DEVELOP_STAGE_OPTIONS } from '../../../services/org-base-data-preview.js?v=20260922d';
...
import { ROLE_LABELS, RESIDENCE } from '../../../core/constants.js?v=20260922d';
import { showToast, escHtml as esc, getBasePath } from '../../../core/utils.js?v=20260922d';
import { openModal, closeModal, openFormModal } from '../../../components/modal.js?v=20260922d';
// 统一成员档案编辑模态（成员名册行内「编辑」入口；模态内按字段分流：档案属性立即生效 / 制度变更报支书确认）
import { openPersonEditModal } from '../../../components/person-edit-modal.js?v=20260922d';
// 纯逻辑（可单测）：新增表单校验
import { validateMemberForm } from '../../../services/roster-ui-logic.js?v=20260922d';
...
} from '../../../services/member-flow.js?v=20260922d';
...
import { getBranchIdOfPerson } from '../../../services/branch.js?v=20260922d';
