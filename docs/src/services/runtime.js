...
import * as mockService from './mock.js?v=20260922a';
import { registerMockAdapter, registerApiAdapter, setDataSource, getDataSource } from '../core/data-adapter.js?v=20260922a';
