...
import { dotDarkVars } from '../core/constants.js?v=20260920c';
import { flashHighlight, showToast } from '../core/utils.js?v=20260920c';
import { anchorDetailToTrigger } from './detail-anchor.js?v=20260920c';
