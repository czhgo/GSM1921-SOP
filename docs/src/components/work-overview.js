...
import { showToast, flashHighlight } from '../core/utils.js?v=20260901g';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260901g';
import { IssueStore, REPORT_CATEGORIES } from '../services/issues.js?v=20260901g';
import { AuthStore } from '../services/auth.js?v=20260901g';
import { solidAccentStyle, dotDarkVars } from '../core/constants.js?v=20260901g';
import { loadActivities } from '../services/activity.js?v=20260901g';
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260901g';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260901g';
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260901g';
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260901g';
import { PEOPLE } from '../mock/people.js?v=20260901g';
import { getPersonName } from '../mock/index.js?v=20260901g';
import { AttendanceStatus } from '../core/domain.js?v=20260901g';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260901g');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260901g');
