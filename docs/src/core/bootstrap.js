...
import { renderSidebar } from '../components/sidebar.js?v=20260829l';
import { renderHeader } from '../components/header.js?v=20260829l';
import { AuthStore } from '../services/auth.js?v=20260829l';
import { IssueStore } from '../services/issues.js?v=20260829l';
import { MilestoneStore } from '../services/milestones.js?v=20260829l';
import { getAccentColors, resolveAccentRole } from './constants.js?v=20260829l';
import { CrossPageState } from './cross-page-state.js?v=20260829l';
import { getBasePath } from './utils.js?v=20260829l';
import { enhanceSelects } from '../components/custom-select.js?v=20260829l';
import { registerApiAdapter, init } from './data-adapter.js?v=20260829l';
import { ApiAdapter } from './api-adapter.js?v=20260829l';
import { getCapabilities } from './registry.js?v=20260829l';
// M4 数据源注册化：副作用导入触发 mock/api 数据源能力注册，bootstrap 经注册表选择数据源
import '../modules/capabilities/data-source.js?v=20260829l';
