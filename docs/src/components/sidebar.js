...
import { ACCENT_COLORS, ACCENT_PALETTE, resolveAccentRole } from '../core/constants.js?v=20260901j';
import { getThemePreference, setThemePreference, initTheme } from '../core/theme.js?v=20260901j';
import { readLoginSnapshot } from '../core/login-snapshot.js?v=20260901j';
import { DEPLOY_MODE } from '../config/deploy.js?v=20260901j';
...
function loadAuth() {
  if (!_authModule) _authModule = import('../services/auth.js?v=20260901j');
  return _authModule;
}
function loadPopover() {
  if (!_popoverModule) _popoverModule = import('./workspace-popover.js?v=20260901j');
