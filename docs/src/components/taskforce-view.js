...
import { dotDarkVars } from '../core/constants.js?v=20260920d';
import { flashHighlight, showToast } from '../core/utils.js?v=20260920d';
import { anchorDetailToTrigger } from './detail-anchor.js?v=20260920d';
