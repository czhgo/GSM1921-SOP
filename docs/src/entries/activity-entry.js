...
import { SignupStore } from '../services/signup.js?v=20260919j';
import { AuthStore } from '../services/auth.js?v=20260919j';
import { getPersonById } from '../services/person.js?v=20260919j';
import { getBasePath, escHtml as esc } from '../core/utils.js?v=20260919j';
import { getActivityTypeColors } from '../core/constants.js?v=20260919j';
import { getAppState } from '../core/state.js?v=20260919j';
...
import { canSignup as _canSignup, renderSignupSection, renderSignupList, bindSignupEvents, roleLabel } from '../components/signup-panel.js?v=20260919j';
import { renderShareButtonHtml, bindShareButton } from '../components/share-button.js?v=20260919j';
import { renderVoteWidget } from '../components/vote-widget.js?v=20260919j';
