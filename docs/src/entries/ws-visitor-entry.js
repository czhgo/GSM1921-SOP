...
import { PEOPLE } from '../mock/index.js?v=20260811a';
import { loadWorkspaceData } from '../core/data-loader.js?v=20260811a';
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260811a';
import { loadActiveInspectionRecords } from '../services/inspection.js?v=20260811a';
import { inspectionToDisplay } from '../mock/index.js?v=20260811a';
import { loadActivities } from '../services/activity.js?v=20260811a';
import { getActivityTypeColors, ROLE_COLORS } from '../core/constants.js?v=20260811a';
...
import { TodoStore, seedTodos, VisitorTodoDeriver } from '../services/todo.js?v=20260811a';
