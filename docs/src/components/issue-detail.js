...
import { IssueStore, issueDomainLabel, issueDomainSuggest } from '../services/issues.js?v=20260922d';
...
import { renderReactions, bindReactions } from './reactions.js?v=20260922d';
import { ISSUE_STATUS_LABELS, ISSUE_CLOSED_REASON_LABELS } from '../core/constants.js?v=20260922d';
