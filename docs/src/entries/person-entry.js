...
import { ROLE_LABELS, SECRETARY_AND_DEPUTY_ROLES, RESIDENCE } from '../core/constants.js?v=20260915d';
import { getBasePath, escHtml as esc, fmtDt } from '../core/utils.js?v=20260915d';
import { badgeHtml } from '../components/badges.js?v=20260915d';
import { countThoughtReportsByPerson } from '../services/thought-report.js?v=20260915d';
