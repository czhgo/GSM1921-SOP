...
import { renderCalendarByActivities } from './calendar.js?v=20260920g';
import { _fmtDate, _currentYearMonth, flashHighlight, downloadCSV, showToast, escHtml as esc } from '../core/utils.js?v=20260920g';
import { badgeHtml } from './badges.js?v=20260920g';
import { ROLE_COLORS, dotDarkVars, isActivityArchived } from '../core/constants.js?v=20260920g';
import { activityLifecycleBadgeHtml } from './inspector.js?v=20260920g';
...
import { renderVoteWidget } from './vote-widget.js?v=20260920g';
