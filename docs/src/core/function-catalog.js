...
export const FUNCTION_CATALOG = [
  ...
  { id: 'makeup', name: '补课制度', group: '党建', role: 'disc', tab: 'mailbox', desc: '缺勤成员通过补课任务恢复考勤状态', usage: '纪检委员工作台 → 制度与文本（补课制度分段）→ 提交补课任务 → 完成回写考勤', related: ['attendance-mgmt', 'flow-makeup'], generic: false, kind: 'feature' },
  ...
  { id: 'mailbox', name: '公邮管理', group: '宣传与档案', role: 'disc', tab: 'mailbox', desc: '支部公邮登录与邮件处理入口', usage: '纪检委员工作台 → 制度与文本（公邮分段）', related: [], generic: false, kind: 'feature' },
  ...
  { id: 'ws-org', name: '组织委员工作台', group: '角色工作台', role: 'org', desc: '今天/待办/工作概况/考察上传/思想汇报初阅/专班管理/成员名册/人才库/发展数据/知情查看/我的处置（11 tab；思想汇报初阅前移——D8 裁决批二 2026-09-08）', usage: '登录 → 组织委员工作台', related: ['taskforce-recruit', 'development', 'talent', 'thought-report', 'todo'], generic: true, kind: 'feature' },
  ...
  { id: 'ws-disc', name: '纪检委员工作台', group: '角色工作台', role: 'disc', desc: '今天/待办/工作概况/考勤管理/活动监督复盘/考察管理/制度与文本/知情查看/我的处置（9 tab；2026-09-14 批次 25 同质薄壳合并——公邮与补课合并为「制度与文本」、专班与活动知情合并为「知情查看」）', usage: '登录 → 纪检委员工作台', related: ['attendance-mgmt', 'makeup', 'mailbox', 'review', 'todo'], generic: true, kind: 'feature' },
  { id: 'ws-leader', name: '党小组组长工作台', group: '角色工作台', role: 'leader', desc: '今天/待办/工作概况/活动管理/考勤上传/考察上传/组员进展（含本组复盘状态）/知情查看/我的处置（9 tab；复盘状态并入组员进展——复盘提交已归组织者/深度参与者，D8 裁决批二 2026-09-08）', usage: '登录 → 党小组组长工作台', related: ['activity-create', 'attendance-personal', 'review', 'todo'], generic: true, kind: 'feature' },
