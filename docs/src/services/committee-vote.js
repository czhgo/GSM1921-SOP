...
import { persist, getAdapter, getAuthToken, getApiBaseUrl, getDataSource } from '../core/data-adapter.js?v=20260915f';
import { AuthStore } from './auth.js?v=20260915f';
import { NoticeStore } from './notice.js?v=20260915f';
import { resolveVoterIds } from './vote-config.js?v=20260915f';
