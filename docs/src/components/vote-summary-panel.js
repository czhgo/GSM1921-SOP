...
import { fetchVotes, lockVotes, votedCountOf, tallyOf } from '../services/committee-vote.js?v=20260914o';
import { optionSetOf, isAnonymousActivity } from '../services/vote-config.js?v=20260914o';
...
} from './resolution-followup-manager.js?v=20260914o';
