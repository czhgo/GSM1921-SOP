...
import { registerMockAdapter, setDataSource } from '../../docs/src/core/data-adapter.js?v=20260921f';
import { createBranch, getBranchById } from '../../docs/src/services/branch.js?v=20260921f';
import { PersonStore } from '../../docs/src/services/person.js?v=20260921f';
import { appointInauguralOfficers } from '../../docs/src/services/appointment.js?v=20260921f';
