...
import { loadThoughtReports } from '../../../services/thought-report.js?v=20260912d';
import { PersonStore } from '../../../services/person.js?v=20260912d';
// 数据域接线收口（2026-09-03）：支部成员名单经 services/person.js 获取（原直连 mock PEOPLE）
import { getResidenceOf, RESIDENCE } from '../../../services/roster.js?v=20260912d';
// B5（2026-09-12）：搜索 + 阶段/党小组筛选复用名册枚举（PARTY_GROUP_OPTIONS 单一源）
import { PARTY_GROUP_OPTIONS } from '../../../services/org-base-data-preview.js?v=20260912d';
import { listPendingConfirmations, lastApprovedStageChange } from '../../../services/member-confirmation.js?v=20260912d';
import { escHtml as esc, flashHighlight } from '../../../core/utils.js?v=20260912d';
