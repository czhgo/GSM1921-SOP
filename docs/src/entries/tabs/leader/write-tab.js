...
import { setState, getAppState } from '../../../core/state.js?v=20260914m';
import { BranchService } from '../../../services/runtime.js?v=20260914m';
import { DecisionTreeState, DECISION_TREE_CONFIGS, renderWorkflowPanel, writeActivityWithSOP, hostGroups as buildHostGroupOptions } from '../../../services/decision-tree.js?v=20260914m';
...
import { mockDB, OutputType, deriveOutputRoute } from '../../../core/domain.js?v=20260914m';
import { persist } from '../../../core/data-adapter.js?v=20260914m';
import { PersonPicker } from '../../../components/person-picker.js?v=20260914m';
import { recordFormShell } from '../../../components/forms.js?v=20260914m';
import { getBranchIdOfPerson, getBranchOutputBlocks, applyOutputBlockPolicy } from '../../../services/branch.js?v=20260914m';
import { badgeHtml } from '../../../components/badges.js?v=20260914m';
// 活动生命周期展示态单一源（草稿/已发布/进行中/待归档/已执行/已归档/已取消）——勿在本文件另造中文标签
import { activityLifecycleBadgeHtml } from '../../../components/inspector.js?v=20260914m';
import { showToast, escHtml } from '../../../core/utils.js?v=20260914m';
import { solidAccentStyle, accDarkVars, accDarkParts, OUTPUT_BLOCK_DEFS, isActivityEnded, ACTIVITY_SUBTYPES, normalizeActivityType } from '../../../core/constants.js?v=20260914m';
import { filterByRole, getCurrentLeaderId, currentLeaderGroup } from './_shared.js?v=20260914m';
