...
import { MOCK_TASKFORCES } from '../mock/index.js?v=20260920b';
import { isInitStateActive } from './init-reset.js?v=20260920b'; // C2 修复（2026-09-08）：init 态跳过演示种子兜底
import { getPersonName, liveMembers } from './person.js?v=20260920b';
import { evaluateWorkforceVotes } from './workforce.js?v=20260920b';
...
import { BranchService } from './runtime.js?v=20260920b';
import { NoticeStore } from './notice.js?v=20260920b';
import { defaultVoteConfig, resolveVoterIds } from './vote-config.js?v=20260920b';
import { loadActivities } from './activity.js?v=20260920b';
import { AuthStore } from './auth.js?v=20260920b';
import { BRANCH_COMMISSION_ROLES } from '../core/constants.js?v=20260920b'; // 支委层应到名单单一源（勿手写）
