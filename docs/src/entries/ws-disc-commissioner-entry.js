import { setState, registerRenderCallback } from '../core/state.js?v=20260808l';
import { showToast } from '../core/utils.js?v=20260808l';
import { CrossPageState } from '../core/cross-page-state.js?v=20260808l';
import { bootstrapPage } from '../core/bootstrap.js?v=20260808l';
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS, ReviewStatus, SourceType, OutputType, deriveOutputRoute } from '../core/domain.js?v=20260808l';
import { persist } from '../core/data-adapter.js?v=20260808l';
import { attendanceToLong, attendanceToWide, inspectionToLong, inspectionToWide, reviewToDisplay, getPersonName } from '../mock/index.js?v=20260808l';
import { loadWorkspaceData } from '../core/data-loader.js?v=20260808l';
import { renderTabBar } from '../components/tab-bar.js?v=20260808l';
import { openFormModal } from '../components/modal.js?v=20260808l';
import { autoGenerateMakeupTask, loadMakeupTasks, saveMakeupTasks } from '../services/makeup.js?v=20260808l';
import { loadAttendanceRecords, loadActiveAttendanceRecords, saveAttendanceRecords } from '../services/attendance.js?v=20260808l';
import { loadInspectionRecords, loadActiveInspectionRecords, getOverdueRecords, confirmInspectionRecord, deleteInspectionRecord, getRecordsBySource } from '../services/inspection.js?v=20260808l';
...
import { loadActivityReviews, loadActiveActivityReviews, loadTaskforceReviews, updateReviewById } from '../services/review.js?v=20260808l';
...
import { TodoStore, TodoSourceType, TodoCategory, TodoActionType, seedTodos } from '../services/todo.js?v=20260808l';
import { enhanceSelects } from '../components/custom-select.js?v=20260808l';
