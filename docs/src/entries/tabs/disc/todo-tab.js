...
import { TodoSourceType, TodoCategory, TodoActionType, seedTodos, REALTIME_GROUP_DOMAIN } from '../../../services/todo.js?v=20260921o';
import { createTodoTab } from '../../../components/todo-tab-shell.js?v=20260921o';
...
import { loadActiveInspectionRecords } from '../../../services/inspection.js?v=20260921o';
...
function _handleTodoAction(todo) {
  ...
  if (target) {
    ...
    if (target.segment) {
      ...
      import('../../../entries/tabs/disc/attendance-tab.js?v=20260921o')
