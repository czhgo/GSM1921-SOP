...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260922d';
import { AttendanceStatus } from '../core/domain.js?v=20260922d';
import { isApiMode } from './runtime.js?v=20260922d';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260922d';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260922d'),
      import('./attendance.js?v=20260922d'),
      import('./inspection.js?v=20260922d'),
      import('./issues.js?v=20260922d'),
    ]);
