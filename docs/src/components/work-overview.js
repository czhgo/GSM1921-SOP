...
import { showToast, flashHighlight } from '../core/utils.js?v=20260901e';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260901e';
import { IssueStore, REPORT_CATEGORIES } from '../services/issues.js?v=20260901e';
import { AuthStore } from '../services/auth.js?v=20260901e';
import { solidAccentStyle, dotDarkVars } from '../core/constants.js?v=20260901e';
import { loadActivities } from '../services/activity.js?v=20260901e';
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260901e';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260901e';
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260901e';
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260901e';
import { PEOPLE } from '../mock/people.js?v=20260901e';
import { getPersonName } from '../mock/index.js?v=20260901e';
import { AttendanceStatus } from '../core/domain.js?v=20260901e';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260901e');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260901e');
