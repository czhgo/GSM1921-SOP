...
import { BranchService } from './runtime.js?v=20260921f';
import { NoticeStore } from './notice.js?v=20260921f';
import { defaultVoteConfig, resolveVoterIds } from './vote-config.js?v=20260921f';
import { ROLE_LABELS } from '../core/constants.js?v=20260921f';
import { POLICY_DEFAULTS } from '../core/policy-defaults.js?v=20260921f';
import { WORK_MAP_MODULES, mergeWorkforceSnapshot, canDisableModule } from '../core/work-map.js?v=20260921f';
import { getPersonName } from './person.js?v=20260921f';
import { AuthStore } from './auth.js?v=20260921f';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260921f';
import { fetchVotesStrict } from './committee-vote.js?v=20260921f';
import { TodoStore, TodoCategory, TodoSourceType, WORK_DOMAIN } from './todo.js?v=20260921f';
