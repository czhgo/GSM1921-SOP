...
const home = await page.evaluate(async () => {
  const reg = await import('/src/core/registry.js?v=20260829f');
  await import('/src/modules/capabilities/data-source.js?v=20260829f');
  await import('/src/modules/capabilities/sop-scenarios.js?v=20260829f');
  const cal = await import('/src/components/calendar.js?v=20260829f');
