...
import { ROLE_LABELS, ROLE_PAGE_MAP } from '../core/constants.js?v=20260901t';
import { PEOPLE, getPersonById, getPersonName } from '../mock/index.js?v=20260901t';
import { mockDB } from '../core/domain.js?v=20260901t';
import { NoticeStore } from './notice.js?v=20260901t';
import { updateActivity } from './mock.js?v=20260901t';
import { TaskForceRecordStore } from './taskforce.js?v=20260901t';
import { persist } from '../core/data-adapter.js?v=20260901t';
import { enableApiMode } from './runtime.js?v=20260901t';
