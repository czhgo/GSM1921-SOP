...
import { createWorkspaceShell } from '../components/workspace-shell.js?v=20260901l';
import { renderReportEntryHtml, bindReportEntry } from '../components/report-entry.js?v=20260901l';
...
import { seedTodos } from '../services/todo.js?v=20260901l';
import { solidAccentStyle } from '../core/constants.js?v=20260901l';
import { openRecruitForm } from './tabs/org/taskforce-tab.js?v=20260901l';
