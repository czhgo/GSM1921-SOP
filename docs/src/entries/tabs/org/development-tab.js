...
import { liveMembers, PersonStore, getPersonName } from '../../../services/person.js?v=20260921j';
...
import { getBasePath, escHtml as esc } from '../../../core/utils.js?v=20260921j';
// SOP-B-30 / D-396：活动参与汇总（以人为第一列）——数据与考勤同源（services/attendance.js 单一读口）
import { listActivityParticipationByPerson } from '../../../services/attendance.js?v=20260921j';
