...
| fagaiwei.agent.md | "发改委" | 执行型（Worker） | 文本母本与内容层治理 | ['read', 'agent', 'edit', 'search'] | ✅ (可委派给档案馆) | sop-sync, yaml-slim |
...
| 原路径 | 新路径/处理方式 | 迁移日期 |
|--------|----------------|---------|
| governance/* | → ROADMAP.md §五/§六（整合）或删除 | 2026-05-02 |
| backlog/* | → ROADMAP.md §五（整合）或删除 | 2026-05-02 |
...
| SYSTEM_ROADMAP.md | → ROADMAP.md | 2026-05-02 |
