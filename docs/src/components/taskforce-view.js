...
import { dotDarkVars } from '../core/constants.js?v=20260914m';
import { flashHighlight, showToast } from '../core/utils.js?v=20260914m';
import { anchorDetailToTrigger } from './detail-anchor.js?v=20260914m';
