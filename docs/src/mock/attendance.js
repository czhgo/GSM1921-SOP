...
import { ACTIVITIES } from './activities.js?v=20260812d';
import { PEOPLE } from './people.js?v=20260812d';
import { AttendanceStatus, ATTENDANCE_STATUS_LABELS } from '../core/domain.js?v=20260812d';
