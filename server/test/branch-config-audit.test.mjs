...
import { CONFIG_HISTORY_MAX, CONFIG_ROLLBACK_WHAT } from '../../docs/src/core/config-clean.js?v=20260912d';
import {
...
test('② rollback：跨键/聚合留痕（branch-created/config-copied 等）拒绝；未找到定位拒绝', async () => {
  ...
  const { applyConfigCopy } = await import('../../docs/src/services/branch.js?v=20260912d');
