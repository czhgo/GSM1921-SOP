...
import { readLoginSnapshot } from '../core/login-snapshot.js?v=20260921d';
import { ROLE_LABELS, ROLE_PAGE_MAP, getAccentColors } from '../core/constants.js?v=20260921d';
import { resolveAppliedAccentRole } from '../core/theme.js?v=20260921d';
import { appearanceControlsHTML, bindAppearanceControls } from '../components/appearance-controls.js?v=20260921d';
import { icon } from '../core/icons.js?v=20260921d';
import { escHtml as esc } from '../core/utils.js?v=20260921d';
...
} from '../services/preferences.js?v=20260921d';
...
import { registerApiAdapter, setDataSource, init as dataInit } from '../core/data-adapter.js?v=20260921d';
...
import { CONFIG_ROLLBACK_KEYS } from '../core/config-clean.js?v=20260921d';
...
function loadAuth() {
  if (!_authModule) _authModule = import('../services/auth.js?v=20260921d');
  return _authModule;
}
...
async function buildMyWorkspaceModel(role, personId) {
  ...
  await import(`../modules/capabilities/${stem}-workspace.js?v=20260921d`);
  ...
  const { applyTabPolicy, getBranchIdOfPerson } = await import('../services/branch.js?v=20260921d');
...
async function renderBranchGovSection(panel, sectionId) {
  ...
  try {
    const br = await import('../services/branch.js?v=20260921d');
    ...
    if (sectionId === 'branch-info-wizard') {
      ...
      await import('../modules/capabilities/secretary-workspace.js?v=20260921d');
...
async function openWizardEmbed(panel) {
  ...
  try {
    const { mountOrgSetupWizard } = await import('../components/org-setup-wizard.js?v=20260921d');
