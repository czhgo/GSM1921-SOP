...
import { showToast, flashHighlight } from '../core/utils.js?v=20260901j';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260901j';
import { IssueStore, REPORT_CATEGORIES } from '../services/issues.js?v=20260901j';
import { AuthStore } from '../services/auth.js?v=20260901j';
import { solidAccentStyle, dotDarkVars } from '../core/constants.js?v=20260901j';
import { loadActivities } from '../services/activity.js?v=20260901j';
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260901j';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260901j';
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260901j';
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260901j';
import { PEOPLE } from '../mock/people.js?v=20260901j';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260901j');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260901j');
