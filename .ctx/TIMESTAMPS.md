...
| content/02_institution/SYSTEM_ROLE_PERMISSION.md | 2026-09-20 | — | [工程师]+[AI] | 系统角色权限矩阵（2026-09-05 自 ROLE_CLASSIFICATION.md §九 拆出：角色键全表 9a0 + 权限矩阵/赋权链 + 双轨约定 §9f；2026-09-17 增 §9j 匿名反馈查看真身权限；2026-09-20 批次 115 §9l 加「系统默认值的取齐记录」（考勤确认 / 汇总：24h→1 天、48h→2 天）与「对照项（二）：上级规定的时限下限不属支部可调」＋ 变更历史 1 行，frontmatter 同步） |
...
| content/02_institution/sop/纪检委员工作流程指南.md | 2026-09-20 | — | [用户]+[AI] | 2026-09-20 批次 116 `:175`「汇总本月出勤率 → 公示」→「**→ 交支委会（不公示、不对外）**」（依支书定案「支委会 + 当事人本人」，`D-537`），frontmatter 同步；批次 119 `:86` §2.1 补「考察同流程含**同款打回**（含申诉先核实）」（依支书定案「与纪检对齐，可打回」，`D-541`） |
...
| content/insights/党支部管理与实务经验沉淀.md | 2026-09-17 | — | [用户]+[AI] | 组织性/条块二元/专班等经验贡献 |
