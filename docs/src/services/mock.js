...
import { mockDB, SCHEMA_VERSION } from '../core/domain.js?v=20260901g';
import { generateId } from '../core/id.js?v=20260901g';
import { getDataSource, persist } from '../core/data-adapter.js?v=20260901g';
...
import { ACTIVITIES } from '../mock/activities.js?v=20260901g';
import { SEED_TASKS, SEED_ASSIGNMENTS, SEED_ARCHIVE_RECORDS, SEED_SIGNUPS } from '../mock/seed.js?v=20260901g';
// Seed 增量合并用（2026-08-05，与 core/mock-adapter.js 对齐）：
// attendance.js/notices.js 为纯数据模块，无指向本文件的循环依赖
import { ATTENDANCE_RECORDS } from '../mock/attendance.js?v=20260901g';
import { MOCK_NOTICES } from '../mock/notices.js?v=20260901g';
...
export function createActivity(data) {
  return _withDelay(() => {
    ...
    if (!newItem.assignments || newItem.assignments.length === 0) {
      import('./todo.js?v=20260901g').then(({ LifecycleTodoDeriver }) => {
