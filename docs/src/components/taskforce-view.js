...
import { dotDarkVars } from '../core/constants.js?v=20260919j';
import { flashHighlight, showToast } from '../core/utils.js?v=20260919j';
import { anchorDetailToTrigger } from './detail-anchor.js?v=20260919j';
