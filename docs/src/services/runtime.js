...
import * as mockService from './mock.js?v=20260921l';
import { registerMockAdapter, registerApiAdapter, setDataSource, getDataSource } from '../core/data-adapter.js?v=20260921l';
