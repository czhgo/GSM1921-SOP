...
| 角色 | 工作台里有什么（职责页） |
|------|------------------------|
| **支书 / 副支书** | 今天、待办、全局概况（按维度/按人）、活动管理、赋权管理、通知发布、上报党委、党小组、知情查看（活动 / 专班分段）、支部分工、反馈管理（支部治理在 设置→支部治理） |
| **组织委员** | 考察上传、思想汇报（初阅）、专班管理、成员名册、人才库、发展数据、知情查看（活动 / 专班分段） |
| **宣传委员** | 宣传任务、项目看板、周报报送、档案归档 |
| **纪检委员** | 考勤管理（矩阵宽表 + 明细）、活动监督复盘、考察管理（宽表 + 明细确认）、制度与文本（补课制度 / 公邮分段）、知情查看（活动 / 专班分段） |
