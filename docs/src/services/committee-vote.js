...
import { persist, getAdapter, getAuthToken, getApiBaseUrl, getDataSource } from '../core/data-adapter.js?v=20260901y';
import { AuthStore } from './auth.js?v=20260901y';
import { NoticeStore } from './notice.js?v=20260901y';
import { resolveVoterIds } from './vote-config.js?v=20260901y';
