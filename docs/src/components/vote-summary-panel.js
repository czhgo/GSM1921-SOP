...
import { fetchVotes, lockVotes } from '../services/committee-vote.js?v=20260911a';
import { optionSetOf } from '../services/vote-config.js?v=20260911a';
...
} from './resolution-followup-manager.js?v=20260911a';
