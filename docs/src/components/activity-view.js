...
import { renderCalendarByActivities } from './calendar.js?v=20260901p';
import { _fmtDate, _currentYearMonth, flashHighlight, downloadCSV, showToast } from '../core/utils.js?v=20260901p';
import { badgeHtml } from './badge.js?v=20260901p';
import { ROLE_COLORS, dotDarkVars } from '../core/constants.js?v=20260901p';
import { activityLifecycleBadgeHtml } from './inspector.js?v=20260901p';
