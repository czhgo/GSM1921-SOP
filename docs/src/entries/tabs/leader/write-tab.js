...
import { DecisionTreeState, DECISION_TREE_CONFIGS, renderWorkflowPanel, writeActivityWithSOP } from '../../../services/decision-tree.js?v=20260912c';
import { AuthStore } from '../../../services/auth.js?v=20260912c';
import { TodoStore, TodoSourceType } from '../../../services/todo.js?v=20260912c';
import { mockDB, OutputType, deriveOutputRoute } from '../../../core/domain.js?v=20260912c';
...
import { getBranchIdOfPerson, getBranchOutputBlocks, applyOutputBlockPolicy } from '../../../services/branch.js?v=20260912c';
import { badgeHtml } from '../../../components/badges.js?v=20260912c';
import { showToast, escHtml } from '../../../core/utils.js?v=20260912c';
import { solidAccentStyle, accDarkVars, accDarkParts, OUTPUT_BLOCK_DEFS } from '../../../core/constants.js?v=20260912c';
import { filterByRole, getCurrentLeaderId, currentLeaderGroup } from './_shared.js?v=20260912c';
