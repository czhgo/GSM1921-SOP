...
import * as mockService from './mock.js?v=20260812b';
import { registerMockAdapter, registerApiAdapter, setDataSource, getDataSource } from '../core/data-adapter.js?v=20260812b';
import { MockAdapter } from '../core/mock-adapter.js?v=20260812b';
import { ApiAdapter } from '../core/api-adapter.js?v=20260812b';
