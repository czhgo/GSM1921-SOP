...
import { renderCalendarByActivities } from './calendar.js?v=20260901r';
import { _fmtDate, _currentYearMonth, flashHighlight, downloadCSV, showToast } from '../core/utils.js?v=20260901r';
import { badgeHtml } from './badge.js?v=20260901r';
import { ROLE_COLORS, dotDarkVars } from '../core/constants.js?v=20260901r';
import { activityLifecycleBadgeHtml } from './inspector.js?v=20260901r';
