...
import { getActivityTypeColors } from '../core/constants.js?v=20260901s';
import { badgeHtml } from '../components/badge.js?v=20260901s';
import { enhanceSelects } from '../components/custom-select.js?v=20260901s';
import { canSignup as _canSignup, renderSignupSection, renderSignupList, bindSignupEvents, roleLabel } from '../components/signup-panel.js?v=20260901s';
import { renderShareButtonHtml, bindShareButton } from '../components/share-button.js?v=20260901s';
import { renderVoteWidget } from '../components/vote-widget.js?v=20260901s';
import { fetchVotes } from '../services/committee-vote.js?v=20260901s';
