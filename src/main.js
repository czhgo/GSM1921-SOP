  ...
  scenarios: [
    {
      ...
      tasks: [
        ...
        { taskId: '1a-4', title: '通知到人',          executor: 'leader',           supervisor: null,         timeOffset: -3, desc: '条条组长通过党小组群发送正式会议通知，注明时间、地点、参会要求，必须提前至少3天；如需覆盖全支部，由支部书记通过党支部大群统一发布。' },
        ...
        { taskId: '1a-6d', title: '组长总结',            executor: 'leader',           supervisor: null,         timeOffset:  0, desc: '条条组长做总结发言，对本次组织生活会进行回顾与总结。' },
