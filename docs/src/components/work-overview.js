...
import { showToast, flashHighlight } from '../core/utils.js?v=20260901p';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260901p';
import { IssueStore, REPORT_CATEGORIES } from '../services/issues.js?v=20260901p';
...
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260901p';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260901p';
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260901p';
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260901p';
import { PEOPLE } from '../mock/people.js?v=20260901p';
import { getPersonName } from '../mock/index.js?v=20260901p';
import { AttendanceStatus } from '../core/domain.js?v=20260901p';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260901p');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260901p');
