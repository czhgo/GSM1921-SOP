...
import { showToast, flashHighlight } from '../core/utils.js?v=20260901m';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260901m';
import { IssueStore, REPORT_CATEGORIES } from '../services/issues.js?v=20260901m';
import { AuthStore } from '../services/auth.js?v=20260901m';
import { solidAccentStyle, dotDarkVars } from '../core/constants.js?v=20260901m';
...
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260901m';
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260901m';
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260901m';
import { PEOPLE } from '../mock/people.js?v=20260901m';
import { getPersonName } from '../mock/index.js?v=20260901m';
import { AttendanceStatus } from '../core/domain.js?v=20260901m';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260901m');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260901m');
