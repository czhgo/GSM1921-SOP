...
import { PEOPLE } from '../mock/people.js?v=20260919i';
// 成员基础数据预览叠加（立项④阶段三·目标1）：PersonStore 读取时套预览 override；
// 依赖方向单向（person → preview，preview 不 import person/roster，无循环）
import { overlayPreviewMembers } from './org-base-data-preview.js?v=20260919i';
// 双形态判定（mock/api）：data-adapter.js 为零静态依赖的叶子模块（无环）
import { getDataSource } from '../core/data-adapter.js?v=20260919i';
