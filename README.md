...
> 本节面向**普通党员和支委**，零门槛。不需要懂代码，打开网页即可操作。

### 一、推演工作台：把新活动写进日历

> 提前把活动记录下来，系统自动生成从「活动发起」到「档案归档」的全套待办清单。

1. 打开网页 **[https://czhgo.github.io/GSM1921-SOP/](https://czhgo.github.io/GSM1921-SOP/)**（或本地双击 `index.html`）
2. 点击右侧顶部的 **【推演工作台】** 页签
3. 在「活动日期」处选好活动举办日期
4. 在「活动场景」下拉框中选择本次活动类型（如：**主题党日**、**组织生活会**、**党小组会** 等）
5. 如是由党小组承办的活动，在「承办小组」处选择对应党小组（第一/二/三党小组）
6. 在「活动名称」框中输入活动名称（如：三月主题党日活动）
7. 点击 **【写入活动】** 按钮 → 日历自动标注活动，并生成所有任务节点的倒计时清单

### 二、参考指南：查自己要做什么

> 按角色一键筛选，找到自己的专属待办。

1. 打开网页后，点击左侧侧边栏的角色按钮（**党支书**、**组织委员**、**宣传委员**、**纪检委员**、**党小组组长**、**活动组织者**……）
2. 系统自动筛选出仅与该角色相关的任务节点，其余人的任务自动隐藏
3. 点击任意任务卡片右侧的 **▼ 下拉箭头**，展开「做什么 / 谁来做 / 截止时间」的详细说明
4. 任务完成后，点击卡片右侧的状态下拉框，将状态改为 **【已完成】**
...
| 把新活动加进日历 | 右侧【推演工作台】→ 填日期/场景/名称 → 点【写入活动】 |
| 查阅标准流程手册 | [`knowledge/SOP/常见工作场景快速指南.md`](./knowledge/SOP/常见工作场景快速指南.md) |
| 发现流程有问题想改 | 填写 [`docs/SOP优化提案反馈卡.md`](./docs/SOP优化提案反馈卡.md) → 提交书记确认 |
...
**减负成果**：活动建设与组织建设双域职责已精简，各角色产出物聚焦核心交付，大幅降低工作负担。
