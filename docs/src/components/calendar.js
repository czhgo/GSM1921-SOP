...
import { ROLE_COLORS, getActivityColor, ACTIVITY_CATEGORY_COLORS, ACTIVITY_TYPE_LABELS, ACTIVITY_TYPE_SHORT } from '../core/constants.js?v=20260823b';
import { _fmtDate, _currentYearMonth } from '../core/utils.js?v=20260823b';
import { filterTasksByManagementRole } from './inspector.js?v=20260823b';
