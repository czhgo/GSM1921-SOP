...
import { ACTIVITIES } from '../../docs/src/mock/activities.js?v=20260911a';
...
} from '../../docs/src/services/roster.js?v=20260911a';
import { defaultVoteConfig, resolveVoterIds } from '../../docs/src/services/vote-config.js?v=20260911a';
