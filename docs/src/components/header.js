...
import { getAccentColors, resolveAccentRole, ROLE_LABELS } from '../core/constants.js?v=20260903a';
import { getBasePath } from '../core/utils.js?v=20260903a';
import { icon } from '../core/icons.js?v=20260903a';
import { DATA_CHANGED_EVENT, DATA_LOADED_EVENT } from '../core/data-adapter.js?v=20260903a';
import { badgeHtml } from './badge.js?v=20260903a';
import { readLoginSnapshot } from '../core/login-snapshot.js?v=20260903a';
// P1 党委后台（2026-09-02）：header 品牌软编码——标题随支部配置档案更换（person→branchId→branches.config.headerTitle）
import { getHeaderTitle } from '../services/branch.js?v=20260903a';
...
function loadAuth() {
  if (!_authModule) _authModule = import('../services/auth.js?v=20260903a');
  return _authModule;
}
function loadNotice() {
  if (!_noticeModule) _noticeModule = import('../services/notice.js?v=20260903a');
