...
export { labelHtml, errorHtml, textField, textareaField, selectField, dateField } from './form-field.js?v=20260921m';
export { recordFormShell } from './form-shell.js?v=20260921m';
