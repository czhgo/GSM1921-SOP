...
export const sopDatabase = {
  scenarios: [
    ...
    },
    {
      ...
      tasks: [
        { taskId: '1e-1', title: '确定议题与通知', executor: 'secretary', supervisor: null, timeOffset: -3, desc: '书记定议题，提前至少3天通知支委。' },
        { taskId: '1e-2', title: '签到考勤', executor: 'disc-commissioner', supervisor: 'secretary', timeOffset: 0, desc: '纪检记录支委到场情况。' },
        { taskId: '1e-3', title: '会议记录', executor: 'secretary', supervisor: null, timeOffset: 0, desc: '书记主持，用工作记录模板记决议。' },
