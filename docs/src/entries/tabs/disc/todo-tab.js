...
import { TodoSourceType, TodoCategory, TodoActionType, seedTodos, REALTIME_GROUP_DOMAIN } from '../../../services/todo.js?v=20260922h';
import { createTodoTab } from '../../../components/todo-tab-shell.js?v=20260922h';
...
function _handleTodoAction(todo) {
  ...
  if (target) {
    ...
    if (target.segment) {
      ...
      import('../../../entries/tabs/disc/attendance-tab.js?v=20260922h')
