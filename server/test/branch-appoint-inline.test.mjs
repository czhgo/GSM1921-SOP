...
import { registerMockAdapter, setDataSource } from '../../docs/src/core/data-adapter.js?v=20260920c';
import { createBranch, getBranchById } from '../../docs/src/services/branch.js?v=20260920c';
import { PersonStore } from '../../docs/src/services/person.js?v=20260920c';
import { appointInauguralOfficers } from '../../docs/src/services/appointment.js?v=20260920c';
