...
import { IssueStore, issueDomainLabel, issueDomainSuggest } from '../services/issues.js?v=20260922e';
import { MilestoneStore } from '../services/milestones.js?v=20260922e';
import { AuthStore } from '../services/auth.js?v=20260922e';
import { showToast } from '../core/utils.js?v=20260922e';
import { icon } from '../core/icons.js?v=20260922e';
import { getPersonName } from '../services/person.js?v=20260922e';
import { renderReactions, bindReactions } from './reactions.js?v=20260922e';
import { ISSUE_STATUS_LABELS, ISSUE_CLOSED_REASON_LABELS } from '../core/constants.js?v=20260922e';
import { badgeHtml } from './badges.js?v=20260922e';
