...
import { getMeetingRoster, getRosterStats, getMeetingRosterCandidates } from '../../../services/roster.js?v=20260920d';
import { solidAccentStyle, ROLE_LABELS, isActivityArchived, isActivityLive } from '../../../core/constants.js?v=20260920d';
import { loadActivities } from '../../../services/activity.js?v=20260920d';
// SOP-B-2（D-288）：考勤候选默认选中「已通过报名者」——报名名单的来源单一源 = SignupStore
import { getApprovedSignupPersonIds } from '../../../services/signup.js?v=20260920d';
import { autoGenerateMakeupTask } from '../../../services/makeup.js?v=20260920d';
...
import { pagerHtml } from '../../../components/pager.js?v=20260920d';
...
import { DISC_COMMISSIONER_ID } from './_shared.js?v=20260920d';
...
import { renderContent as renderMakeupContent } from './makeup-tab.js?v=20260920d';
