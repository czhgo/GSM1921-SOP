...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260922e';
import { AttendanceStatus } from '../core/domain.js?v=20260922e';
import { isApiMode } from './runtime.js?v=20260922e';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260922e';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260922e'),
      import('./attendance.js?v=20260922e'),
      import('./inspection.js?v=20260922e'),
      import('./issues.js?v=20260922e'),
    ]);
