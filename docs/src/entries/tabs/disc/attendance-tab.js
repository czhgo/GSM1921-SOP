...
import { attendanceToLong, loadAttendanceRecords, loadActiveAttendanceRecords, saveAttendanceRecords, canUploadAttendance, upsertMeetingAttendance, MEETING_ATTENDANCE_TYPES as MEETING_TYPES, ABSENCE_REASONS, recorderRolesOf, listGroupMeetingAttendance } from '../../../services/attendance.js?v=20260914k';
...
import { getMeetingRoster, getRosterStats, getMeetingRosterCandidates } from '../../../services/roster.js?v=20260914k';
import { solidAccentStyle, ROLE_LABELS, isActivityArchived, isActivityLive } from '../../../core/constants.js?v=20260914k';
import { loadActivities } from '../../../services/activity.js?v=20260914k';
import { autoGenerateMakeupTask } from '../../../services/makeup.js?v=20260914k';
...
import { showToast, downloadCSV, triggerPrint, _fmtDate, escHtml as esc, getBasePath } from '../../../core/utils.js?v=20260914k';
import { DISC_COMMISSIONER_ID } from './_shared.js?v=20260914k';
import { HandoffStore } from '../../../services/handoff.js?v=20260914k';
