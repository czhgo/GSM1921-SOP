...
import { loadActiveAttendanceRecords, canUploadAttendance, appendAttendanceRecords, loadAttendanceAppeals, resolveAttendanceAppeal, reconfirmReturnedRecord, MEETING_ATTENDANCE_TYPES } from '../../../services/attendance.js?v=20260922c';
import { loadMakeupTasks } from '../../../services/makeup.js?v=20260922c';
...
import { attendanceToLong } from '../../../services/attendance.js?v=20260922c';
...
import { showToast, escHtml as esc, getBasePath } from '../../../core/utils.js?v=20260922c';
// ③批（支书 2026-09-06）：党小组会考勤候选 = 本组应到名单（党员非滞留）；
// 滞留者「可见但不可选」（灰态 + 「滞留」徽标 + title 备注，同纪检口径）
import { getMeetingRosterCandidates, getRosterStats } from '../../../services/roster.js?v=20260922c';
import { solidAccentStyle, accDarkVars } from '../../../core/constants.js?v=20260922c';
import { currentLeaderGroup } from './_shared.js?v=20260922c';
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
        <div>
          ...
          <select id="att-activity-select" class="input-flat w-full">
            ...
            ${eligibleActivities.length === 0 ? '<option value="" disabled>暂无可上传活动（仅本组党小组会与本人为组织者的活动可上传）</option>' : ''}
