...
import * as mockService from './mock.js?v=20260901o';
import { registerMockAdapter, registerApiAdapter, setDataSource, getDataSource } from '../core/data-adapter.js?v=20260901o';
