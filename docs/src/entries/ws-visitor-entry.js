...
import { TodoStore, seedTodos, VisitorTodoDeriver } from '../services/todo.js?v=20260823b';
...
/** 渲染上下文（供各 tab 模块使用；onNavLocated 供定位完成后清除高亮目标） */
function _renderCtx(state) {
  return {
    ...
    onNavLocated: () => { _visitorHighlightTfId = null; _visitorHighlightActId = null; },
  };
}
