...
import { POLICY_DEFAULTS } from '../../docs/src/core/policy-defaults.js?v=20260921p';
import {
...
import { defaultVoteConfig, resolveVoterIds } from '../../docs/src/services/vote-config.js?v=20260921p';
