...
import { persist, getDataSource, getApiBaseUrl, getAuthToken } from '../core/data-adapter.js?v=20260919i';
import { buildSystemNotice } from '../core/system-notice-templates.js?v=20260919i';
import { bumpToken } from '../core/version-token.js?v=20260919i'; // P0 域缓存失效（spec §二.3）
import { MOCK_NOTICES } from '../mock/index.js?v=20260919i';
...
import { getPersonById, liveMembers } from './person.js?v=20260919i';
import { NoticeTodoDeriver, TodoStore, TodoSourceType, TodoStatus } from './todo.js?v=20260919i';
...
import { getOrganizedActivities, isActivityOrganizer } from './activity.js?v=20260919i';
import {
  NOTICE_PUBLISH_ROLES, NOTICE_MANAGE_ROLES, BRANCH_COMMISSION_ROLES,
  NOTICE_AUDIENCE_SENTINELS, ROLE_LABELS,
} from '../core/constants.js?v=20260919i';
