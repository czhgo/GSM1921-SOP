...
import { isDetained } from './roster.js?v=20260921m';
...
export { BALLOT_MODES, BALLOT_MODE_LABELS, isAnonymousForced, defaultBallotMode, ballotModeOfActivity, isAnonymousActivity } from '../core/constants.js?v=20260921m';
