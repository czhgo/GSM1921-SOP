...
export const FUNCTION_CATALOG = [
  ...
  // ══════════ 角色工作台 ══════════
  { id: 'ws-secretary', name: '支书工作台', group: '角色工作台', role: 'secretary', desc: '今天/待办/全局概况/活动管理/支部分工/赋权管理/通知发布/专班查看/党小组进展/反馈管理/上报党委（11 tab，副支书共台；支部治理收口于设置中心「支部治理」）', usage: '登录 → 支书工作台（支书/副支书）', related: ['activity-create', 'assign', 'notification', 'todo'], generic: true, kind: 'feature' },
  ...
  { id: 'ws-leader', name: '党小组组长工作台', group: '角色工作台', role: 'leader', desc: '今天/待办/工作概况/活动管理/考勤上传/考察上传/组员进展（含本组复盘状态）/专班查看/我的处置（9 tab；复盘状态并入组员进展——复盘提交已归组织者/深度参与者，D8 裁决批二 2026-09-08）', usage: '登录 → 党小组组长工作台', related: ['activity-create', 'attendance-personal', 'review', 'todo'], generic: true, kind: 'feature' },
