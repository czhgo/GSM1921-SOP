          ...
          <div class="mt-6 pt-4 border-t border-gray-100">
            ...
            <div class="mt-4 pt-3 border-t border-gray-100">
              ...
              <div class="flex items-center justify-between mt-2">
                ...
                <button id="btn-submit-comment" class="text-sm px-6 py-2.5 rounded-lg bg-gray-800 text-white hover:bg-gray-700 transition-colors font-sans">提交评论</button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="mb-3">
            ...
            ${canManage
              ? `<select id="status-select" class="input-flat w-full text-xs rounded font-sans">
                ...
                <button id="btn-apply-status" class="mt-2 w-full text-sm px-6 py-2.5 rounded-lg bg-orange-50 text-orange-700 border border-orange-200 hover:bg-orange-100 font-sans">应用</button>`
