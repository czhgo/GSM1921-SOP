...
import { ReferencesModule } from '../modules/references.js?v=20260916a';
import { renderSidebar } from '../components/sidebar.js?v=20260916a';
import { renderHeader } from '../components/header.js?v=20260916a';
import { BranchService } from '../services/runtime.js?v=20260916a'; // 注册 mock/api 适配器 + BranchService 绑定（loadDB）
