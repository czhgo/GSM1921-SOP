...
import { _fmtDate, showToast } from '../../../core/utils.js?v=20260901t';
import { populateMonthSelector, renderCalendarByActivities } from '../../../components/calendar.js?v=20260901t';
import { renderInspectorFromState } from '../../../components/inspector.js?v=20260901t';
import { computeSecretaryStats } from '../../../services/roles.js?v=20260901t';
import { PersonPicker } from '../../../components/person-picker.js?v=20260901t';
import { openModal, closeModal } from '../../../components/modal.js?v=20260901t';
import { DecisionTreeState, renderWorkflowPanel, writeActivityWithSOP } from '../../../services/decision-tree.js?v=20260901t';
...
import { getPersonName, PEOPLE } from '../../../mock/index.js?v=20260901t';
import { NoticeStore } from '../../../services/notice.js?v=20260901t';
import { BranchService } from '../../../services/runtime.js?v=20260901t';
import { ACTIVITY_CLASSIFICATION, classifyActivityType, getAccentColors, resolveAccentRole, dotDarkVars } from '../../../core/constants.js?v=20260901t';
import { badgeHtml } from '../../../components/badge.js?v=20260901t';
import { collectAgendaRows } from './agenda-form.js?v=20260901t';
import { defaultVoteConfig, isDecisionScenario, resolveVoterIds } from '../../../services/vote-config.js?v=20260901t';
import { getAdapter } from '../../../core/data-adapter.js?v=20260901t';
