...
import { persist, getDataSource } from '../core/data-adapter.js?v=20260915d';
import { generateId } from '../core/id.js?v=20260915d';
import { bumpToken } from '../core/version-token.js?v=20260915d';
// 登记角色集单一源（勿手写角色名单——roles-sync 守卫会拦）
import { MEMBER_FLOW_ROLES } from '../core/constants.js?v=20260915d';
import { MEMBER_FLOWS } from '../mock/index.js?v=20260915d';
import { PersonStore } from './person.js?v=20260915d';
import { submitTransferOut } from './member-confirmation.js?v=20260915d';
import { createAccount, deactivateAccount, reactivateAccount } from './accounts.js?v=20260915d';
