...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260921p';
import { AttendanceStatus } from '../core/domain.js?v=20260921p';
import { isApiMode } from './runtime.js?v=20260921p';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260921p';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260921p'),
      import('./attendance.js?v=20260921p'),
      import('./inspection.js?v=20260921p'),
      import('./issues.js?v=20260921p'),
    ]);
