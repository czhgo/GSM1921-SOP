...
import { ReferencesModule } from '../modules/references.js?v=20260914m';
import { renderSidebar } from '../components/sidebar.js?v=20260914m';
import { renderHeader } from '../components/header.js?v=20260914m';
import { BranchService } from '../services/runtime.js?v=20260914m'; // 注册 mock/api 适配器 + BranchService 绑定（loadDB）
