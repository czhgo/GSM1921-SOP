...
import { ROLE_LABELS } from '../core/constants.js?v=20260920b';
import { POLICY_DEFAULTS } from '../core/policy-defaults.js?v=20260920b';
import { WORK_MAP_MODULES, mergeWorkforceSnapshot, canDisableModule } from '../core/work-map.js?v=20260920b';
import { getPersonName } from './person.js?v=20260920b';
import { AuthStore } from './auth.js?v=20260920b';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260920b';
import { fetchVotesStrict } from './committee-vote.js?v=20260920b';
import { TodoStore, TodoCategory, TodoSourceType, WORK_DOMAIN } from './todo.js?v=20260920b';
