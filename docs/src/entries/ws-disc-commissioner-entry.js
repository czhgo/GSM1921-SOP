...
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS, ReviewStatus, SourceType, OutputType, deriveOutputRoute } from '../core/domain.js?v=20260807g';
import { persist } from '../core/data-adapter.js?v=20260807g';
import { attendanceToLong, attendanceToWide, inspectionToLong, inspectionToWide, reviewToDisplay, getPersonName } from '../mock/index.js?v=20260807g';
import { loadWorkspaceData } from '../core/data-loader.js?v=20260807g';
import { renderTabBar } from '../components/tab-bar.js?v=20260807g';
import { openFormModal } from '../components/modal.js?v=20260807g';
import { autoGenerateMakeupTask, loadMakeupTasks, saveMakeupTasks } from '../services/makeup.js?v=20260807g';
import { loadAttendanceRecords, saveAttendanceRecords } from '../services/attendance.js?v=20260807g';
import { loadInspectionRecords, getOverdueRecords, confirmInspectionRecord, deleteInspectionRecord, getRecordsBySource } from '../services/inspection.js?v=20260807g';
