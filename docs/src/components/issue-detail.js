...
import { renderReactions, bindReactions } from './reactions.js?v=20260908c';
import { ISSUE_STATUS_LABELS, ISSUE_CLOSED_REASON_LABELS } from '../core/constants.js?v=20260908c';
