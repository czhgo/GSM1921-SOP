...
import { loadAttendanceRecords, loadActiveAttendanceRecords, listLowAttendanceSessions } from './attendance.js?v=20260922j';
import { loadActivities } from './activity.js?v=20260922j';
import { loadInspectionRecords, getOverdueRecords } from './inspection.js?v=20260922j';
import { TaskForceRecordStore } from './taskforce.js?v=20260922j';
import { loadActivityReviews, loadActiveActivityReviews } from './review.js?v=20260922j';
import { NoticeStore } from './notice.js?v=20260922j';
import { TodoStore, seedTodos, TodoCategory, TodoActionType, REALTIME_GROUP_DOMAIN, WORK_DOMAIN } from './todo.js?v=20260922j';
import { tokenOf } from '../core/version-token.js?v=20260922j'; // P0 域缓存失效（spec §二.3/§二.4）
import { PEOPLE } from '../mock/index.js?v=20260922j';
import { getPersonById } from './person.js?v=20260922j';
import { ROLE_LABELS, isActivityEnded, isActivityArchived } from '../core/constants.js?v=20260922j';
import { mockDB, AttendanceStatus, ReviewStatus } from '../core/domain.js?v=20260922j';
import { persist } from '../core/data-adapter.js?v=20260922j'; // 周报审核写口落盘（SOP-B-40 ②）
