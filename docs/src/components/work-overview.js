...
import { showToast, flashHighlight } from '../core/utils.js?v=20260922d';
import { dutyCardHtml } from './workforce-duty-card.js?v=20260922d';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260922d';
import { IssueStore } from '../services/issues.js?v=20260922d';
import { AuthStore } from '../services/auth.js?v=20260922d';
import { solidAccentStyle, dotDarkVars, isActivityEnded, isActivityArchived } from '../core/constants.js?v=20260922d';
import { loadActivities } from '../services/activity.js?v=20260922d';
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260922d';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260922d';
...
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260922d';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260922d');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260922d');
