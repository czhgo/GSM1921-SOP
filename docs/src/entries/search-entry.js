...
import { ReferencesModule } from '../modules/references.js?v=20260921o';
import { renderSidebar } from '../components/sidebar.js?v=20260921o';
import { renderHeader } from '../components/header.js?v=20260921o';
import { BranchService } from '../services/runtime.js?v=20260921o'; // 注册 mock/api 适配器 + BranchService 绑定（loadDB）
