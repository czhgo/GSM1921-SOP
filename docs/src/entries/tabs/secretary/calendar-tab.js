...
import { getAppState, setState } from '../../../core/state.js?v=20260901n';
import { _fmtDate, showToast } from '../../../core/utils.js?v=20260901n';
import { populateMonthSelector, renderCalendarByActivities } from '../../../components/calendar.js?v=20260901n';
import { renderInspectorFromState } from '../../../components/inspector.js?v=20260901n';
import { computeSecretaryStats } from '../../../services/roles.js?v=20260901n';
import { PersonPicker } from '../../../components/person-picker.js?v=20260901n';
import { openModal, closeModal } from '../../../components/modal.js?v=20260901n';
import { DecisionTreeState, renderWorkflowPanel, writeActivityWithSOP } from '../../../services/decision-tree.js?v=20260901n';
...
import { getPersonName, PEOPLE } from '../../../mock/index.js?v=20260901n';
import { NoticeStore } from '../../../services/notice.js?v=20260901n';
import { BranchService } from '../../../services/runtime.js?v=20260901n';
import { ACTIVITY_CLASSIFICATION, classifyActivityType, getAccentColors, resolveAccentRole, dotDarkVars } from '../../../core/constants.js?v=20260901n';
import { badgeHtml } from '../../../components/badge.js?v=20260901n';
import { collectAgendaRows } from './agenda-form.js?v=20260901n';
import { defaultVoteConfig, isDecisionScenario, resolveVoterIds } from '../../../services/vote-config.js?v=20260901n';
