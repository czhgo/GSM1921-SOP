...
import { ReferencesModule } from '../modules/references.js?v=20260912j';
import { renderSidebar } from '../components/sidebar.js?v=20260912j';
import { renderHeader } from '../components/header.js?v=20260912j';
import { BranchService } from '../services/runtime.js?v=20260912j'; // 注册 mock/api 适配器 + BranchService 绑定（loadDB）
