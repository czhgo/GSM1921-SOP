...
import { buildOrgWizardReport } from '../../docs/src/services/org-wizard-report.js?v=20260912a';
...
test('report：待手动替换文件清单要点齐全（mock/constants/权限/术语/制度/配色/policy）', () => {
  const md = buildOrgWizardReport(SAMPLE);
  for (const frag of [
    'docs/src/mock/people.js?v=20260912a',
    'docs/src/core/constants.js?v=20260912a',
    'SYSTEM_ROLE_PERMISSION.md',
    'USAGE_POLICY.md',
    'content/02_institution/sop/',
    'COLOR_SYSTEM.md',
    'docs/src/styles.css',
    'docs/src/core/policy-defaults.js?v=20260912a',
  ]) {
