...
import { getAccentColors, ROLE_LABELS, relativeLuminance } from '../core/constants.js?v=20260919i';
...
import { DATA_CHANGED_EVENT, DATA_LOADED_EVENT } from '../core/data-adapter.js?v=20260919i';
...
function loadNotice() {
  if (!_noticeModule) _noticeModule = import('../services/notice.js?v=20260919i');
