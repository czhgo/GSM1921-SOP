...
import { SignupStore } from '../services/signup.js?v=20260901x';
...
import { getActivityTypeColors } from '../core/constants.js?v=20260901x';
import { badgeHtml } from '../components/badge.js?v=20260901x';
import { enhanceSelects } from '../components/custom-select.js?v=20260901x';
import { canSignup as _canSignup, renderSignupSection, renderSignupList, bindSignupEvents, roleLabel } from '../components/signup-panel.js?v=20260901x';
import { renderShareButtonHtml, bindShareButton } from '../components/share-button.js?v=20260901x';
import { renderVoteWidget } from '../components/vote-widget.js?v=20260901x';
import { fetchVotes } from '../services/committee-vote.js?v=20260901x';
