...
| 金浅底 | `rgba(255,215,0,0.12~0.30)` | ██ | 金色浅背景（tab 激活态取上限 0.30，其余 0.12~0.14） |
| 金边框 | `rgba(255,215,0,0.35~0.9)` | ██ | 金色边框（tab 激活态取上限 0.9，其余 0.35~0.45） |
...
| 品牌·党徽金 | `#FFD700`（配套：深文字 `#B45309` / **tab 浅背景 `rgba(255,215,0,0.30)`、tab 边框 `rgba(255,215,0,0.9)`**，2026-08-08 提浓解决"0.14 叠白偏橙不金"；其余用途 0.12/0.35） | **tab 激活态（2026-08-08 起）**、主题党日、项目分工标签、考察成长元素、待办行动按钮 |
