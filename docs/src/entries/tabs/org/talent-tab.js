...
import { loadThoughtReports } from '../../../services/thought-report.js?v=20260917b';
import { PersonStore, getPersonName } from '../../../services/person.js?v=20260917b';
// 数据域接线收口（2026-09-03）：支部成员名单经 services/person.js 获取（原直连 mock PEOPLE）
import { getResidenceOf } from '../../../services/roster.js?v=20260917b';
// Q-21-3 收敛（2026-09-13）：在册状态枚举单一源 = core/constants.js（原经 roster.js 转出）
import { RESIDENCE } from '../../../core/constants.js?v=20260917b';
// B5（2026-09-12）：搜索 + 阶段/党小组筛选已统一接入 components/list-filter.js（分面枚举由引擎 auto 派生）
import { listPendingConfirmations, lastApprovedStageChange } from '../../../services/member-confirmation.js?v=20260917b';
import { escHtml as esc, flashHighlight, getBasePath } from '../../../core/utils.js?v=20260917b';
