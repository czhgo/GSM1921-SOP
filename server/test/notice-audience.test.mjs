...
import { MOCK_NOTICES } from '../../docs/src/mock/index.js?v=20260914o';
import { NOTICE_AUDIENCE_OPTIONS } from '../../docs/src/core/constants.js?v=20260914o';
import { NoticeStore, canReadNotice } from '../../docs/src/services/notice.js?v=20260914o';
