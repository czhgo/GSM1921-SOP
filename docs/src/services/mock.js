...
import { mockDB, SCHEMA_VERSION } from '../core/domain.js?v=20260901f';
import { generateId } from '../core/id.js?v=20260901f';
import { getDataSource, persist } from '../core/data-adapter.js?v=20260901f';
...
import { ACTIVITIES } from '../mock/activities.js?v=20260901f';
import { SEED_TASKS, SEED_ASSIGNMENTS, SEED_ARCHIVE_RECORDS, SEED_SIGNUPS } from '../mock/seed.js?v=20260901f';
// Seed 增量合并用（2026-08-05，与 core/mock-adapter.js 对齐）：
// attendance.js/notices.js 为纯数据模块，无指向本文件的循环依赖
import { ATTENDANCE_RECORDS } from '../mock/attendance.js?v=20260901f';
import { MOCK_NOTICES } from '../mock/notices.js?v=20260901f';
...
export function loadDB() {
  ...
  try {
    ...
    // 2026-08-29 T-304 C2 三委数据交接：恢复交接记录
    if (Array.isArray(parsed.handoffs)) mockDB.handoffs = parsed.handoffs;
    // 2026-08-18 支部文件 / 2026-08-30 思想汇报：恢复（刷新不丢）
    ...
    // 2026-09-01 成员变更审批链路（书记点验链路 ③④ 落地）：恢复申请与广播记录
...
export function createActivity(data) {
  return _withDelay(() => {
    ...
    if (!newItem.assignments || newItem.assignments.length === 0) {
      import('./todo.js?v=20260901f').then(({ LifecycleTodoDeriver }) => {
