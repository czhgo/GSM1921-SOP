...
import { _fmtDate, getBasePath } from '../../core/utils.js?v=20260901o';
...
import { deriveActivityLifecycleStatus, ACTIVITY_LIFECYCLE } from '../inspector.js?v=20260901o';
import { populateMonthSelector } from '../calendar.js?v=20260901o';
import { getCapabilities, mountCapability, getRuntimeEnv } from '../../core/registry.js?v=20260901o';
