...
} from '../../docs/src/services/person.js?v=20260921m';
import {
  getResidenceOf, saveResidenceChange, getDetainedMembers, RESIDENCE_KEY,
} from '../../docs/src/services/roster.js?v=20260921m';
// Q-21-3（2026-09-13）：在册状态枚举单一源 = core/constants.js（原经 roster.js 转出）
import { RESIDENCE } from '../../docs/src/core/constants.js?v=20260921m';
import {
...
import { buildDevelopNodeRemindGroup } from '../../docs/src/services/todo.js?v=20260921m';
