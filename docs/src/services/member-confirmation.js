...
import { PersonStore, findRemovedRecord } from './person.js?v=20260915g';
import { getResidenceOf, saveResidenceChange, getDetainedMembers } from './roster.js?v=20260915g';
// 发展阶段枚举单一源（静态种子派生，禁造新枚举）
import { DEVELOP_STAGE_OPTIONS } from './org-base-data-preview.js?v=20260915g';
...
import { isActivityNotStarted, RESIDENCE } from '../core/constants.js?v=20260915g';
