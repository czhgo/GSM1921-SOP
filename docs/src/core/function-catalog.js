...
export const FUNCTION_CATALOG = [
  ...
  { id: 'thought-report', name: '思想汇报', group: '党建', role: 'member', tab: 'thought-report', desc: '成员提交思想汇报，提交即入库归档至个人档案（不设人工归档门；篇幅建议 1500 字以上，少于 1200 字触发警告审阅、不影响提交）；组织委员可查看调用，必要时打回要求补充', usage: '成员工作台 → 思想汇报 → 选期次 + 写正文 → 提交（即归档）；组织台「思想汇报」查看台账与篇幅不足一览', related: ['flow-thought-report', 'talent'], generic: true, kind: 'feature' },
  ...
  { id: 'ws-org', name: '组织委员工作台', group: '角色工作台', role: 'org', desc: '今天/待办/工作概况/考察上传/思想汇报初阅/专班管理/成员名册/人才库/发展数据/知情查看/我的处置（11 tab；2026-09-15 按行为性质四组分段——工作台/我的职责/知情查看/制度与答复；思想汇报初阅前移——D8 裁决批二 2026-09-08）', usage: '登录 → 组织委员工作台', related: ['taskforce-recruit', 'development', 'talent', 'thought-report', 'todo'], generic: true, kind: 'feature' },
