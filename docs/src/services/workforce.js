...
import { BranchService } from './runtime.js?v=20260914q';
import { NoticeStore } from './notice.js?v=20260914q';
import { defaultVoteConfig, resolveVoterIds } from './vote-config.js?v=20260914q';
import { ROLE_LABELS } from '../core/constants.js?v=20260914q';
import { POLICY_DEFAULTS } from '../core/policy-defaults.js?v=20260914q';
import { WORK_MAP_MODULES, mergeWorkforceSnapshot, canDisableModule } from '../core/work-map.js?v=20260914q';
import { getPersonName } from './person.js?v=20260914q';
import { AuthStore } from './auth.js?v=20260914q';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260914q';
import { fetchVotesStrict } from './committee-vote.js?v=20260914q';
import { TodoStore, TodoCategory, TodoSourceType, WORK_DOMAIN } from './todo.js?v=20260914q';
