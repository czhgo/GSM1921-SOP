...
import { persist, getAdapter, getAuthToken, getApiBaseUrl, getDataSource } from '../core/data-adapter.js?v=20260916a';
import { AuthStore } from './auth.js?v=20260916a';
import { NoticeStore } from './notice.js?v=20260916a';
import { resolveVoterIds } from './vote-config.js?v=20260916a';
