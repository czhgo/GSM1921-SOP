...
import { getAccentColors, resolveAccentRole } from './constants.js?v=20260808l';
import { CrossPageState } from './cross-page-state.js?v=20260808l';
import { getBasePath } from './utils.js?v=20260808l';
import { enhanceSelects } from '../components/custom-select.js?v=20260808l';
import { registerApiAdapter, setDataSource, init } from './data-adapter.js?v=20260808l';
import { ApiAdapter } from './api-adapter.js?v=20260808l';
