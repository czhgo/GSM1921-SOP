...
import { ROLE_LABELS, ROLE_COLORS } from '../../../core/constants.js?v=20260920d';
import { AuthStore } from '../../../services/auth.js?v=20260920d';
import { dutyCardHtml } from '../../../components/workforce-duty-card.js?v=20260920d';
import { SecretaryOverviewStore, listWeeklyReportsPendingReview, reviewWeeklyReport, WEEKLY_REVIEW_STATUS } from '../../../services/secretary-overview.js?v=20260920d';
// S1–S4 滞留党员设计（2026-09-06 支书已批）：支书复核卡（只读查看徽标/备注/变更留痕）
import { getRosterStats } from '../../../services/roster.js?v=20260920d';
...
import { IssueStore, REPORT_CATEGORIES } from '../../../services/issues.js?v=20260920d';
