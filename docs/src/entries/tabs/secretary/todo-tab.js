...
import { showToast, escHtml as esc, flashHighlight } from '../../../core/utils.js?v=20260921g';
// D2 裁决批二（2026-09-08）：概况汇报区只读摘要「去待办处理」→ 定位消费（展开该答复详情并滚动到视口）
import { PendingTarget } from '../../../core/pending-target.js?v=20260921g';
import { createTodoTab, createUrgeController } from '../../../components/todo-tab-shell.js?v=20260921g';
import { TodoStore, seedTodos, TodoCategory, REALTIME_GROUP_DOMAIN, WORK_DOMAIN } from '../../../services/todo.js?v=20260921g';
import { SecretaryTodoDeriver } from '../../../services/secretary-overview.js?v=20260921g';
import { badgeHtml } from '../../../components/badges.js?v=20260921g';
import { loadAttendanceRecords, saveAttendanceRecords } from '../../../services/attendance.js?v=20260921g';
import { loadInspectionRecords, saveInspectionRecords } from '../../../services/inspection.js?v=20260921g';
import { updateActivityReview, loadActivityReviews, renderActivityReviewFormHtml, submitActivityReviewForm } from '../../../services/review.js?v=20260921g';
...
import { getPersonById, getPersonName, PersonStore } from '../../../services/person.js?v=20260921g';
import { solidAccentStyle, ROLE_LABELS, isArchiveFallbackPage } from '../../../core/constants.js?v=20260921g';
...
import { TaskForceRecordStore, createTaskforceVoteActivity, findTaskforceVoteActivity } from '../../../services/taskforce.js?v=20260921g';
import { fetchVotes } from '../../../services/committee-vote.js?v=20260921g';
import { resolveVoterIds } from '../../../services/vote-config.js?v=20260921g';
import { renderReportInboxHtml, bindReportInbox } from '../../../components/reporting.js?v=20260921g';
// 2026-09-08 裁决批一（D1/D3）：成员变更=域内确认+批量去顶卡——顶卡面板移除，
// 确认位唯一化 = 「成员发展」域实时组内批量块（buildMcBulkRows/renderMcBulkRowsHtml/bindMcBulk）。
import { preloadMemberChangeRequests, getCachedMemberChangeRequests, buildMcBulkRows, renderMcBulkRowsHtml, bindMcBulk } from '../../../components/member-change-panel.js?v=20260921g';
import { tryDirectJump } from '../../../components/todo-jump.js?v=20260921g';
import { buildOverdueRemindGroupNow } from '../../../services/resolution-followup.js?v=20260921g';
...
import { listPendingConfirmations, decideConfirmation, shouldShowSemesterDetainedRemind, semesterDetainedWindowsLabel, MC_ACTION_LABEL } from '../../../services/member-confirmation.js?v=20260921g';
import { getDetainedMembers, getResidenceOf } from '../../../services/roster.js?v=20260921g';
