...
import { fetchVotes, lockVotes, votedCountOf, tallyOf } from '../services/committee-vote.js?v=20260921g';
import { optionSetOf, isAnonymousActivity } from '../services/vote-config.js?v=20260921g';
...
} from './resolution-followup-manager.js?v=20260921g';
// 批次 39：表态矩阵并入单一源「人 × 项目」矩阵（原 .vs-matrix 自建实现撤除，Q-23-18 收敛）
import { renderRelationMatrix } from './relation-matrix.js?v=20260921g';
