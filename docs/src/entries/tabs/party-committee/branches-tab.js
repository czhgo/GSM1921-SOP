...
import { createBranch, renameBranch, getCommitteeName } from '../../../services/branch.js?v=20260912j';
import { appointSecretary, listAppointments } from '../../../services/appointment.js?v=20260912j';
import { getRosterStats } from '../../../services/roster.js?v=20260912j';
// 立项⑥ B波：空支部名册导入服务（模板/净化/统计；确认落库直接走 PersonStore.replaceBranchMembers）
import { buildBranchRosterTemplate, sanitizeBranchRoster } from '../../../services/branch-roster-import.js?v=20260912j';
import { showToast, escHtml as esc, downloadBlob } from '../../../core/utils.js?v=20260912j';
// 立项⑦ B波：支部卡「进入支部（演示）」按钮绑定（与 governance-overview-tab 同源）
import { bindBranchDemoButtons } from '../../../modules/branch-demo-nav.js?v=20260912j';
