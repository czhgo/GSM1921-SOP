...
import { getRosterStats, getResidenceOf } from '../../../services/roster.js?v=20260920d';
import { listPendingConfirmations } from '../../../services/member-confirmation.js?v=20260920d';
import { DEVELOP_STAGE_OPTIONS } from '../../../services/org-base-data-preview.js?v=20260920d';
...
import { ROLE_LABELS, RESIDENCE } from '../../../core/constants.js?v=20260920d';
import { showToast, escHtml as esc, getBasePath } from '../../../core/utils.js?v=20260920d';
import { openModal, closeModal, openFormModal } from '../../../components/modal.js?v=20260920d';
...
// 纯逻辑（可单测）：新增表单校验
import { validateMemberForm } from '../../../services/roster-ui-logic.js?v=20260920d';
...
} from '../../../services/member-flow.js?v=20260920d';
...
import { getBranchIdOfPerson } from '../../../services/branch.js?v=20260920d';
