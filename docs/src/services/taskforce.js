...
import { MOCK_TASKFORCES } from '../mock/index.js?v=20260921a';
import { isInitStateActive } from './init-reset.js?v=20260921a'; // C2 修复（2026-09-08）：init 态跳过演示种子兜底
import { getPersonName, liveMembers } from './person.js?v=20260921a';
import { evaluateWorkforceVotes } from './workforce.js?v=20260921a';
...
import { BRANCH_COMMISSION_ROLES } from '../core/constants.js?v=20260921a'; // 支委层应到名单单一源（勿手写）
