...
import { WORK_MAP_MODULES, mergeWorkforceSnapshot, canDisableModule, ORG_SUBJECT_LABELS } from '../core/work-map.js?v=20260922g';
import { getPersonName } from './person.js?v=20260922g';
import { AuthStore } from './auth.js?v=20260922g';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260922g';
import { fetchVotesStrict } from './committee-vote.js?v=20260922g';
import { TodoStore, TodoCategory, TodoSourceType, WORK_DOMAIN } from './todo.js?v=20260922g';
