...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260921i';
import { AttendanceStatus } from '../core/domain.js?v=20260921i';
import { isApiMode } from './runtime.js?v=20260921i';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260921i';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260921i'),
      import('./attendance.js?v=20260921i'),
      import('./inspection.js?v=20260921i'),
      import('./issues.js?v=20260921i'),
    ]);
