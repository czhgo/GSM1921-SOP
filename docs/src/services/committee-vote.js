...
import { persist, getAdapter, getAuthToken, getApiBaseUrl, getDataSource } from '../core/data-adapter.js?v=20260913v';
import { AuthStore } from './auth.js?v=20260913v';
import { NoticeStore } from './notice.js?v=20260913v';
import { resolveVoterIds } from './vote-config.js?v=20260913v';
