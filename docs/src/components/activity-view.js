...
import { renderCalendarByActivities } from './calendar.js?v=20260921o';
import { _fmtDate, _currentYearMonth, flashHighlight, downloadCSV, showToast, escHtml as esc } from '../core/utils.js?v=20260921o';
import { badgeHtml } from './badges.js?v=20260921o';
import { ROLE_COLORS, dotDarkVars, isActivityArchived } from '../core/constants.js?v=20260921o';
import { activityLifecycleBadgeHtml } from './inspector.js?v=20260921o';
...
import { renderVoteWidget } from './vote-widget.js?v=20260921o';
