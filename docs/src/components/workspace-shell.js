...
import { getAppState, setState, registerRenderCallback } from '../core/state.js?v=20260901k';
import { bootstrapPage } from '../core/bootstrap.js?v=20260901k';
import { renderTabBar } from './tab-bar.js?v=20260901k';
import { flashHighlight } from '../core/utils.js?v=20260901k';
import { CrossPageState } from '../core/cross-page-state.js?v=20260901k';
import { getCapabilities } from '../core/registry.js?v=20260901k';
import { loadWorkspaceData } from '../core/data-loader.js?v=20260901k';
import { TodoStore } from '../services/todo.js?v=20260901k';
