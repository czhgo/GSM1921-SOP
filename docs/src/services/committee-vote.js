...
import { persist, getAdapter, getAuthToken, getApiBaseUrl, getDataSource } from '../core/data-adapter.js?v=20260901r';
import { AuthStore } from './auth.js?v=20260901r';
import { NoticeStore } from './notice.js?v=20260901r';
import { resolveVoterIds } from './vote-config.js?v=20260901r';
