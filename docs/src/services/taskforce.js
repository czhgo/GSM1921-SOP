...
import { MOCK_TASKFORCES } from '../mock/index.js?v=20260913v';
import { isInitStateActive } from './init-reset.js?v=20260913v'; // C2 修复（2026-09-08）：init 态跳过演示种子兜底
import { getPersonName, liveMembers } from './person.js?v=20260913v';
import { evaluateWorkforceVotes } from './workforce.js?v=20260913v';
...
import { defaultVoteConfig, resolveVoterIds } from './vote-config.js?v=20260913v';
import { loadActivities } from './activity.js?v=20260913v';
import { AuthStore } from './auth.js?v=20260913v';
import { BRANCH_COMMISSION_ROLES } from '../core/constants.js?v=20260913v'; // 支委层应到名单单一源（勿手写）
...
export const TaskForceRecordStore = {
  ...
  add(record) {
    ...
    if (!newRecord.members || newRecord.members.length === 0) {
      import('./todo.js?v=20260913v').then(({ LifecycleTodoDeriver }) => {
