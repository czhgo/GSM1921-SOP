...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260921j';
import { AttendanceStatus } from '../core/domain.js?v=20260921j';
import { isApiMode } from './runtime.js?v=20260921j';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260921j';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260921j'),
      import('./attendance.js?v=20260921j'),
      import('./inspection.js?v=20260921j'),
      import('./issues.js?v=20260921j'),
    ]);
