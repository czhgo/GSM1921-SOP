...
export function renderInsightView(container, opts = {}) {
  ...
  if (view === 'taskforce') {
    return import('./taskforce-view.js?v=20260922c').then(m => m.renderTaskforceView(body, {
      highlightId: opts.highlightTfId || null,
      onLocated: opts.onLocated,
    }));
  }
  return import('./activity-view.js?v=20260922c').then(m => m.renderActivityView(body, {
