...
import { getAppState, setState, registerRenderCallback } from '../core/state.js?v=20260903b';
import { bootstrapPage } from '../core/bootstrap.js?v=20260903b';
import { renderTabBar } from './tab-bar.js?v=20260903b';
...
import { applyTabPolicy, getBranchIdOfPerson } from '../services/branch.js?v=20260903b';
