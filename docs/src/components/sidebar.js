...
import { ACCENT_COLORS, ACCENT_PALETTE, resolveAccentRole } from '../core/constants.js?v=20260827c';
import { getThemePreference, setThemePreference, initTheme } from '../core/theme.js?v=20260827c';
import { readLoginSnapshot } from '../core/login-snapshot.js?v=20260827c';
import { DEPLOY_MODE } from '../config/deploy.js?v=20260827c';
...
function loadPopover() {
  if (!_popoverModule) _popoverModule = import('./workspace-popover.js?v=20260827c');
