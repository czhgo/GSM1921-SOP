...
import { getMeetingRoster, getRosterStats, getMeetingRosterCandidates } from '../../../services/roster.js?v=20260921f';
import { solidAccentStyle, ROLE_LABELS, isActivityArchived, isActivityLive } from '../../../core/constants.js?v=20260921f';
import { loadActivities } from '../../../services/activity.js?v=20260921f';
// SOP-B-2（D-288）：考勤候选默认选中「已通过报名者」——报名名单的来源单一源 = SignupStore
import { getApprovedSignupPersonIds } from '../../../services/signup.js?v=20260921f';
import { autoGenerateMakeupTask } from '../../../services/makeup.js?v=20260921f';
import { TodoStore, TodoSourceType } from '../../../services/todo.js?v=20260921f';
import { NoticeStore } from '../../../services/notice.js?v=20260921f';
import { enhanceSelects } from '../../../components/custom-select.js?v=20260921f';
...
import { pagerHtml } from '../../../components/pager.js?v=20260921f';
// 人×项目矩阵单一源（支书 2026-09-14 批次 35 裁定：宽表默认 + 矩阵推广）
import { renderRelationMatrix } from '../../../components/relation-matrix.js?v=20260921f';
import { showToast, downloadCSV, triggerPrint, _fmtDate, escHtml as esc, getBasePath } from '../../../core/utils.js?v=20260921f';
import { DISC_COMMISSIONER_ID } from './_shared.js?v=20260921f';
import { HandoffStore } from '../../../services/handoff.js?v=20260921f';
...
import { renderContent as renderMakeupContent } from './makeup-tab.js?v=20260921f';
