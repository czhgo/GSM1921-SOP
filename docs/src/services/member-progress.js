...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260921n';
import { AttendanceStatus } from '../core/domain.js?v=20260921n';
import { isApiMode } from './runtime.js?v=20260921n';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260921n';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260921n'),
      import('./attendance.js?v=20260921n'),
      import('./inspection.js?v=20260921n'),
      import('./issues.js?v=20260921n'),
    ]);
