...
import { recordAgendaResult } from '../../docs/src/services/agenda-follow-up.js?v=20260921k';
// 品牌认定（2026-09-21 批次 132 · 支书口径二「提案 → 支委会通过后确定」）——判据与状态迁移的单一源
import { applyBrandDesignationResult } from '../../docs/src/services/activity.js?v=20260921k';
