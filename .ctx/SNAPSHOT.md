...
date: "2026-09-10"
version: "v26"
milestone: "2026-09-11 续批（第六批）：R-13 浅色对比存量核销（先定性：灰字 296 = 真违规 68 / 伪影 228（折叠侧栏 225+display:none 3），约 3/4 为默认折叠侧栏伪影 → 伪影口径入库；再收口：组件侧 help 38 / stats 9 / 页脚 7 / settings 4 + 同族扩散 ~30 处，浅色 2.15–2.54→3.19–8.70，深色零退化，剩余真违规仅登记项 12）+ 乙部仅余 R-14（浅色存量需改样式表：styles.css .ref-* / about.css 浅色 52 / status-badge pending，待专批）；版本串 20260911a / CODE_VERSION 105"
---
...
> **上版**: v25 (2026-09-11)
> **变更来源**: 2026-09-10/11（五批 + 本批共六批，T-077 追加批次 1~7；见 v26/v25/v24/v23/v22 里程碑行；测试/文件计数一律以实测为准）
