...
import { showToast, flashHighlight } from '../core/utils.js?v=20260921n';
import { dutyCardHtml } from './workforce-duty-card.js?v=20260921n';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260921n';
import { IssueStore } from '../services/issues.js?v=20260921n';
import { AuthStore } from '../services/auth.js?v=20260921n';
import { solidAccentStyle, dotDarkVars, isActivityEnded, isActivityArchived } from '../core/constants.js?v=20260921n';
import { loadActivities } from '../services/activity.js?v=20260921n';
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260921n';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260921n';
...
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260921n';
...
import { renderFilteredList } from './list-filter.js?v=20260921n';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260921n');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260921n');
