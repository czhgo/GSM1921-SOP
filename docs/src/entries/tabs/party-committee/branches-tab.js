...
import { createBranch, renameBranch, getCommitteeName } from '../../../services/branch.js?v=20260914i';
import { appointSecretary, listAppointments } from '../../../services/appointment.js?v=20260914i';
...
import { buildBranchRosterTemplate, sanitizeBranchRoster } from '../../../services/branch-roster-import.js?v=20260914i';
import { showToast, escHtml as esc, downloadBlob, getBasePath } from '../../../core/utils.js?v=20260914i';
// 立项⑦ B波：支部卡「进入支部（演示）」按钮绑定（与 governance-overview-tab 同源）
import { bindBranchDemoButtons } from '../../../modules/branch-demo-nav.js?v=20260914i';
