...
import { loadAttendanceRecords, loadActiveAttendanceRecords, listLowAttendanceSessions } from './attendance.js?v=20260919i';
import { loadActivities } from './activity.js?v=20260919i';
import { loadInspectionRecords, getOverdueRecords } from './inspection.js?v=20260919i';
import { TaskForceRecordStore } from './taskforce.js?v=20260919i';
import { loadActivityReviews, loadActiveActivityReviews } from './review.js?v=20260919i';
import { NoticeStore } from './notice.js?v=20260919i';
import { TodoStore, seedTodos, TodoCategory, TodoActionType, REALTIME_GROUP_DOMAIN, WORK_DOMAIN } from './todo.js?v=20260919i';
import { tokenOf } from '../core/version-token.js?v=20260919i'; // P0 域缓存失效（spec §二.3/§二.4）
import { PEOPLE } from '../mock/index.js?v=20260919i';
import { getPersonById } from './person.js?v=20260919i';
import { ROLE_LABELS, isActivityEnded, isActivityArchived } from '../core/constants.js?v=20260919i';
import { mockDB, AttendanceStatus, ReviewStatus } from '../core/domain.js?v=20260919i';
import { persist } from '../core/data-adapter.js?v=20260919i'; // 周报审核写口落盘（SOP-B-40 ②）
