...
import { SignupStore, canCloseActivitySignup, closeActivitySignup, SignupStatus } from '../services/signup.js?v=20260921d';
import { AuthStore } from '../services/auth.js?v=20260921d';
import { getPersonById } from '../services/person.js?v=20260921d';
import { getBasePath, escHtml as esc, showToast } from '../core/utils.js?v=20260921d';
import { getActivityTypeColors } from '../core/constants.js?v=20260921d';
import { getAppState } from '../core/state.js?v=20260921d';
...
import { canSignup as _canSignup, renderSignupSection, renderSignupList, bindSignupEvents, roleLabel } from '../components/signup-panel.js?v=20260921d';
import { renderShareButtonHtml, bindShareButton } from '../components/share-button.js?v=20260921d';
...
import { settleWrites } from '../core/pending-writes.js?v=20260921d';
