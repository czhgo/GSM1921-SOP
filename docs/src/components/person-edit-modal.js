...
import { ROLE_LABELS, DEVELOP_STAGES, RESIDENCE } from '../core/constants.js?v=20260922f';
import { submitMemberChange } from '../services/member-confirmation.js?v=20260922f';
