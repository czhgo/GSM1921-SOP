...
async function collectAll(page) {
  return page.evaluate(async () => {
    const mock = await import('/src/mock/index.js?v=20260922c');
    const seed = await import('/src/mock/seed.js?v=20260922c');
    const accounts = await import('/src/mock/accounts.js?v=20260922c');
    return {
      PEOPLE: mock.PEOPLE,
