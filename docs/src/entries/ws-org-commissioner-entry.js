...
import { _personName, PEOPLE, inspectionToLong, getPersonById, getPersonName } from '../mock/index.js?v=20260808l';
import { mockDB, SourceType, ParticipationLevel } from '../core/domain.js?v=20260808l';
...
import { SignupStore, resolveSignupReviewer, SignupStatus } from '../services/signup.js?v=20260808l';
