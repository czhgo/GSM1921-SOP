...
import { showToast, flashHighlight } from '../core/utils.js?v=20260829f';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260829f';
import { IssueStore, REPORT_CATEGORIES } from '../services/issues.js?v=20260829f';
...
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260829f';
...
import { PEOPLE } from '../mock/people.js?v=20260829f';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260829f');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260829f');
