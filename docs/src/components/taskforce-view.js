...
import { dotDarkVars } from '../core/constants.js?v=20260922a';
import { flashHighlight, showToast } from '../core/utils.js?v=20260922a';
import { anchorDetailToTrigger } from './detail-anchor.js?v=20260922a';
