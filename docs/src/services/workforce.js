...
import { WORK_MAP_MODULES, mergeWorkforceSnapshot } from '../core/work-map.js?v=20260909e';
import { getPersonName } from './person.js?v=20260909e';
import { AuthStore } from './auth.js?v=20260909e';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260909e';
