...
import { setState, getAppState } from '../../../core/state.js?v=20260829k';
import { BranchService } from '../../../services/runtime.js?v=20260829k';
import { DecisionTreeState, DECISION_TREE_CONFIGS, renderWorkflowPanel, writeActivityWithSOP } from '../../../services/decision-tree.js?v=20260829k';
import { AuthStore } from '../../../services/auth.js?v=20260829k';
import { TodoStore, TodoSourceType } from '../../../services/todo.js?v=20260829k';
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS, SourceType, ParticipationLevel, OutputType, deriveOutputRoute } from '../../../core/domain.js?v=20260829k';
import { persist } from '../../../core/data-adapter.js?v=20260829k';
import { loadAttendanceRecords, saveAttendanceRecords } from '../../../services/attendance.js?v=20260829k';
import { loadInspectionRecords, saveInspectionRecords } from '../../../services/inspection.js?v=20260829k';
import { PersonPicker } from '../../../components/person-picker.js?v=20260829k';
import { getPersonName, PEOPLE } from '../../../mock/index.js?v=20260829k';
import { badgeHtml } from '../../../components/badge.js?v=20260829k';
import { showToast } from '../../../core/utils.js?v=20260829k';
import { solidAccentStyle, accDarkVars, accDarkParts } from '../../../core/constants.js?v=20260829k';
import { filterByRole, getCurrentLeaderId } from './_shared.js?v=20260829k';
