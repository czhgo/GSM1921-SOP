...
import { getPersonName } from '../services/person.js?v=20260812c';
import { ACTIVITIES } from './activities.js?v=20260812c';
import { PEOPLE } from './people.js?v=20260812c';
import { AttendanceStatus, ATTENDANCE_STATUS_LABELS } from '../core/domain.js?v=20260812c';
