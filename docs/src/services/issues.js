...
import { PersonStore } from './person.js?v=20260920d';
import { bumpToken } from '../core/version-token.js?v=20260920d'; // P2 渲染守卫失效（spec §四.1）
import { getDataSource, getAdapter } from '../core/data-adapter.js?v=20260920d';
import { hashSubmitterToken, SECRETARY_ROLES, PARTY_STAFF_ROLE } from '../core/constants.js?v=20260920d';
// 2026-09-17 批次 49：处置写链（REST 直连，不走 persist）须自登记进成功提示的统一等待点
import { trackWrite } from '../core/pending-writes.js?v=20260920d';
import { withinBranch, getBranchIdOfPerson } from './branch.js?v=20260920d';
import { generateId, randomHex } from '../core/id.js?v=20260920d';
