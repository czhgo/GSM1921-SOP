...
import { attendanceToLong, loadAttendanceRecords, loadActiveAttendanceRecords, saveAttendanceRecords, canUploadAttendance, upsertMeetingAttendance, MEETING_ATTENDANCE_TYPES as MEETING_TYPES, ABSENCE_REASONS, recorderRolesOf, listGroupMeetingAttendance } from '../../../services/attendance.js?v=20260914i';
import { getPersonById, getPersonName } from '../../../services/person.js?v=20260914i';
...
import { getMeetingRoster, getRosterStats, getMeetingRosterCandidates } from '../../../services/roster.js?v=20260914i';
import { solidAccentStyle, ROLE_LABELS, isActivityArchived, isActivityLive } from '../../../core/constants.js?v=20260914i';
import { loadActivities } from '../../../services/activity.js?v=20260914i';
import { autoGenerateMakeupTask } from '../../../services/makeup.js?v=20260914i';
...
import { showToast, downloadCSV, triggerPrint, _fmtDate, escHtml as esc, getBasePath } from '../../../core/utils.js?v=20260914i';
import { DISC_COMMISSIONER_ID } from './_shared.js?v=20260914i';
