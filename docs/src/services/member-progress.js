...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260922f';
import { AttendanceStatus } from '../core/domain.js?v=20260922f';
import { isApiMode } from './runtime.js?v=20260922f';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260922f';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260922f'),
      import('./attendance.js?v=20260922f'),
      import('./inspection.js?v=20260922f'),
      import('./issues.js?v=20260922f'),
    ]);
