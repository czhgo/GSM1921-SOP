...
import { _fmtDate, showToast } from '../../../core/utils.js?v=20260829h';
import { populateMonthSelector, renderCalendarByActivities } from '../../../components/calendar.js?v=20260829h';
import { renderInspectorFromState } from '../../../components/inspector.js?v=20260829h';
import { computeSecretaryStats } from '../../../services/roles.js?v=20260829h';
import { PersonPicker } from '../../../components/person-picker.js?v=20260829h';
import { openModal, closeModal } from '../../../components/modal.js?v=20260829h';
import { DecisionTreeState, renderWorkflowPanel, writeActivityWithSOP } from '../../../services/decision-tree.js?v=20260829h';
import { loadActivities } from '../../../services/activity.js?v=20260829h';
import { renderQueryView } from '../../../components/query-view.js?v=20260829h';
import { icon } from '../../../core/icons.js?v=20260829h';
import { loadAttendanceRecords } from '../../../services/attendance.js?v=20260829h';
import { getPersonName } from '../../../mock/index.js?v=20260829h';
import { NoticeStore } from '../../../services/notice.js?v=20260829h';
import { BranchService } from '../../../services/runtime.js?v=20260829h';
import { ACTIVITY_CLASSIFICATION, classifyActivityType, getAccentColors, resolveAccentRole, dotDarkVars } from '../../../core/constants.js?v=20260829h';
