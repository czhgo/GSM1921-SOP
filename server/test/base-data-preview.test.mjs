...
// ⚠️ 对 docs/src 的相对 import 必须带与源码一致的 ?v=20260914m query（模块缓存键一致性）。
...
import { PersonStore } from '../../docs/src/services/person.js?v=20260914m';
import {
...
} from '../../docs/src/services/org-base-data-preview.js?v=20260914m';
