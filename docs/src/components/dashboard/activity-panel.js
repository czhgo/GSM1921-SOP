...
import { setState, getAppState } from '../../core/state.js?v=20260912c';
import { _fmtDate, getBasePath } from '../../core/utils.js?v=20260912c';
...
import { getActivityTypeColors } from '../../core/constants.js?v=20260912c';
import { badgeHtml } from '../badges.js?v=20260912c';
import { deriveActivityLifecycleStatus, ACTIVITY_LIFECYCLE } from '../inspector.js?v=20260912c';
import { populateMonthSelector } from '../calendar.js?v=20260912c';
import { getCapabilities, mountCapability, getRuntimeEnv } from '../../core/registry.js?v=20260912c';
