...
} from '../../docs/src/core/work-map.js?v=20260919g';
import { sanitizeConfigWorkforce } from '../../docs/src/core/config-clean.js?v=20260919g';
import { ROLE_KEYS } from '../../docs/src/core/constants.js?v=20260919g';
