...
import { WORK_MAP_MODULES, mergeWorkforceSnapshot, canDisableModule, ORG_SUBJECT_LABELS } from '../core/work-map.js?v=20260922f';
import { getPersonName } from './person.js?v=20260922f';
import { AuthStore } from './auth.js?v=20260922f';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260922f';
import { fetchVotesStrict } from './committee-vote.js?v=20260922f';
import { TodoStore, TodoCategory, TodoSourceType, WORK_DOMAIN } from './todo.js?v=20260922f';
