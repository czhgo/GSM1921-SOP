...
import { _fmtDate, getBasePath } from '../../core/utils.js?v=20260919j';
...
import { isActivityArchived } from '../../core/constants.js?v=20260919j';
import { badgeHtml } from '../badges.js?v=20260919j';
import { deriveActivityLifecycleStatus, ACTIVITY_LIFECYCLE } from '../inspector.js?v=20260919j';
import { populateMonthSelector } from '../calendar.js?v=20260919j';
import { getCapabilities, mountCapability, getRuntimeEnv } from '../../core/registry.js?v=20260919j';
