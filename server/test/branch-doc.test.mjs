...
import { getAdapter, registerMockAdapter, setDataSource } from '../../docs/src/core/data-adapter.js?v=20260915e';
import {
...
} from '../../docs/src/services/branch-doc.js?v=20260915e';
...
test('⑨ 消费端经 listDocs 读支部文件（资料查询 / 活动写入会前草案），不再直读 adapter 全量', async () => {
  const cases = [
    ['modules/references.js', '../../docs/src/modules/references.js?v=20260915e'],
    ['secretary/calendar-tab.js', '../../docs/src/entries/tabs/secretary/calendar-tab.js?v=20260915e'],
  ];
