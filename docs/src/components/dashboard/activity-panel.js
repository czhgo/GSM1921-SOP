...
import { _fmtDate, getBasePath } from '../../core/utils.js?v=20260921o';
...
import { deriveActivityLifecycleStatus, ACTIVITY_LIFECYCLE } from '../inspector.js?v=20260921o';
import { populateMonthSelector } from '../calendar.js?v=20260921o';
import { getCapabilities, mountCapability, getRuntimeEnv } from '../../core/registry.js?v=20260921o';
