...
| T-144 | **其他角色界面按主体色配色规则推广改版**：基于 DESIGN\_SYSTEM §2.7「主体色配色规则（打样样板）」将 visitor 打样推广至其他角色页面——全局 `--party-gold` 提亮为 #FFD700（现 #D4AF37）、各角色页面按"X 主视觉→辅助强调色功能点缀→状态色全局统一→暖白底全局统一→灰只做中性"五连规则改版。书记决策（2026-08-01）："这会给我们其他角色的界面打一个样！！"范围先经书记确认（每角色页是否本轮全部纳入，或分批）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | H2.2 母本子本 + DESIGN\_SYSTEM §2.7 + H2.4 经验沉淀（推广完成后沉淀方法论）                                             | content/04\_web\_design/\* + docs/src/\* + docs/\*.html                                                                 | ⏳ 待启动          |
