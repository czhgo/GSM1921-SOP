...
import { defaultVoteConfig, resolveVoterIds } from './vote-config.js?v=20260922h';
import { ROLE_LABELS } from '../core/constants.js?v=20260922h';
import { POLICY_DEFAULTS } from '../core/policy-defaults.js?v=20260922h';
import { WORK_MAP_MODULES, mergeWorkforceSnapshot, canDisableModule, ORG_SUBJECT_LABELS } from '../core/work-map.js?v=20260922h';
import { getPersonName } from './person.js?v=20260922h';
import { AuthStore } from './auth.js?v=20260922h';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260922h';
import { fetchVotesStrict } from './committee-vote.js?v=20260922h';
import { TodoStore, TodoCategory, TodoSourceType, WORK_DOMAIN } from './todo.js?v=20260922h';
