...
export const ICONS = {
  ...
  party:       '<path d="M4 15s1-1 4-1 5 2 8 1 4-1 4-1V4s-1-1-4-1-5 2-8 1-4-1-4-1L4 15z"/><line x1="4" y1="22" x2="4" y2="15"/>',  // 党务管理 → 旗帜，与人员管理区分
  ...
  // ── 委员矩阵图标（D-244 职能动作隐喻）──
  megaphone:   '<path d="M21 3l-9 4.5v9L21 21V3z"/><path d="M3 12h9"/><path d="M6 8a4 4 0 0 1 0 8"/>',  // 宣传委员 = 喇叭（发声/传播）
  scale:       '<path d="M12 3v18"/><path d="M4 7l4 8"/><path d="M20 7l-4 8"/><line x1="2" y1="15" x2="10" y2="15"/><line x1="14" y1="15" x2="22" y2="15"/><circle cx="6" cy="15" r="2"/><circle cx="18" cy="15" r="2"/>',  // 纪检委员 = 天平（衡量/裁判）
  cog:         '<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .5 1.6 1.65 1.65 0 0 0-1.3 2.6 1.65 1.65 0 0 0-2.6-1.3 1.65 1.65 0 0 0-1.6-.5 1.65 1.65 0 0 0-.5-1.6 1.65 1.65 0 0 0 1.3-2.6 1.65 1.65 0 0 0 2.6 1.3 1.65 1.65 0 0 0 1.6.5z"/>',  // 组织委员 = 齿轮（连接/运转）
  ...
  helpArrowRight:  '<path d="M3 7 L15 7 M11 2 L15 7 L11 12" stroke="var(--help-party-red)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',
  dialogueRing:    '<ellipse cx="50" cy="50" rx="46" ry="46" fill="none" stroke="var(--help-party-red)" stroke-width="1.5" stroke-dasharray="4 3" opacity="0.35" vector-effect="non-scaling-stroke"/>',
