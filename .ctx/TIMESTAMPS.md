...
|---------|-------------|--------|------|------|
| README.md | 2026-09-20 | — | [用户]+[AI] | 对外门面（2026-09-20 批次 106 对齐页面与页签数、设置分区、考勤/交接去向；2026-09-20 批次 118 支书台覆盖面补「支委会会议（线上召开）」） |
| README-members.md | 2026-09-20 | — | [用户]+[AI] | 支部成员版（2026-09-20 批次 106 补登） |
| README-server.md | 2026-09-21 | — | [用户]+[AI] | 后端对接说明主文档（2026-09-20 批次 106 补登；2026-09-20 批次 111 同步 `DATA_MODEL.md` 行号引用 45 处中 44 处 +8、§4.0 计数改准 331/62/432、§4.1 尾注改准；2026-09-21 批次 133 按【角色 / 功能 / 板块 / 字段】四项补齐 8 类实然缺口、§4.0 计数改准〔来源 C 74 · 合计 444〕、部署环节逐条核对后改准 12 处行号引用；**无 frontmatter ⇒ 不在 `S13` 比对面内**） |
...
| .ctx/logs/DECISION_LOG.md | 2026-09-21 | — | [工程师]+[AI] | 总决策日志（月度索引；2026-09-20 批次 114 刷为 261 条；2026-09-20 批次 115 刷为 **262 条（D-275~D-536）**；2026-09-20 批次 116 刷为 **263 条（D-275~D-537）** ＋ 2026-09 行末补批次 116 说明；2026-09-20 批次 117 刷为 **264 条（D-275~D-538）** ＋ 2026-09 行末补批次 117 说明；2026-09-20 批次 118 刷为 **265 条（D-275~D-539）** ＋ 2026-09 行末补批次 118 说明；2026-09-21 批次 120 刷为 **268 条（D-275~D-542）** ＋ 2026-09 行末补批次 120 说明〔含批次 119 的 2 条 `D-540` / `D-541` 同批补记〕；2026-09-21 批次 121 刷为 **269 条（D-275~D-543）** ＋ 2026-09 行末补批次 121 说明；2026-09-21 批次 122 刷为 **270 条（D-275~D-544）** ＋ 2026-09 行末补批次 122 说明；2026-09-21 批次 123 刷为 **272 条（D-275~D-546）** ＋ 2026-09 行末补批次 123 说明；**2026-09-21 批次 124 未刷本行**（如实登记的**登记缺口**：其正文已到 274 条，本行停在 272）；2026-09-21 批次 125 **一并刷为 275 条（D-275~D-549）**（含批次 124 的 `D-547` / `D-548`）＋ 2026-09 行末补批次 125 说明；**2026-09-21 批次 127 一并将批次 126 未刷的那一条补上**——2026-09 行由 **277 条（D-275~D-551）刷为 279 条（D-275~D-553）**（含批次 126 的 `D-550` / `D-551`）＋ 行末补批次 126 / 批次 127 说明；**2026-09-21 批次 128 刷为 280 条（D-275~D-554）** ＋ 行末补批次 128 说明；**2026-09-21 批次 129 刷为 281 条（D-275~D-555）** ＋ 行末补批次 129 说明；**2026-09-21 批次 130 刷为 282 条（D-275~D-556）** ＋ 行末补批次 130 说明；**2026-09-21 批次 131 刷为 283 条（D-275~D-557）** ＋ 行末补批次 131 说明） |
...
| .ctx/logs/2026-09-EXECUTION_LOG.md | 2026-09-21 | — | [工程师]+[AI] | 9月执行日志（当前活跃；2026-09-20 批次 114 补登批次 114 节；2026-09-20 批次 115 补登批次 115 节；2026-09-20 批次 116 补登批次 116 节；2026-09-20 批次 117 补登批次 117 节；2026-09-20 批次 118 补登批次 118 节；2026-09-21 批次 120 补登批次 120 节〔批次 119 未刷本行，本批只补 120〕；2026-09-21 批次 121 补登批次 121 节；2026-09-21 批次 122 补登批次 122 节；2026-09-21 批次 123 补登批次 123 节；2026-09-21 批次 124 补登批次 124 节；2026-09-21 批次 125 补登批次 125 节；**2026-09-21 批次 126 / 批次 127 各补登一节**（批次 126 未刷本行、本批一并补）；**2026-09-21 批次 128 补登一节**；**2026-09-21 批次 129 补登一节**（含「收尾实测（`R-85` 全量）」实跑数字）；**2026-09-21 批次 130 补登一节**（队列 8 条「低风险自决项」的前置判定：5 条早已落地、3 条列集中议 ⇒ **0 条自决**；含两张判定表 / 前提不符 / 两处计数不一致 / 反查 / `R-85` 全量）；**2026-09-21 批次 131 补登一节**（SOP「支委分工」对照系统复审（第三次）：**系统实然表 15 行 · SOP 分工分布清单（10 文件 ＋ help 页 ＋ 只登记 5 处）· 改准 22 行（`docs/help.html`）· (乙) 判据 4 组 · (丙) 上报 4 条 · 反查 11 组 · 真机 14 项（11 正 / 3 反）· `R-85` 全量 ＋ 停服**））**；**2026-09-21 批次 132 补登一节**（**两条支书口径同时改准**：会议考勤上传位**按会议类型分**〔修正 `D-548` 一刀切〕＋ 品牌认定＝**提案 → 支委会通过后确定**；含逐类规则表 · 母本 / 帮助页改准 · 真机 36 正 / 0 反 · 反查与版本戳 · `R-85` 全量 ＋ 停服）**） |
| .ctx/logs/2026-09-DECISION_LOG.md | 2026-09-21 | — | [工程师]+[AI] | 9月决策日志（当前活跃；2026-09-20 批次 114 补登 `D-535` ＋ 立「归位三」节；2026-09-20 批次 115 补登 `D-536` ＋「归位三」批次 115 补注段 ＋ 本月目录 1 行；2026-09-20 批次 116 补登 `D-537` ＋ 本月目录 1 行 ＋ 文首 / 文末续编说明编号起止；2026-09-20 批次 117 补登 `D-538` ＋ `D-522` / `D-526` 各 1 行补注 ＋ 本月目录 1 行 ＋ 目录说明口径 ＋ 文首 / 文末续编说明编号起止；2026-09-20 批次 118 补登 `D-539` ＋ 本月目录 1 行 ＋ 目录说明口径 ＋ 文首 / 文末续编说明编号起止；2026-09-21 批次 120 补登 `D-542` ＋ 本月目录 1 行 ＋ 目录说明口径 ＋ 文首 / 文末续编说明编号起止；2026-09-21 批次 121 补登 `D-543` ＋ 立「归位四」节（10 段逐字）＋ 本月目录 1 行 ＋ 文首 / 文末续编说明编号起止 ＋ `D-535` 未做条补记；2026-09-21 批次 122 补登 `D-544` ＋ 本月目录 1 行 ＋ 目录说明口径 ＋ 文首 / 文末续编说明编号起止；2026-09-21 批次 123 补登 `D-545` / `D-546` ＋ 本月目录 2 行 ＋ 目录说明口径 ＋ 文首 / 文末续编说明编号起止；2026-09-21 批次 124 补登 `D-547` / `D-548` ＋ 本月目录 2 行 ＋ 文首 / 文末续编说明编号起止；2026-09-21 批次 125 补登 `D-549` ＋ 本月目录 1 行 ＋ 目录说明口径 ＋ 文首 / 文末续编说明编号起止；**2026-09-21 批次 126 / 批次 127 各补登**（`D-550` / `D-551`；`D-552` / `D-553`）＋ 本月目录各 1–2 行 ＋ 文首 / 文末续编说明编号起止（**下一条自 `D-554`**）；**2026-09-21 批次 128 补登 `D-554`** ＋ 本月目录 1 行 ＋ 文首 / 文末续编说明编号起止（**下一条自 `D-555`**））；**2026-09-21 批次 129 补登 `D-555`** ＋ 本月目录 1 行 ＋ `D-554` 那行状态改「已被 `D-555` 收口」 ＋ 文首 / 文末续编说明编号起止改 **`D-275`…`D-555`（281 条）**（**下一条自 `D-556`**）；**2026-09-21 批次 130 补登 `D-556`** ＋ 本月目录 1 行 ＋ 文首 / 文末续编说明编号起止改 **`D-275`…`D-556`（282 条）**（**下一条自 `D-557`**）；**2026-09-21 批次 131 补登 `D-557`** ＋ 本月目录 1 行 ＋ 文首 / 文末续编说明编号起止改 **`D-275`…`D-557`（283 条）**（**下一条自 `D-558`**）；**2026-09-21 批次 132 补登 `D-558` / `D-559`** ＋ 本月目录 2 行 ＋ 目录说明口径改「截至批次 132」＋ 文首 / 文末续编说明编号起止改 **`D-275`…`D-559`（285 条）**（**下一条自 `D-560`**）） |
...
| content/02_institution/SYSTEM_ROLE_PERMISSION.md | 2026-09-21 | — | [工程师]+[AI] | 系统角色权限矩阵（2026-09-05 自 ROLE_CLASSIFICATION.md §九 拆出：角色键全表 9a0 + 权限矩阵/赋权链 + 双轨约定 §9f；2026-09-17 增 §9j 匿名反馈查看真身权限；2026-09-20 批次 115 §9l 加「系统默认值的取齐记录」（考勤确认 / 汇总：24h→1 天、48h→2 天）与「对照项（二）：上级规定的时限下限不属支部可调」＋ 变更历史 1 行，frontmatter 同步；2026-09-21 批次 124 §9l「同族登记项（一）」补登**思想汇报字数**（1500 / 1200，系依族例登记的推导——支书未就本数字逐条明答，`D-547`）＋ 变更历史 1 行） |
...
| content/02_institution/sop/常见工作场景快速指南.md | 2026-09-17 | — | [用户]+[AI] | |
| content/02_institution/sop/支委与党小组定人定责定岗说明.md | 2026-09-17 | — | [用户]+[AI] | |
| content/02_institution/sop/宣传委员工作流程指南.md | 2026-09-21 | — | [用户]+[AI] | 2026-09-21 批次 121 改准四处「反向过时」说明（`:57` 照片墙已实现、`:111` 图片管理规则括注、`:119` 周报自动生成与通知支书已实现、`:121` 图片管理已实现），frontmatter 同步 |
| content/02_institution/sop/纪检委员工作流程指南.md | 2026-09-21 | — | [用户]+[AI] | 2026-09-20 批次 116 `:175`「汇总本月出勤率 → 公示」→「**→ 交支委会（不公示、不对外）**」（依支书定案「支委会 + 当事人本人」，`D-537`），frontmatter 同步；批次 119 `:86` §2.1 补「考察同流程含**同款打回**（含申诉先核实）」（依支书定案「与纪检对齐，可打回」，`D-541`）；2026-09-21 批次 124 §1.2 `:61` 会议考勤权限句改准为「**上传＝该场会议组织者**；纪检管确认（打包确认）/ 录入总表 / 统计核对与更正」（依支书 2026-09-20 定案「会议考勤上传收归组织者」，`D-548`） |
| content/02_institution/sop/组织委员工作流程指南.md | 2026-09-20 | — | [用户]+[AI] | 2026-09-20 批次 115 `:202` 公示期「不少于 7 天」→「**不少于五个工作日**」（引上级《发展党员工作细则（2026年）》第十三条），frontmatter 同步 |
| content/02_institution/sop/党小组组长工作手册.md | 2026-09-15 | — | [用户]+[AI] | |
...
| content/04_web_design/data/DATA_MODEL.md | 2026-09-21 | — | [工程师]+[AI] | 数据模型设计（T-282 自 DATA_ARCHITECTURE 拆分 §二：20 类模型 + 写入验证 + 待办/通知派生 + 归档字段；2026-09-17 增 §2.29 匿名反馈核查留痕；2026-09-20 批次 110 改准 7 处、批次 111 补 §2.1 八字段行〔表体 24 → 32 行〕；**2026-09-20 批次 113 把该文件 frontmatter 与本报行一并刷为 2026-09-20**——原「表行仍随 frontmatter 的 2026-09-15、未刷」的旧注已作废，`S13` 现为真一致；**2026-09-21 批次 123 §2.1 新增 `signupClosed` 一行**（报名可手动关，`D-546`）＋ `signupEnabled` 行补「与下行的分工」，frontmatter 与本报行同步刷为 2026-09-21；2026-09-21 批次 124 §五「思想汇报篇幅软提示」行 `wordSoftMin` 由过时的 800 改准为 1200 并补「提醒只给提交人本人」；**2026-09-21 批次 126 改准 §2.16 一处实然句**——「系统上该动作当前仅向支书角色开放」→「**向支委层角色（支书 / 副支书 / 组织 / 宣传 / 纪检）开放**」（品牌认定与意见处置归支委会，`D-550`）） |
...
| server/test/form-loop-registry.mjs | 2026-09-21 | — | [工程师]+[AI] | 校验点台账（2026-09-21 批次 129 **补登**——本表原先无此行；本批 8 条 `line` 按实文同步`R-80`：`inspector.js` 4 条 · `references.js` 4 条；**批次 132：`leader/attendance-tab.js` 3 条（+3）与 `inspector.js` 4 条（-2）行号同步**） |
...
| docs/src/components/inspector.js | 2026-09-21 | — | [工程师]+[AI] | 检查器组件（产出物区/分类型关闭条件；2026-09-21 批次 129 议程行新增「报送党员大会表决」勾选位与「已定：报送党员大会表决」显示，随行位移台账 4 条行号同步；**批次 132：品牌认定按钮改「提案 / 撤回 / 取消认定」三态**〔取消「点一下即认定」〕＋ 议程项加「品牌认定：目标活动」徽标，随行位移台账 4 条行号再同步，`D-559`） |
| docs/src/components/modal.js | 2026-09-14 | — | [工程师]+[AI] | 模态框组件 |
...
| docs/src/entries/activity-entry.js | 2026-09-21 | — | [工程师]+[AI] | 活动/专班统一详情页入口（**2026-09-21 批次 132 补登**——本表原先无此行；本批品牌认定块由「一键切换」改为**提案 / 撤回 / 取消认定**三态，`D-559`） |
| docs/src/entries/settings-entry.js | 2026-09-21 | — | [工程师]+[AI] | 设置页入口（**2026-09-21 批次 132 补登**——本表原先无此行；本批「支部制度参数」卡新增「**不考勤的会议类型**」一行并改准记录人标签尾注，`D-558`） |
...
| docs/src/entries/tabs/secretary/calendar-tab.js | 2026-09-21 | — | [工程师]+[AI] | 支书工作台·日历 tab（2026-09-21 批次 129 **补登**——本表原先无此行；本批草案判据改走单一源 `isAgendaDraftDoc` ＋ 顺手修「拟上会」勾入制度草案丢 `branchDocId` 的既有缺陷） |
...
| docs/src/entries/tabs/prop/archive-tab.js | 2026-09-21 | — | [工程师]+[AI] | 档案归档 tab（T-279 M3 新建；2026-09-21 批次 120：**新增照片墙**——上传（走上传接口）/ 标注 / 按拍摄日期分组展示 ＋ 缩略图鉴权取 blob；**不新开 tab / 页面**） |
...
| docs/src/services/activity.js | 2026-09-21 | — | [工程师]+[AI] | 活动服务（**2026-09-21 批次 132：新增「品牌认定」段**——提案 / 撤回 / 取消认定 ＋ 纯函数 `applyBrandDesignationResult` ＋ 落库 `commitBrandDesignationResult`，`D-559`） |
