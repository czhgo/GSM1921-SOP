...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260922b';
import { AttendanceStatus } from '../core/domain.js?v=20260922b';
import { isApiMode } from './runtime.js?v=20260922b';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260922b';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260922b'),
      import('./attendance.js?v=20260922b'),
      import('./inspection.js?v=20260922b'),
      import('./issues.js?v=20260922b'),
    ]);
