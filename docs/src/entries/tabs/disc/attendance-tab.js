...
import { attendanceToLong, loadAttendanceRecords, loadActiveAttendanceRecords, saveAttendanceRecords, canUploadAttendance, upsertMeetingAttendance, MEETING_ATTENDANCE_TYPES as MEETING_TYPES, ABSENCE_REASONS, recorderRolesOf, listGroupMeetingAttendance } from '../../../services/attendance.js?v=20260912c';
...
import { getMeetingRoster, getRosterStats, getMeetingRosterCandidates } from '../../../services/roster.js?v=20260912c';
import { solidAccentStyle, ROLE_LABELS } from '../../../core/constants.js?v=20260912c';
...
import { showToast, downloadCSV, triggerPrint, _fmtDate, escHtml as esc } from '../../../core/utils.js?v=20260912c';
import { DISC_COMMISSIONER_ID } from './_shared.js?v=20260912c';
import { HandoffStore } from '../../../services/handoff.js?v=20260912c';
