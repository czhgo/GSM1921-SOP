...
import { _fmtDate, getBasePath } from '../../core/utils.js?v=20260922i';
...
import { isActivityArchived } from '../../core/constants.js?v=20260922i';
import { badgeHtml } from '../badges.js?v=20260922i';
import { deriveActivityLifecycleStatus, ACTIVITY_LIFECYCLE } from '../inspector.js?v=20260922i';
import { populateMonthSelector } from '../calendar.js?v=20260922i';
import { getCapabilities, mountCapability, getRuntimeEnv } from '../../core/registry.js?v=20260922i';
