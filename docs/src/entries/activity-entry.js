...
import { SignupStore } from '../services/signup.js?v=20260915g';
import { AuthStore } from '../services/auth.js?v=20260915g';
import { getPersonById } from '../services/person.js?v=20260915g';
import { getBasePath, escHtml as esc } from '../core/utils.js?v=20260915g';
import { getActivityTypeColors } from '../core/constants.js?v=20260915g';
import { getAppState } from '../core/state.js?v=20260915g';
...
import { canSignup as _canSignup, renderSignupSection, renderSignupList, bindSignupEvents, roleLabel } from '../components/signup-panel.js?v=20260915g';
import { renderShareButtonHtml, bindShareButton } from '../components/share-button.js?v=20260915g';
import { renderVoteWidget } from '../components/vote-widget.js?v=20260915g';
