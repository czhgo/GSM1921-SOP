...
const MODULE_META = {
  workspace: {
    ...
    roles: [
      { role: 'secretary', label: '党支部书记', desc: '组织统筹·赋权管理·全局决策', page: './ws-secretary.html', icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>' },
      { role: 'org-commissioner', label: '组织委员', desc: '专班建设·招募统筹·定人定责定岗', page: './ws-org-commissioner.html', icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>' },
      { role: 'prop-commissioner', label: '宣传委员', desc: '活动与专班视图·宣传材料·周报', page: './ws-prop-commissioner.html', icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"/></svg>' },
      { role: 'disc-commissioner', label: '纪检委员', desc: '考勤管理·考察管理·活动监督复盘', page: './ws-disc-commissioner.html', icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>' },
      { role: 'leader', label: '党小组组长', desc: '活动写入·考勤上传·考察上传', page: './ws-leader.html', icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" y1="22" x2="4" y2="15"/></svg>' },
      { role: 'organizer', label: '组织者', desc: '分工记录·复盘提交·考察查看', page: './ws-organizer.html', icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/></svg>' },
      { role: 'deep', label: '深度参与者', desc: '承担具体分工·任务状态更新', page: './ws-deep.html', icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M20.24 12.24a6 6 0 0 0-8.49-8.49L5 10.5V19h8.5z"/><line x1="16" y1="8" x2="2" y2="22"/></svg>' },
    ],
  },
  party: {
    title: '党务管理',
...
export function showRoleSelector(module) {
  ...
  const cardsHTML = meta.roles.map(r => `
    <button class="role-selector-card" data-role="${r.role}" data-page="${r.page}"
