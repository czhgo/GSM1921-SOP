...
import { PersonStore } from './person.js?v=20260912b';
import { bumpToken } from '../core/version-token.js?v=20260912b'; // P2 渲染守卫失效（spec §四.1）
import { getDataSource, getAdapter } from '../core/data-adapter.js?v=20260912b';
import { hashSubmitterToken } from '../core/constants.js?v=20260912b';
