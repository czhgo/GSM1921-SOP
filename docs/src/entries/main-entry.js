...
import { STATE, setState, registerRenderCallback, getAppState } from '../core/state.js?v=20260915e';
import { NoticeStore, renderNoticeList } from '../services/notice.js?v=20260915e';
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260915e';
import { getBasePath } from '../core/utils.js?v=20260915e';
import { loadAttendanceRecords, loadActiveAttendanceRecords } from '../services/attendance.js?v=20260915e';
...
import { getHeaderTitle } from '../services/branch.js?v=20260915e';
import { loadWorkspaceData } from '../core/data-loader.js?v=20260915e';
import { DATA_CHANGED_EVENT } from '../core/data-adapter.js?v=20260915e';
import '../modules/capabilities/activity-calendar.js?v=20260915e'; // 副作用导入：注册首页活动日历能力
// ── 方案 B 入口拆分：dashboard 区块渲染模块 ──
import { renderDashboardStats } from '../components/dashboard/stats.js?v=20260915e';
import { renderActivityList, renderActivityCalendar, initActivityTabs, getInitialActivityView } from '../components/dashboard/activity-panel.js?v=20260915e';
import { renderTaskforceList } from '../components/dashboard/taskforce-list.js?v=20260915e';
import { renderGallery } from '../components/dashboard/gallery.js?v=20260915e';
