...
import { WORK_MAP_MODULES, mergeWorkforceSnapshot } from '../core/work-map.js?v=20260912b';
import { getPersonName } from './person.js?v=20260912b';
import { AuthStore } from './auth.js?v=20260912b';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260912b';
import { fetchVotesStrict } from './committee-vote.js?v=20260912b';
