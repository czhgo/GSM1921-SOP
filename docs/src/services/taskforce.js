...
import { MOCK_TASKFORCES } from '../mock/index.js?v=20260921o';
import { isInitStateActive } from './init-reset.js?v=20260921o'; // C2 修复（2026-09-08）：init 态跳过演示种子兜底
import { getPersonName, liveMembers } from './person.js?v=20260921o';
import { evaluateWorkforceVotes } from './workforce.js?v=20260921o';
...
import { defaultVoteConfig, resolveVoterIds } from './vote-config.js?v=20260921o';
import { loadActivities } from './activity.js?v=20260921o';
import { AuthStore } from './auth.js?v=20260921o';
import { BRANCH_COMMISSION_ROLES } from '../core/constants.js?v=20260921o'; // 支委层应到名单单一源（勿手写）
