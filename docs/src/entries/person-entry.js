...
import { getBranchById } from '../services/branch.js?v=20260922i';
import { openPersonEditModal } from '../components/person-edit-modal.js?v=20260922i';
// Q-21-3 收敛（2026-09-13）：在册状态枚举单一源 = core/constants.js（原经 org-base-data-preview 转出）
import { ROLE_LABELS, SECRETARY_AND_DEPUTY_ROLES, RESIDENCE } from '../core/constants.js?v=20260922i';
import { getBasePath, escHtml as esc, fmtDt } from '../core/utils.js?v=20260922i';
import { badgeHtml } from '../components/badges.js?v=20260922i';
import { countThoughtReportsByPerson } from '../services/thought-report.js?v=20260922i';
