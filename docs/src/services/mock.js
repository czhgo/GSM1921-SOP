...
import { mockDB, SCHEMA_VERSION } from '../core/domain.js?v=20260811d';
import { generateId } from '../core/id.js?v=20260811d';
import { getDataSource, persist } from '../core/data-adapter.js?v=20260811d';
