...
import { setDataSource, registerMockAdapter } from '../../docs/src/core/data-adapter.js?v=20260919i';
import {
  POLICY_DEFAULTS, POLICY_OVERRIDABLE, POLICY_OVERRIDE_SECTIONS,
} from '../../docs/src/core/policy-defaults.js?v=20260919i';
// 批次 47-F 第二组并入：消费点导出面（原 policy-defaults-sync.test.mjs 的导入）
import { MEETING_ATTENDANCE_TYPES } from '../../docs/src/services/attendance.js?v=20260919i';
import { WORKFORCE_VOTE_DEFAULT } from '../../docs/src/services/workforce.js?v=20260919i';
import { getOverdueRecords } from '../../docs/src/services/inspection.js?v=20260919i';
import {
  sanitizeConfigPolicyOverrides, applyBranchPolicyOverrides,
} from '../../docs/src/core/config-clean.js?v=20260919i';
import {
  savePolicyOverrides, canManagePolicyOverrides, getBranchById,
} from '../../docs/src/services/branch.js?v=20260919i';
import {
  semesterDetainedWindowsLabel,
} from '../../docs/src/services/member-confirmation.js?v=20260919i';
import {
  leaderSemesterReportTermKey, isLeaderSemesterRemindWindow,
} from '../../docs/src/entries/tabs/today/today-tab.js?v=20260919i';
