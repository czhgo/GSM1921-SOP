...
import { ReferencesModule } from '../modules/references.js?v=20260920b';
import { renderSidebar } from '../components/sidebar.js?v=20260920b';
import { renderHeader } from '../components/header.js?v=20260920b';
import { BranchService } from '../services/runtime.js?v=20260920b'; // 注册 mock/api 适配器 + BranchService 绑定（loadDB）
