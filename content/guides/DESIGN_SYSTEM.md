...
> 创建日期：2026-05-02 | 关联文档：ROADMAP.md §九 DESIGN-OPT | 目标读者：[人机]
...
| 表单标签（label） | 衬线字体（CSS规则） | 推演工作台内所有label自动应用 |
...
| `content/guides/DESIGN_SYSTEM.md` | 设计系统规范文档（本文件） | Markdown |
| `ROADMAP.md` §九 | 设计优化项目规划 | Markdown |
...
| 查实施进度 | → ROADMAP.md §九 DESIGN-OPT-4 |
| 提交设计反馈 | → content/guides/SOP优化提案反馈卡.md |
