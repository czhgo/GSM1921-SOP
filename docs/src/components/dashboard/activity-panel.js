...
import { _fmtDate, getBasePath } from '../../core/utils.js?v=20260921m';
...
import { isActivityArchived } from '../../core/constants.js?v=20260921m';
import { badgeHtml } from '../badges.js?v=20260921m';
import { deriveActivityLifecycleStatus, ACTIVITY_LIFECYCLE } from '../inspector.js?v=20260921m';
import { populateMonthSelector } from '../calendar.js?v=20260921m';
import { getCapabilities, mountCapability, getRuntimeEnv } from '../../core/registry.js?v=20260921m';
