...
import { resolveConflicts, assertComposeValid } from '../../docs/src/core/module-compose.js?v=20260911a';
import { BLOCK_MANIFESTS } from '../../docs/src/workflow/blocks/manifests.js?v=20260911a';
