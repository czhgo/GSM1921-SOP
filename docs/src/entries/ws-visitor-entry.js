...
import { PEOPLE } from '../mock/index.js?v=20260807h';
import { loadWorkspaceData } from '../core/data-loader.js?v=20260807h';
import { loadAttendanceRecords } from '../services/attendance.js?v=20260807h';
import { loadInspectionRecords } from '../services/inspection.js?v=20260807h';
import { inspectionToDisplay } from '../mock/index.js?v=20260807h';
import { loadActivities } from '../services/activity.js?v=20260807h';
import { getActivityTypeColors, ROLE_COLORS } from '../core/constants.js?v=20260807h';
...
import { TodoStore, seedTodos, VisitorTodoDeriver } from '../services/todo.js?v=20260807h';
