...
import { BranchService } from '../services/runtime.js?v=20260913c'; // 副作用注册适配器 + BranchService 绑定（loadDB）
import { registerApiAdapter, setDataSource, init } from '../core/data-adapter.js?v=20260913c';
import { ApiAdapter } from '../core/api-adapter.js?v=20260913c';
import { AuthStore } from '../services/auth.js?v=20260913c';
import { getBranchById, getBranchIdOfPerson } from '../services/branch.js?v=20260913c';
import { mountOrgSetupWizard } from '../components/org-setup-wizard.js?v=20260913c';
