...
import { persist, getAdapter, getAuthToken, getApiBaseUrl, getDataSource } from '../core/data-adapter.js?v=20260914i';
import { AuthStore } from './auth.js?v=20260914i';
import { NoticeStore } from './notice.js?v=20260914i';
import { resolveVoterIds } from './vote-config.js?v=20260914i';
