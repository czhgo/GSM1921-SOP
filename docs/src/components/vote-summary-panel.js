...
import { fetchVotes, lockVotes } from '../services/committee-vote.js?v=20260909e';
import { optionSetOf } from '../services/vote-config.js?v=20260909e';
...
} from './resolution-followup-manager.js?v=20260909e';
