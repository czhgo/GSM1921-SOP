...
import { registerApiAdapter, init as dataInit, setDataSource, notifyDataLoaded, getAdapter, persist } from '../core/data-adapter.js?v=20260922h';
...
import { resolveVoterIds, defaultVoteConfig, optionSetOf, isAnonymousActivity } from '../services/vote-config.js?v=20260922h';
import { fetchVotes, tallyForItem } from '../services/committee-vote.js?v=20260922h';
import { renderVoteWidget } from '../components/vote-widget.js?v=20260922h';
import { renderVoteSummary } from '../components/vote-summary-panel.js?v=20260922h';
...
import { buildAgendaCandidates, AGENDA_CANDIDATE_GROUPS } from '../entries/tabs/secretary/agenda-form.js?v=20260922h';
import { listDocs as listBranchDocs, isAgendaDraftDoc, isInstitutionDraftAgendaItem } from '../services/branch-doc.js?v=20260922h';
...
import { listBrandProposals } from '../services/activity.js?v=20260922h';
