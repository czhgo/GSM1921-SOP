...
import { WORK_MAP_MODULES, mergeWorkforceSnapshot } from '../core/work-map.js?v=20260912c';
import { getPersonName } from './person.js?v=20260912c';
import { AuthStore } from './auth.js?v=20260912c';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260912c';
import { fetchVotesStrict } from './committee-vote.js?v=20260912c';
