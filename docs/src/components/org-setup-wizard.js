...
import { OUTPUT_BLOCK_DEFS, BRANCH_COMMISSION_ROLES, ROLE_LABELS, getAccentColors } from '../core/constants.js?v=20260915g';
// 副作用：注册支委层工作台能力（配置目录=其 tab 清单，单一源）
import '../modules/capabilities/secretary-workspace.js?v=20260915g';
import { BLOCK_MANIFESTS } from '../workflow/blocks/manifests.js?v=20260915g';
import { escHtml as esc, showToast, downloadBlob } from '../core/utils.js?v=20260915g';
import { WORK_MAP_MODULES } from '../core/work-map.js?v=20260915g';
import {
...
} from '../services/branch.js?v=20260915g';
import { buildConfigPackage, applyConfigPackage } from '../services/org-config-package.js?v=20260915g';
import {
  buildPreviewTemplate, sanitizePreview, applyPreview, clearPreview, getPreviewState,
  PREVIEW_KIND, PREVIEW_VERSION,
} from '../services/org-base-data-preview.js?v=20260915g';
import { getRosterStats, isDetained } from '../services/roster.js?v=20260915g';
import { buildOrgWizardReport } from '../services/org-wizard-report.js?v=20260915g';
import { PersonStore, getPersonName } from '../services/person.js?v=20260915g';
// R5-1（2026-09-06）：建空支部「就地任命首任骨干」——任命编排在 appointment.js 收口（含数据边界登记）
import { appointInauguralOfficers } from '../services/appointment.js?v=20260915g';
