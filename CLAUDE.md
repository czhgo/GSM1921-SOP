...
| ID    | 事项                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 引用流程                                                                                                | 修改对象                                                                                                              | 状态              |
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | --------------- |
| T-116 | **反论评议·系统性**（多轮持续）：全仓库反论的书记评议。**由 W4 专项评议循环承接**，轮次进度/已执行工作/书记特别要求见 `.ctx/REVIEW_QUEUE.md` 附录 ① | H5 书记评议 + USAGE\_POLICY §二.2.3 + OPERATIONS\_GUIDE §11 | 全仓库 | 🔄 进行中（W4 承接） |
| T-117 | **理论复用评议**（多轮持续机制，书记 2026-08-06：「理论复用评议绝不是最后一轮」）：全仓库跨节/跨文件引用复用的书记评议。**由 W4 专项评议循环承接**，轮次进度/已执行工作/书记特别要求见 `.ctx/REVIEW_QUEUE.md` 附录 ② | H5 书记评议 + H2.2 母本子本 + OPERATIONS\_GUIDE §1.4 散落即漂移 | 全仓库 | 🔄 进行中（W4 承接） |
...
| T-195 | **黑话审查**（表述维度专项，可多轮）：全仓库 AI 编造黑话的书记审查（源头污染优先 + 基线方法 grep 验证）。**由 W4 专项评议循环承接（专项③）**，第1-3轮已完成归档、第4轮待书记发起，轮次进度/已执行工作/书记特别要求见 `.ctx/REVIEW_QUEUE.md` 附录 ③ | H5 书记评议 + sample-diff-learning + H5.8.2 D 表述 | 全仓库用户文档 | 🔄 进行中（W4 承接） |
| T-200 | **书记原话逐条复核**（长期）：SECRETARY_PRONOUNCEMENTS.md 每一条论断需由书记逐条过一遍，确认是否为准确原话；AI 不得自行改动未经书记确认的原话。**由 W4 专项评议循环承接（专项④）**，已复核至 P-014 定稿 + 章节重组迁出，轮次进度/已执行工作/书记特别要求见 `.ctx/REVIEW_QUEUE.md` 附录 ④ | H5 书记评议 | content/01_strategy/SECRETARY_PRONOUNCEMENTS.md | 🔄 进行中（W4 承接） |
