...
import { SignupStore, canCloseActivitySignup, closeActivitySignup, SignupStatus } from '../services/signup.js?v=20260921f';
import { AuthStore } from '../services/auth.js?v=20260921f';
import { getPersonById } from '../services/person.js?v=20260921f';
import { getBasePath, escHtml as esc, showToast } from '../core/utils.js?v=20260921f';
import { getActivityTypeColors } from '../core/constants.js?v=20260921f';
import { getAppState } from '../core/state.js?v=20260921f';
...
import { canSignup as _canSignup, renderSignupSection, renderSignupList, bindSignupEvents, roleLabel } from '../components/signup-panel.js?v=20260921f';
import { renderShareButtonHtml, bindShareButton } from '../components/share-button.js?v=20260921f';
...
import { settleWrites } from '../core/pending-writes.js?v=20260921f';
