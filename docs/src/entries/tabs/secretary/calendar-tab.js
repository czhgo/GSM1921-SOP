...
import { getAppState, setState } from '../../../core/state.js?v=20260921l';
import { showToast, escHtml as esc } from '../../../core/utils.js?v=20260921l';
import { scrollDetailIntoView } from '../../../components/detail-anchor.js?v=20260921l';
import { populateMonthSelector, renderCalendarByActivities } from '../../../components/calendar.js?v=20260921l';
import { renderInspectorFromState, _draftMaterialCount } from '../../../components/inspector.js?v=20260921l';
import { computeSecretaryStats } from '../../../services/roles.js?v=20260921l';
import { PersonPicker } from '../../../components/person-picker.js?v=20260921l';
import { openModal, closeModal } from '../../../components/modal.js?v=20260921l';
import { DecisionTreeState, renderWorkflowPanel, writeActivityWithSOP } from '../../../services/decision-tree.js?v=20260921l';
import { loadActivities, listBrandProposals } from '../../../services/activity.js?v=20260921l';
import { renderQueryView } from '../../../components/query-view.js?v=20260921l';
import { icon } from '../../../core/icons.js?v=20260921l';
import { loadAttendanceRecords } from '../../../services/attendance.js?v=20260921l';
...
import { ACTIVITY_CLASSIFICATION, classifyActivityType, normalizeActivityType, dotDarkVars, SCENARIO_WRITE_IDS, SCENARIO_LABELS } from '../../../core/constants.js?v=20260921l';
// R1-A 点⑤（2026-09-09）：强调色渲染统一 person-aware 动态解析（替代模块级 resolveAccentRole 快照）
import { getAppliedAccentColors } from '../../../core/theme.js?v=20260921l';
import { badgeHtml } from '../../../components/badges.js?v=20260921l';
import { collectAgendaRows, buildAgendaCandidates, AGENDA_CANDIDATE_GROUPS } from './agenda-form.js?v=20260921l';
import { defaultVoteConfig, isDecisionScenario, resolveVoterIds, isAnonymousForced } from '../../../services/vote-config.js?v=20260921l';
import { AuthStore } from '../../../services/auth.js?v=20260921l';
import { getBranchIdOfPerson, getBranchById, applyWorkflowBlockPolicy } from '../../../services/branch.js?v=20260921l';
// 支部文件读侧收敛点（2026-09-10）：会前草案下拉经 branch-doc 服务读取（按归属支部过滤，跨支部不可见）
import { listDocs as listBranchDocs, isAgendaDraftDoc } from '../../../services/branch-doc.js?v=20260921l';
// L3 S4（2026-09-03）：主题党日工作流块 manifest 驱动试点（入口守卫 + 表单元数据单一源）
import { BLOCK_MANIFESTS, THEME_PARTY_DAY_MANIFEST } from '../../../workflow/blocks/manifests.js?v=20260921l';
// B1（2026-09-12）：党委下钻支部的演示只读视图判定（单一源 = modules/branch-demo-nav.js）
import { isReadonlyBranchDrilldown } from '../../../modules/branch-demo-nav.js?v=20260921l';
...
function openWriteModal() {
  ...
  openModal({
    ...
    onMount: (panel) => {
      ...
      // 浮窗页脚就近深链（2026-09-19 批次 99）：本浮窗要定的制度口径（票决门槛 / 应到名单核对 /
      // 会议考勤类型）集中在设置的「支部制度参数」分区，就地给去该分区的入口（设置页顶部有「← 返回上一页」）。
      // 加在 .modal-body 之外的页脚：切步骤只重绘 body，本条不随步骤消失。
      const foot = document.createElement('div');
      foot.style.cssText = 'padding:10px 20px;border-top:1px solid var(--neutral-200);font-size:0.72rem;line-height:1.7;color:var(--neutral-500);';
      foot.innerHTML = '相关设置：<a href="./settings.html#branch-policy-params" style="color:var(--app-accent,#B91C1C);text-decoration:underline;">活动制度口径（票决门槛 / 应到名单核对 / 考勤类型）→ 支部制度参数</a>';
...
async function _loadAgendaCandidateSources() {
  ...
  const [{ TaskForceRecordStore }, { IssueStore }, { loadDevStageOverrides }] = await Promise.all([
    import('../../../services/taskforce.js?v=20260921l'),
    import('../../../services/issues.js?v=20260921l'),
    import('../../../services/member-confirmation.js?v=20260921l'),
  ]);
