import { setState, registerRenderCallback } from '../core/state.js?v=20260807i';
import { showToast } from '../core/utils.js?v=20260807i';
import { CrossPageState } from '../core/cross-page-state.js?v=20260807i';
import { bootstrapPage } from '../core/bootstrap.js?v=20260807i';
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS, ReviewStatus, SourceType, OutputType, deriveOutputRoute } from '../core/domain.js?v=20260807i';
import { persist } from '../core/data-adapter.js?v=20260807i';
import { attendanceToLong, attendanceToWide, inspectionToLong, inspectionToWide, reviewToDisplay, getPersonName } from '../mock/index.js?v=20260807i';
import { loadWorkspaceData } from '../core/data-loader.js?v=20260807i';
import { renderTabBar } from '../components/tab-bar.js?v=20260807i';
import { openFormModal } from '../components/modal.js?v=20260807i';
import { autoGenerateMakeupTask, loadMakeupTasks, saveMakeupTasks } from '../services/makeup.js?v=20260807i';
import { loadAttendanceRecords, saveAttendanceRecords } from '../services/attendance.js?v=20260807i';
import { loadInspectionRecords, getOverdueRecords, confirmInspectionRecord, deleteInspectionRecord, getRecordsBySource } from '../services/inspection.js?v=20260807i';
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260807i';
import { loadActivities } from '../services/activity.js?v=20260807i';
import { loadActivityReviews, loadTaskforceReviews, updateReviewById } from '../services/review.js?v=20260807i';
import { renderMyDispatchTab, bindMyDispatchEvents } from '../services/issues.js?v=20260807i';
import { renderTodoList } from '../components/todo-list.js?v=20260807i';
import { TodoStore, TodoSourceType, TodoCategory, TodoActionType, seedTodos } from '../services/todo.js?v=20260807i';
import { enhanceSelects } from '../components/custom-select.js?v=20260807i';
import { badgeHtml } from '../components/badge.js?v=20260807i';
