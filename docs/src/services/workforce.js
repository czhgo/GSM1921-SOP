...
import { ROLE_LABELS } from '../core/constants.js?v=20260920d';
import { POLICY_DEFAULTS } from '../core/policy-defaults.js?v=20260920d';
import { WORK_MAP_MODULES, mergeWorkforceSnapshot, canDisableModule } from '../core/work-map.js?v=20260920d';
import { getPersonName } from './person.js?v=20260920d';
import { AuthStore } from './auth.js?v=20260920d';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260920d';
import { fetchVotesStrict } from './committee-vote.js?v=20260920d';
import { TodoStore, TodoCategory, TodoSourceType, WORK_DOMAIN } from './todo.js?v=20260920d';
