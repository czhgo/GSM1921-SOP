...
import { setState, STATE, getAppState } from '../core/state.js?v=20260920g';
import { ROLE_COLORS, ROLE_LABELS, ROLE_THEME_CLASS, COMMISSIONER_ROLES, ACTIVITY_CLASSIFICATION } from '../core/constants.js?v=20260920g';
import { _fmtChinese, showToast, escHtml as esc } from '../core/utils.js?v=20260920g';
import { icon } from '../core/icons.js?v=20260920g';
import { openModal, closeModal } from './modal.js?v=20260920g';
// 数据域接线收口（2026-09-03）：支部成员名单经 services/person.js 获取（原直连 mock PEOPLE）
// 实时视图（非快照）：成员增删即时可见——见 services/person.js liveMembers 说明
const PEOPLE = liveMembers();
import { getPersonById } from '../services/person.js?v=20260920g';
...
import { statusBadgeHtml, bindStatusBadge, badgeHtml } from './badges.js?v=20260920g';
import { persist, getAuthToken, getApiBaseUrl, getAdapter } from '../core/data-adapter.js?v=20260920g';
...
import { createEditableAgenda, normalizeEditedAgenda } from '../services/agenda-editing.js?v=20260920g';
// 议程更新后通知全员（活动锚定，targetType/targetId 供归档联动）
import { NoticeStore } from '../services/notice.js?v=20260920g';
import { fetchVotes, submitVote } from '../services/committee-vote.js?v=20260920g';
import { optionSetOf, resolveVoterIds, OPTION_SETS, isAnonymousActivity } from '../services/vote-config.js?v=20260920g';
import { renderVoteSummary } from './vote-summary-panel.js?v=20260920g';
import { loadAttendanceRecords } from '../services/attendance.js?v=20260920g';
import { loadInspectionRecords } from '../services/inspection.js?v=20260920g';
import { loadActivityReviews } from '../services/review.js?v=20260920g';
import { mockDB, OutputType, deriveOutputRoute, ReviewStatus, AttendanceStatus } from '../core/domain.js?v=20260920g';
