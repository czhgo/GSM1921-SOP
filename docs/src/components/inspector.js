...
import { setState, STATE, getAppState } from '../core/state.js?v=20260829j';
import { ROLE_COLORS, ROLE_LABELS, ROLE_THEME_CLASS, COMMISSIONER_ROLES } from '../core/constants.js?v=20260829j';
import { _fmtChinese, showToast } from '../core/utils.js?v=20260829j';
import { icon } from '../core/icons.js?v=20260829j';
import { openModal, closeModal } from './modal.js?v=20260829j';
import { PEOPLE, getPersonById } from '../mock/index.js?v=20260829j';
import { BranchService } from '../services/runtime.js?v=20260829j';
import { AuthStore } from '../services/auth.js?v=20260829j';
import { statusBadgeHtml, bindStatusBadge } from './status-badge.js?v=20260829j';
import { badgeHtml } from './badge.js?v=20260829j';
import { persist, getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260829j';
import { loadAttendanceRecords } from '../services/attendance.js?v=20260829j';
import { loadInspectionRecords } from '../services/inspection.js?v=20260829j';
import { loadActivityReviews } from '../services/review.js?v=20260829j';
import { mockDB, OutputType, deriveOutputRoute, ReviewStatus, AttendanceStatus } from '../core/domain.js?v=20260829j';
