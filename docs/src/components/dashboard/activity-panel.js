...
import { _fmtDate, getBasePath } from '../../core/utils.js?v=20260829q';
...
import { deriveActivityLifecycleStatus, ACTIVITY_LIFECYCLE } from '../inspector.js?v=20260829q';
import { populateMonthSelector } from '../calendar.js?v=20260829q';
import { getCapabilities, mountCapability } from '../../core/registry.js?v=20260829q';
