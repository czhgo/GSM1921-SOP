...
date: "2026-09-10"
version: "v27"
milestone: "2026-09-11/12 续批（第七批）：R-14 样式表专批落地（特批 1 styles.css .ref-* 灰字 --neutral-400→500 浅 2.54→4.83；特批 2 about.css 浅色族 --ab-ink-faint #94897A→#6C6254、.ab-tl-stage 2.40→4.93、.ab-tl-no--decision 2.28→5.83（装饰编号豁免）；特批 3 status-badge pending 双态分档 浅 3.39→4.84 / 深 6.44→7.37；控制组 20 行零变化）+ 乙部仅余 R-15（深色 about 3 处 4.15/3.82/4.15，需另行专批）；版本串随日期滚动 20260912a / CODE_VERSION 107"
---
...
> **上版**: v26 (2026-09-11)
> **变更来源**: 2026-09-10/11/12（六批 + 本批共七批，T-077 追加批次 1~8；见 v27/v26/v25/v24/v23 里程碑行；测试/文件计数一律以实测为准）
