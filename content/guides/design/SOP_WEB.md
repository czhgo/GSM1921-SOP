...
> **T42 轮核心架构决策**（丙部 P.1~P.3 决策归档：D-1/D-2/D-3）。
...
Header 显示角色切换器 + 模式切换器
    ...
    |
    +-- 模式切换器点击 → 切换 manage <-> observe
    |     → 派发 view:mode-change 事件
    |     → 仅在 active = primary 时可切换
...
> **2026-05-18 修正，对齐 CLAUDE.md H2.5+H2.6 (D-15)**
