...
import { showToast, flashHighlight } from '../core/utils.js?v=20260922e';
import { dutyCardHtml } from './workforce-duty-card.js?v=20260922e';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260922e';
import { IssueStore } from '../services/issues.js?v=20260922e';
import { AuthStore } from '../services/auth.js?v=20260922e';
import { solidAccentStyle, dotDarkVars, isActivityEnded, isActivityArchived } from '../core/constants.js?v=20260922e';
import { loadActivities } from '../services/activity.js?v=20260922e';
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260922e';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260922e';
...
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260922e';
...
import { renderFilteredList } from './list-filter.js?v=20260922e';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260922e');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260922e');
