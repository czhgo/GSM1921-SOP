...
import { showToast, flashHighlight } from '../core/utils.js?v=20260829l';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260829l';
import { IssueStore, REPORT_CATEGORIES } from '../services/issues.js?v=20260829l';
import { AuthStore } from '../services/auth.js?v=20260829l';
import { solidAccentStyle, dotDarkVars } from '../core/constants.js?v=20260829l';
import { loadActivities } from '../services/activity.js?v=20260829l';
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260829l';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260829l';
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260829l';
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260829l';
import { PEOPLE } from '../mock/people.js?v=20260829l';
import { getPersonName } from '../mock/index.js?v=20260829l';
import { AttendanceStatus } from '../core/domain.js?v=20260829l';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260829l');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260829l');
