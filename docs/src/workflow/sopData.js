  ...
  scenarios: [
    {
      ...
      tasks: [
        ...
        { taskId: '1a-4b', title: '发布考勤二维码',     executor: 'leader',           supervisor: null,         timeOffset:  0, desc: '现场组织的党小组长负责在会议现场发布考勤二维码，供与会党员扫码签到。 - Source: content/SOP/常见工作场景快速指南.md#党建工作组织生活会严肃政治会议' },
    ...
    },
    {
      ...
      tasks: [
        ...
        { taskId: '1b-6a', title: '考勤确认',            executor: 'disc-commissioner',supervisor: 'leader',     timeOffset:  0, desc: '活动结束后，党小组活动考勤由组长上传，纪检委员确认后录入考勤总表。会议考勤由纪检委员直接上传并录入。 - Source: 纪检委员工作流程指南 §一「考勤管理」' },
        ...
        { taskId: '1b-7c', title: '考察确认',            executor: 'disc-commissioner',supervisor: 'leader',     timeOffset:  3, desc: '党小组活动考察由组长上传，纪检委员确认后录入考察总表。专班考察由专班负责人/组织委员上传，纪检委员确认后录入。 - Source: 纪检委员工作流程指南 §二「考察管理」' },
    ...
    },
    {
      ...
      tasks: [
        ...
        { taskId: '4-1b', title: '书记审批立项',        executor: 'secretary',        supervisor: null,         timeOffset: null, desc: '块块组长向支部书记报告活动方案；书记审批同意后方可推进，参考主题党日流程。' },
