...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260920a';
import { AttendanceStatus } from '../core/domain.js?v=20260920a';
import { isApiMode } from './runtime.js?v=20260920a';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260920a';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260920a'),
      import('./attendance.js?v=20260920a'),
      import('./inspection.js?v=20260920a'),
      import('./issues.js?v=20260920a'),
    ]);
