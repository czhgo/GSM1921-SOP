...
import { ROLE_COLORS, getActivityColor, ACTIVITY_CATEGORY_COLORS, ACTIVITY_TYPE_LABELS, ACTIVITY_TYPE_SHORT } from '../core/constants.js?v=20260919j';
import { _fmtDate, _currentYearMonth } from '../core/utils.js?v=20260919j';
import { tokenOf } from '../core/version-token.js?v=20260919j'; // P2 视图渲染守卫数据版本（spec §四.2）
import { filterTasksByManagementRole, activityLifecycleBadgeHtml } from './inspector.js?v=20260919j';
