...
import { MOCK_TASKFORCES, PEOPLE } from '../mock/index.js?v=20260912c';
import { isInitStateActive } from './init-reset.js?v=20260912c'; // C2 修复（2026-09-08）：init 态跳过演示种子兜底
import { getPersonName } from './person.js?v=20260912c';
import { evaluateWorkforceVotes } from './workforce.js?v=20260912c';
...
import { BranchService } from './runtime.js?v=20260912c';
import { NoticeStore } from './notice.js?v=20260912c';
import { defaultVoteConfig, resolveVoterIds } from './vote-config.js?v=20260912c';
...
export const TaskForceRecordStore = {
  ...
  add(record) {
    ...
    if (!newRecord.members || newRecord.members.length === 0) {
      import('./todo.js?v=20260912c').then(({ LifecycleTodoDeriver }) => {
