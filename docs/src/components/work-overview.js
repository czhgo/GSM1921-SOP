...
import { showToast, flashHighlight } from '../core/utils.js?v=20260915e';
import { dutyCardHtml } from './workforce-duty-card.js?v=20260915e';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260915e';
import { IssueStore } from '../services/issues.js?v=20260915e';
import { AuthStore } from '../services/auth.js?v=20260915e';
import { solidAccentStyle, dotDarkVars, isActivityEnded, isActivityArchived } from '../core/constants.js?v=20260915e';
import { loadActivities } from '../services/activity.js?v=20260915e';
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260915e';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260915e';
// S3③（2026-09-12）：补课口径统一——概况补课缺口与「补课制度」表同源（services/makeup.js）
import { loadMakeupTasks } from '../services/makeup.js?v=20260915e';
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260915e';
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260915e';
...
import { renderFilteredList } from './list-filter.js?v=20260915e';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260915e');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260915e');
