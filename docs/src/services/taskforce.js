...
import { MOCK_TASKFORCES } from '../mock/index.js?v=20260919k';
import { isInitStateActive } from './init-reset.js?v=20260919k'; // C2 修复（2026-09-08）：init 态跳过演示种子兜底
import { getPersonName, liveMembers } from './person.js?v=20260919k';
import { evaluateWorkforceVotes } from './workforce.js?v=20260919k';
...
import { BranchService } from './runtime.js?v=20260919k';
import { NoticeStore } from './notice.js?v=20260919k';
import { defaultVoteConfig, resolveVoterIds } from './vote-config.js?v=20260919k';
import { loadActivities } from './activity.js?v=20260919k';
import { AuthStore } from './auth.js?v=20260919k';
import { BRANCH_COMMISSION_ROLES } from '../core/constants.js?v=20260919k'; // 支委层应到名单单一源（勿手写）
...
export const TaskForceRecordStore = {
  ...
  add(record) {
    ...
    if (!newRecord.members || newRecord.members.length === 0) {
      import('./todo.js?v=20260919k').then(({ LifecycleTodoDeriver }) => {
