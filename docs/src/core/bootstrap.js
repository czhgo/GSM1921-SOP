...
import { CrossPageState } from './cross-page-state.js?v=20260912j';
import { getBasePath } from './utils.js?v=20260912j';
import { enhanceSelects } from '../components/custom-select.js?v=20260912j';
// 立项⑦ B波 演示放行门（单一源，与「进入支部（演示）」按钮同口径）
import { isPartyStaffBranchDemoAllowed } from '../modules/branch-demo-nav.js?v=20260912j';
// A② 归档兜底放行门（2026-09-10）：书记/副书记 archive=Y 兜底权限——可进入宣传台归档兜底面
import { isArchiveFallbackPage } from './constants.js?v=20260912j';
...
import { getAppliedAccentColors } from './theme.js?v=20260912j';
import { registerApiAdapter, init } from './data-adapter.js?v=20260912j';
import { ApiAdapter } from './api-adapter.js?v=20260912j';
import { getCapabilities } from './registry.js?v=20260912j';
