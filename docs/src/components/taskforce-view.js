...
import { dotDarkVars } from '../core/constants.js?v=20260921b';
import { flashHighlight, showToast } from '../core/utils.js?v=20260921b';
import { anchorDetailToTrigger } from './detail-anchor.js?v=20260921b';
