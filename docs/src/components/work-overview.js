...
import { dutyCardHtml } from './workforce-duty-card.js?v=20260921m';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260921m';
import { IssueStore } from '../services/issues.js?v=20260921m';
import { AuthStore } from '../services/auth.js?v=20260921m';
import { solidAccentStyle, dotDarkVars, isActivityEnded, isActivityArchived } from '../core/constants.js?v=20260921m';
import { loadActivities } from '../services/activity.js?v=20260921m';
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260921m';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260921m';
...
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260921m';
...
import { renderFilteredList } from './list-filter.js?v=20260921m';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260921m');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260921m');
