...
import { ROLE_LABELS } from '../core/constants.js?v=20260914e';
import { POLICY_DEFAULTS } from '../core/policy-defaults.js?v=20260914e';
import { WORK_MAP_MODULES, mergeWorkforceSnapshot, canDisableModule } from '../core/work-map.js?v=20260914e';
import { getPersonName } from './person.js?v=20260914e';
import { AuthStore } from './auth.js?v=20260914e';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260914e';
import { fetchVotesStrict } from './committee-vote.js?v=20260914e';
import { TodoStore, TodoCategory, TodoSourceType, WORK_DOMAIN } from './todo.js?v=20260914e';
