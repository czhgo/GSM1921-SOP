...
import { persist, flushSnapshot, getDataSource } from '../core/data-adapter.js?v=20260921k';
import { THOUGHT_REPORTS } from '../mock/index.js?v=20260921k';
import { POLICY_DEFAULTS } from '../core/policy-defaults.js?v=20260921k';
// 期次纯函数单一源 = core/period.js（服务层与通知模板共用，避免 core→services 环依赖）
import { PERIOD_RE, periodOf, periodLabel, comparePeriodDesc } from '../core/period.js?v=20260921k';
...
export { PERIOD_RE, periodOf, periodLabel, comparePeriodDesc, periodOptions } from '../core/period.js?v=20260921k';
