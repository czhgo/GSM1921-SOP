...
export const sopDatabase = {
  scenarios: [
    ...
    {
      scenarioId: 'branch-party-meeting', title: '【活动建设】支部党员大会',
      domain: 'activity', description: '刚性考勤 · 仅限党员和预备党员',
      tasks: [
        { taskId: '1c-0', title: '时间统筹（三组长协调）',  executor: 'leader',           supervisor: null,             timeOffset: -7, desc: '三位党小组长各自统计本组党员可用时间，取最大公因数（重叠时间段）；在支委群中同步结果；由支部书记在党支部大群统一发布，要求全员至少参与一场。' },
        { taskId: '1c-1', title: '确定会议主题',        executor: 'leader',           supervisor: null,         timeOffset: -7, desc: '块块组长根据支委会部署确定会议主题，确保与年度工作重点一致。' },
        { taskId: '1c-2', title: '会前谈心谈话',        executor: 'leader',           supervisor: null,         timeOffset: -7, desc: '组长与本组党员逐一谈心，了解思想状况，为会议提供信息基础。' },
        { taskId: '1c-2b', title: '全员述职回顾',       executor: 'all',              supervisor: 'leader',     timeOffset: -5, desc: '会前5天，全体参会党员回顾总结过去一年在党支部中承担的工作（述职），作为个人对照检查材料的基础素材。' },
        { taskId: '1c-4', title: '通知到人',          executor: 'leader',           supervisor: null,         timeOffset: -3, desc: '块块组长通过党小组群发送正式会议通知，注明时间、地点、参会要求，必须提前至少3天；如需覆盖全支部，由支部书记通过党支部大群统一发布。' },
        { taskId: '1c-4b', title: '发布考勤二维码',     executor: 'leader',           supervisor: null,         timeOffset:  0, desc: '现场组织的党小组长负责在会议现场发布考勤二维码，供与会党员扫码签到。' },
        { taskId: '1c-5', title: '签到考勤',            executor: 'disc-commissioner',supervisor: 'leader',     timeOffset:  0, desc: '执行刚性考勤（三会一课范畴）。组长发布二维码后，纪检委员同步记录到场情况。事假须提前1天申请；病假可事后补假。缺勤须记录留档。请假/缺勤人员的补课安排跟进见 §1.3 补课跟进机制（T+7 执行）。' },
        ...
        { taskId: '1c-6b', title: '摄影留存宣传底稿',   executor: 'leader',           supervisor: null,         timeOffset:  3, desc: '现场主持的党小组长负责摄影留存，形成宣传底稿（照片+简要文字记录），提交宣传委员备用。' },
        ...
        { taskId: '1c-8', title: '汇总支部党员大会记录',  executor: 'leader',           supervisor: null,         timeOffset:  5, desc: '党小组组长会后收集过去一年承担较多工作的骨干同志的检查材料，与图片汇总整理形成完整的支部党员大会记录（含述职摘要+对照检查材料精选）。' },
        { taskId: '1c-9', title: '档案归档',            executor: 'prop-commissioner',supervisor: 'leader',     timeOffset:  5, desc: '宣传委员归档会议材料（支部党员大会记录），上传智慧党建平台，T+5天完成。' },
    ...
    {
      scenarioId: 'party-group-meeting', title: '【活动建设】党小组会',
      domain: 'activity', description: '刚性考勤 · 仅限党员和预备党员',
      tasks: [
        { taskId: '1d-0', title: '时间统筹（三组长协调）',  executor: 'leader',           supervisor: null,             timeOffset: -7, desc: '三位党小组长各自统计本组党员可用时间，取最大公因数（重叠时间段）；在支委群中同步结果；由支部书记在党支部大群统一发布，要求全员至少参与一场。' },
        { taskId: '1d-1', title: '确定会议主题',        executor: 'leader',           supervisor: null,         timeOffset: -7, desc: '块块组长根据支委会部署确定会议主题，确保与年度工作重点一致。' },
        { taskId: '1d-2', title: '会前谈心谈话',        executor: 'leader',           supervisor: null,         timeOffset: -7, desc: '组长与本组党员逐一谈心，了解思想状况，为会议提供信息基础。' },
        ...
        { taskId: '1d-4', title: '通知到人',          executor: 'leader',           supervisor: null,         timeOffset: -3, desc: '块块组长通过党小组群发送正式会议通知，注明时间、地点、参会要求，必须提前至少3天；如需覆盖全支部，由支部书记通过党支部大群统一发布。' },
        { taskId: '1d-4b', title: '发布考勤二维码',     executor: 'leader',           supervisor: null,         timeOffset:  0, desc: '现场组织的党小组长负责在会议现场发布考勤二维码，供与会党员扫码签到。' },
        { taskId: '1d-5', title: '签到考勤',            executor: 'disc-commissioner',supervisor: 'leader',     timeOffset:  0, desc: '执行刚性考勤（三会一课范畴）。组长发布二维码后，纪检委员同步记录到场情况。事假须提前1天申请；病假可事后补假。缺勤须记录留档。请假/缺勤人员的补课安排跟进见 §1.3 补课跟进机制（T+7 执行）。' },
    ...
    {
      scenarioId: 'party-lecture', title: '【活动建设】党课',
      domain: 'activity', description: '刚性考勤 · 仅限党员和预备党员',
      tasks: [
        { taskId: '1e-0', title: '时间统筹（三组长协调）',  executor: 'leader',           supervisor: null,             timeOffset: -7, desc: '三位党小组长各自统计本组党员可用时间，取最大公因数（重叠时间段）；在支委群中同步结果；由支部书记在党支部大群统一发布，要求全员至少参与一场。' },
        { taskId: '1e-1', title: '确定党课主题',        executor: 'leader',           supervisor: null,         timeOffset: -7, desc: '块块组长根据支委会部署确定党课主题，确保与年度工作重点一致。' },
        { taskId: '1e-2', title: '会前谈心谈话',        executor: 'leader',           supervisor: null,         timeOffset: -7, desc: '组长与本组党员逐一谈心，了解思想状况，为党课提供信息基础。' },
        { taskId: '1e-2b', title: '全员述职回顾',       executor: 'all',              supervisor: 'leader',     timeOffset: -5, desc: '会前5天，全体参会党员回顾总结过去一年在党支部中承担的工作（述职），作为个人对照检查材料的基础素材。' },
        { taskId: '1e-4', title: '通知到人',          executor: 'leader',           supervisor: null,         timeOffset: -3, desc: '块块组长通过党小组群发送正式会议通知，注明时间、地点、参会要求，必须提前至少3天；如需覆盖全支部，由支部书记通过党支部大群统一发布。' },
        { taskId: '1e-4b', title: '发布考勤二维码',     executor: 'leader',           supervisor: null,         timeOffset:  0, desc: '现场组织的党小组长负责在会议现场发布考勤二维码，供与会党员扫码签到。' },
        { taskId: '1e-5', title: '签到考勤',            executor: 'disc-commissioner',supervisor: 'leader',     timeOffset:  0, desc: '执行刚性考勤（三会一课范畴）。组长发布二维码后，纪检委员同步记录到场情况。事假须提前1天申请；病假可事后补假。缺勤须记录留档。请假/缺勤人员的补课安排跟进见 §1.3 补课跟进机制（T+7 执行）。' },
        { taskId: '1e-6a', title: '个人自评',            executor: 'all',              supervisor: null,         timeOffset:  0, desc: '每位党员做个人自我批评，结合述职回顾内容展开。' },
        { taskId: '1e-6c', title: '互相批评',            executor: 'all',              supervisor: null,         timeOffset:  0, desc: '开展批评与自我批评，要有辣味，直指问题。' },
        { taskId: '1e-6d', title: '组长总结',            executor: 'leader',           supervisor: null,         timeOffset:  0, desc: '块块组长做总结发言，对本次党课进行回顾与总结。' },
        { taskId: '1e-6b', title: '摄影留存宣传底稿',   executor: 'leader',           supervisor: null,         timeOffset:  3, desc: '现场主持的党小组长负责摄影留存，形成宣传底稿（照片+简要文字记录），提交宣传委员备用。' },
        { taskId: '1e-7b', title: '后台考勤汇总',       executor: 'disc-commissioner',supervisor: 'leader',     timeOffset:  3, desc: '纪检委员在后台考勤小程序中统一汇总出勤数据，字段含：姓名、学号、发展阶段、所属党小组；导出后提交宣传委员归档。' },
        { taskId: '1e-7c', title: '活动参与三层记录',   executor: 'disc-commissioner',supervisor: 'leader',     timeOffset:  3, desc: '现场记录组织/深度参与/出勤三层角色；活动后在后台考勤汇总时（T+3）与组织者确认人员名单及分层，整理为参与记录草稿，供月底汇总使用。' },
        { taskId: '1e-8', title: '汇总党课记录',  executor: 'leader',           supervisor: null,         timeOffset:  5, desc: '党小组组长会后收集相关材料，与图片汇总整理形成完整的党课记录（含学习笔记摘要+骨干同志心得精选）。' },
        { taskId: '1e-9', title: '档案归档',            executor: 'prop-commissioner',supervisor: 'leader',     timeOffset:  5, desc: '宣传委员归档会议材料（党课记录），上传智慧党建平台，T+5天完成。' },
        { taskId: '1e-10', title: '补课安排跟进',       executor: 'disc-commissioner',supervisor: 'leader',     timeOffset:  7, desc: '对请假/缺勤人员事后1周内（T+7）安排补课并跟踪完成；特殊情况可延至T+14，须在备注中标注。' },
      ],
    },
    {
