...
import { SignupStore, resolveSignupReviewer, SignupStatus } from '../../../services/signup.js?v=20260914a';
import { AuthStore } from '../../../services/auth.js?v=20260914a';
import { loadTaskforceReviews, addTaskforceReview } from '../../../services/review.js?v=20260914a';
import { loadInspectionRecords } from '../../../services/inspection.js?v=20260914a'; // IA-C3 收敛单写入口 2026-09-06：saveInspectionRecords 已随考察写入口移除
import { TodoStore, TodoSourceType, TodoCategory, TodoActionType } from '../../../services/todo.js?v=20260914a';
import { NoticeStore } from '../../../services/notice.js?v=20260914a';
import { mockDB, SourceType, ReviewStatus } from '../../../core/domain.js?v=20260914a'; // IA-C3 收敛单写入口 2026-09-06：ParticipationLevel 随考察写入口移除
...
import { isActivityEnded } from '../../../core/constants.js?v=20260914a';
