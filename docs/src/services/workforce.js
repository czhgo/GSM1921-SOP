...
import { ROLE_LABELS } from '../core/constants.js?v=20260919j';
import { POLICY_DEFAULTS } from '../core/policy-defaults.js?v=20260919j';
import { WORK_MAP_MODULES, mergeWorkforceSnapshot, canDisableModule } from '../core/work-map.js?v=20260919j';
import { getPersonName } from './person.js?v=20260919j';
import { AuthStore } from './auth.js?v=20260919j';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260919j';
import { fetchVotesStrict } from './committee-vote.js?v=20260919j';
import { TodoStore, TodoCategory, TodoSourceType, WORK_DOMAIN } from './todo.js?v=20260919j';
