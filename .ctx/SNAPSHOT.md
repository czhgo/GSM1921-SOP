...
date: "2026-09-10"
version: "v28"
milestone: "2026-09-12 续批（第八批）：R-15 深色模式收尾轮（about.css 深色 token #7E7870→#948E85 + 深色分支；目标 4.15/3.82/4.15→5.58/5.14/5.58，同族抽样 11 项 ≥4.5，浅色 21 项零变化；深色违规 67→5（余为装饰编号·豁免）→ **深色对比不再开新轮·收官**） + 黑话审查第 7 轮（6 候选逐条裁定：漂移→失同步 67 处/40 文件（回潮·入库）、向导页去内部术语保留命令、幂等→口语、落库→保存 + 口径同族 29 处、空态去锚点、接触点→用户最先看到的内容）+ 乙部当前无未闭环项；版本串 20260912a / CODE_VERSION 109"
---
...
> **上版**: v27 (2026-09-11)
> **变更来源**: 2026-09-10/11/12（七批 + 本批共八批，T-077 追加批次 1~9；见 v28/v27/v26/v25/v24 里程碑行；测试/文件计数一律以实测为准）
