import { renderTabBar } from '../components/tab-bar.js?v=20260808g';
import { renderTodoList } from '../components/todo-list.js?v=20260808g';
import { getAppState, setState, registerRenderCallback } from '../core/state.js?v=20260808g';
import { BranchService } from '../services/runtime.js?v=20260808g';
import { showToast } from '../core/utils.js?v=20260808g';
import { bootstrapPage } from '../core/bootstrap.js?v=20260808g';
import { loadWorkspaceData } from '../core/data-loader.js?v=20260808g';
import { attendanceToLong, inspectionToLong, PEOPLE, getPersonById, getPersonName } from '../mock/index.js?v=20260808g';
import { PersonPicker } from '../components/person-picker.js?v=20260808g';
import { DecisionTreeState, DECISION_TREE_CONFIGS, renderWorkflowPanel, writeActivityWithSOP } from '../services/decision-tree.js?v=20260808g';
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS, SourceType, ParticipationLevel, ReviewStatus, REVIEW_STATUS_LABELS, OutputType, deriveOutputRoute } from '../core/domain.js?v=20260808g';
import { persist } from '../core/data-adapter.js?v=20260808g';
import { loadMakeupTasks } from '../services/makeup.js?v=20260808g';
import { loadAttendanceRecords, loadActiveAttendanceRecords, saveAttendanceRecords } from '../services/attendance.js?v=20260808g';
import { loadInspectionRecords, saveInspectionRecords } from '../services/inspection.js?v=20260808g';
...
import { loadActivityReviews, findActivityReviewIndex, updateActivityReview, addActivityReview } from '../services/review.js?v=20260808g';
import { renderMyDispatchTab, bindMyDispatchEvents } from '../services/issues.js?v=20260808g';
import { TodoStore, TodoSourceType, seedTodos } from '../services/todo.js?v=20260808g';
