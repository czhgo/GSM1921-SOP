...
import { solidAccentStyle, ARCHIVE_FALLBACK_ROLES } from '../../../core/constants.js?v=20260912j';
import { showToast, downloadCSV, downloadBlob, downloadUrl, _fmtDate, escHtml } from '../../../core/utils.js?v=20260912j';
import { persist, getAuthToken, getApiBaseUrl } from '../../../core/data-adapter.js?v=20260912j';
...
import { isApiMode } from '../../../services/runtime.js?v=20260912j';
import { AuthStore } from '../../../services/auth.js?v=20260912j';
import { getPersonName } from '../../../services/person.js?v=20260912j';
import { addExternalDispatch, loadExternalDispatches } from '../../../services/external-dispatch.js?v=20260912j';
// A② 归档缺口判据单一源（书记台「宣传材料待归档」实时组同源）：已归档但无归档记录的活动
import { getArchiveGapActivities, getEndedUnarchivedActivities } from '../../../services/secretary-overview.js?v=20260912j';
