...
import { fetchVotes, lockVotes } from '../services/committee-vote.js?v=20260910a';
import { optionSetOf } from '../services/vote-config.js?v=20260910a';
...
} from './resolution-followup-manager.js?v=20260910a';
