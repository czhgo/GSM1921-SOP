...
import { _fmtDate, getBasePath } from '../../core/utils.js?v=20260914s';
...
import { populateMonthSelector } from '../calendar.js?v=20260914s';
import { getCapabilities, mountCapability, getRuntimeEnv } from '../../core/registry.js?v=20260914s';
