...
import { setState, getAppState } from '../../../core/state.js?v=20260914e';
import { BranchService } from '../../../services/runtime.js?v=20260914e';
import { DecisionTreeState, DECISION_TREE_CONFIGS, renderWorkflowPanel, writeActivityWithSOP, hostGroups as buildHostGroupOptions } from '../../../services/decision-tree.js?v=20260914e';
...
import { mockDB, OutputType, deriveOutputRoute } from '../../../core/domain.js?v=20260914e';
import { persist } from '../../../core/data-adapter.js?v=20260914e';
import { PersonPicker } from '../../../components/person-picker.js?v=20260914e';
import { recordFormShell } from '../../../components/forms.js?v=20260914e';
import { getBranchIdOfPerson, getBranchOutputBlocks, applyOutputBlockPolicy } from '../../../services/branch.js?v=20260914e';
import { badgeHtml } from '../../../components/badges.js?v=20260914e';
// 活动生命周期展示态单一源（草稿/已发布/进行中/待归档/已执行/已归档/已取消）——勿在本文件另造中文标签
import { activityLifecycleBadgeHtml } from '../../../components/inspector.js?v=20260914e';
import { showToast, escHtml } from '../../../core/utils.js?v=20260914e';
import { solidAccentStyle, accDarkVars, accDarkParts, OUTPUT_BLOCK_DEFS, isActivityEnded, ACTIVITY_SUBTYPES, normalizeActivityType } from '../../../core/constants.js?v=20260914e';
import { filterByRole, getCurrentLeaderId, currentLeaderGroup } from './_shared.js?v=20260914e';
import { anchorDetailToTrigger } from '../../../components/detail-anchor.js?v=20260914e';
// 统一检索引擎（支书 2026-09-13 裁定）：第一列是活动的表格一律接入（关键词 + 分面；≤8 行自动不渲染检索条）
import { renderFilteredList, activityKeyword, activityFacets } from '../../../components/list-filter.js?v=20260914e';
