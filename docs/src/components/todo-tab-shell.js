...
import { TodoStore, urgeRolesOf, WORK_DOMAIN, WORK_DOMAIN_LABELS, realtimeGroupDomainOf } from '../services/todo.js?v=20260919k';
// S3②（2026-09-12）：未读通知计数单一来源——与顶栏角标/首页同源（NoticeStore activeOnly+read 过滤），
// 不再用「通知类待办」现算（口径不同致三处不一致）。
import { NoticeStore, NOTICE_MODULE_ROLE_PAGES } from '../services/notice.js?v=20260919k';
import { renderDomainTodoList } from './todo-list.js?v=20260919k';
import { badgeHtml } from './badges.js?v=20260919k';
import { showToast } from '../core/utils.js?v=20260919k';
import { solidAccentStyle, ROLE_LABELS } from '../core/constants.js?v=20260919k';
...
import { memoizeRender } from './memoize-render.js?v=20260919k'; // P2 渲染守卫（spec §四.1）
