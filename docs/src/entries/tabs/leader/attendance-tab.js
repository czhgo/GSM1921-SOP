...
import { loadActiveAttendanceRecords, canUploadAttendance, appendAttendanceRecords, loadAttendanceAppeals, resolveAttendanceAppeal, reconfirmReturnedRecord, MEETING_ATTENDANCE_TYPES } from '../../../services/attendance.js?v=20260922k';
...
import { attendanceToLong } from '../../../services/attendance.js?v=20260922k';
...
import { getMeetingRosterCandidates, getRosterStats } from '../../../services/roster.js?v=20260922k';
import { solidAccentStyle, accDarkVars } from '../../../core/constants.js?v=20260922k';
import { currentLeaderGroup } from './_shared.js?v=20260922k';
