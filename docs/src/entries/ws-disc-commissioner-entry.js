...
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS, ReviewStatus, SourceType, OutputType, deriveOutputRoute } from '../core/domain.js?v=20260807b';
import { persist } from '../core/data-adapter.js?v=20260807b';
import { attendanceToLong, attendanceToWide, inspectionToLong, inspectionToWide, reviewToDisplay, getPersonName } from '../mock/index.js?v=20260807b';
import { loadWorkspaceData } from '../core/data-loader.js?v=20260807b';
import { renderTabBar } from '../components/tab-bar.js?v=20260807b';
import { openFormModal } from '../components/modal.js?v=20260807b';
import { autoGenerateMakeupTask, loadMakeupTasks, saveMakeupTasks } from '../services/makeup.js?v=20260807b';
import { loadAttendanceRecords, saveAttendanceRecords } from '../services/attendance.js?v=20260807b';
import { loadInspectionRecords, getOverdueRecords, confirmInspectionRecord, deleteInspectionRecord, getRecordsBySource } from '../services/inspection.js?v=20260807b';
...
import { loadActivityReviews, loadTaskforceReviews, updateReviewById } from '../services/review.js?v=20260807b';
