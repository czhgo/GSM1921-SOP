...
- **与乙部关系**：一次性评议轮次写入执行日志 T 编号即归档；长期专项的「轮次进度/已执行工作/书记特别要求」以附录挂载 REVIEW\_QUEUE，不占用乙部
...
## P.9 民主与集中的表述张力——为"集中"立论与支书个人作用的表述（长线课题）

**为什么需要决策**：叙事充分立论了"民主/扁平"（平等沟通、集体领导、框架内对话、扁平化），但"集中"只有"支书确实有最终决策权"一句交代、未立论——长期不对称会引起对民主认知的反扑。支委个人尤其支书个人的作用在叙事中没有表述；"是否为书记的判定和指挥确定范围"待决。此问题牵扯其他表述是否修改（第二章阶段2"最终决策权但过程充分展开"、P-008"扁平化消除上下级命令但不消除程序"均与之相关）。书记 2026-08-12 立为长线课题，AI 不得擅自立论。

**书记原话（2026-08-12，记录供书记研究）**：

- "我们不能忽视支委个人的作用，特别是支书个人的作用。（这里的表述我还在思考）因为我们既有民主，也要集中，这种集中如果没有表述去体现，会引起代价对于民主认知的反扑。这是危险的！！"
- "如果我是对于下一任支书交代工作，那我会说'最重要的工作是人事安排和议程设置'。但这个话并不适宜对于所有人说。"
- "是否意味着我们要为书记发挥他的判定和指挥确定范围？"
- "我不知道该怎么表述，这个问题其实很严重，他会牵扯到我们其他表述是否修改！！"

**AI 思考碎片（2026-08-12 提交书记研究，属 AI 工作表达，非书记论断）**：

- **碎片一：集中设定框架，民主在框架内运行**——"人事安排"和"议程设置"是集中的日常形态：决定谁在什么位置（结构性权力）、决定什么问题进入视野（方向性权力），不是指挥每件具体事务，而是设定"人选+议题"两个框架，让民主在框架内充分展开；与"框架内对话"同构（集中设框架，民主在框架内表达）。
- **碎片二：为集中的权力确定范围，恰恰是保护民主的方式**——类比"赋权"的教训（位置≠指挥权）：若明确"哪些事项由支书/支委最终判定、哪些事项平等协商"，集中就有界、民主就有安全感，二者互相成全而非对立。
- **碎片三：与既有表述的兼容性**——第二章阶段2已有"最终决策权但过程充分展开"的种子；P-008 说扁平化消除上下级命令但不消除程序。若为"集中"立论，需一并回答与这两处的兼容性、是否同步修改——这是"牵扯到其他表述"的落点。

**路线图**：
**第一步：集中的表述方向**（2026-08-12 书记给出方向一并定稿）
书记方向一：最重要的集中是【知情权】（信息必须集中）+ 责任嵌入更深（程序中书记因更大的责任被要求嵌入更深）——已提炼入册 [SECRETARY\_PRONOUNCEMENTS.md P-013](content/01_strategy/SECRETARY_PRONOUNCEMENTS.md)（民主与集中的统一）。书记定稿确认："书记原话并没有否定集中，最重要的集中就是知情权；程序在所有人之上所以扁平，嵌入更深所以集中。"

**第二步（待书记研究）**：其余未决点——"是否为书记的判定和指挥确定范围"；"人事安排和议程设置"的表述边界（不适宜对所有人说）；此课题推进后牵扯「管理事，服务人」其他表述是否修改。

**当前状态**：方向一已落地 P-013（2026-08-12）；长线课题继续，其余未决点待书记研究指示

***

## P.10 发展路径叙事中的「不是…而是」是否清理

**为什么需要决策**：发展路径叙事保留了 7 处「不是…而是」句式（如「不是问题清单，而是内在原因」「主人翁意识不是『我不需要听组织的』，而是…」），属叙事澄清、非「大家普遍以为」稻草人；但「禁用不是…而是句式」规则与之冲突，需书记判定是否纳入本轮反论清理。

**路线图**：
**第一步：这 7 处「不是…而是」是否属于应清理的反论？**
| 方向 | 含义 | 后果 |
