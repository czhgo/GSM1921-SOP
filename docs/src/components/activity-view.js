...
import { renderCalendarByActivities } from './calendar.js?v=20260829o';
import { _fmtDate, _currentYearMonth, flashHighlight, downloadCSV, showToast } from '../core/utils.js?v=20260829o';
import { badgeHtml } from './badge.js?v=20260829o';
import { ROLE_COLORS, dotDarkVars } from '../core/constants.js?v=20260829o';
import { activityLifecycleBadgeHtml } from './inspector.js?v=20260829o';
