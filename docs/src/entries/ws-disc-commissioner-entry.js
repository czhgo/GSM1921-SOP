import { setState, registerRenderCallback } from '../core/state.js?v=20260808k';
import { showToast } from '../core/utils.js?v=20260808k';
import { CrossPageState } from '../core/cross-page-state.js?v=20260808k';
import { bootstrapPage } from '../core/bootstrap.js?v=20260808k';
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS, ReviewStatus, SourceType, OutputType, deriveOutputRoute } from '../core/domain.js?v=20260808k';
import { persist } from '../core/data-adapter.js?v=20260808k';
import { attendanceToLong, attendanceToWide, inspectionToLong, inspectionToWide, reviewToDisplay, getPersonName } from '../mock/index.js?v=20260808k';
import { loadWorkspaceData } from '../core/data-loader.js?v=20260808k';
import { renderTabBar } from '../components/tab-bar.js?v=20260808k';
import { openFormModal } from '../components/modal.js?v=20260808k';
import { autoGenerateMakeupTask, loadMakeupTasks, saveMakeupTasks } from '../services/makeup.js?v=20260808k';
import { loadAttendanceRecords, loadActiveAttendanceRecords, saveAttendanceRecords } from '../services/attendance.js?v=20260808k';
import { loadInspectionRecords, loadActiveInspectionRecords, getOverdueRecords, confirmInspectionRecord, deleteInspectionRecord, getRecordsBySource } from '../services/inspection.js?v=20260808k';
...
import { loadActivityReviews, loadActiveActivityReviews, loadTaskforceReviews, updateReviewById } from '../services/review.js?v=20260808k';
import { renderMyDispatchTab, bindMyDispatchEvents } from '../services/issues.js?v=20260808k';
import { renderTodoList } from '../components/todo-list.js?v=20260808k';
import { TodoStore, TodoSourceType, TodoCategory, TodoActionType, seedTodos } from '../services/todo.js?v=20260808k';
