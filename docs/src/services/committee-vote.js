...
import { persist, getAdapter, getAuthToken, getApiBaseUrl, getDataSource } from '../core/data-adapter.js?v=20260901p';
import { AuthStore } from './auth.js?v=20260901p';
import { NoticeStore } from './notice.js?v=20260901p';
import { resolveVoterIds } from './vote-config.js?v=20260901p';
