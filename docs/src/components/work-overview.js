...
import { showToast, flashHighlight } from '../core/utils.js?v=20260921j';
import { dutyCardHtml } from './workforce-duty-card.js?v=20260921j';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260921j';
import { IssueStore } from '../services/issues.js?v=20260921j';
import { AuthStore } from '../services/auth.js?v=20260921j';
import { solidAccentStyle, dotDarkVars, isActivityEnded, isActivityArchived } from '../core/constants.js?v=20260921j';
import { loadActivities } from '../services/activity.js?v=20260921j';
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260921j';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260921j';
...
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260921j';
...
import { renderFilteredList } from './list-filter.js?v=20260921j';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260921j');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260921j');
