...
import { persist, getAdapter, getAuthToken, getApiBaseUrl, getDataSource } from '../core/data-adapter.js?v=20260914b';
import { AuthStore } from './auth.js?v=20260914b';
import { NoticeStore } from './notice.js?v=20260914b';
import { resolveVoterIds } from './vote-config.js?v=20260914b';
