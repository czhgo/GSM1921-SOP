...
「党建」Tab 分组承载角色工作台内的功能板块，是**工作台**内的功能分区——2026-08-03 起各类工作统一承载于角色工作台（Tab 分组统一为「党建」），不再作为与工作台并列的独立模块。
...
- 意见建议处理流程图（意见反馈处置权归书记，关联 [常见工作场景快速指南 §意见建议反馈](../../02_institution/sop/常见工作场景快速指南.md#意见建议反馈)）
