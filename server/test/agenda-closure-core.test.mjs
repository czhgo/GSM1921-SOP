...
import { collectAgendaRows } from '../../docs/src/entries/tabs/secretary/agenda-form.js?v=20260922g';
import { recordAgendaResultForActivity } from '../../docs/src/services/agenda-follow-up.js?v=20260922g';
