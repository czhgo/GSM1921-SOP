...
import { NoticeStore, resolveNoticeUrl, canReadNotice } from '../services/notice.js?v=20260915d';
...
import { registerApiAdapter, init as dataInit, setDataSource, notifyDataLoaded } from '../core/data-adapter.js?v=20260915d';
