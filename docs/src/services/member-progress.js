...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260921m';
import { AttendanceStatus } from '../core/domain.js?v=20260921m';
import { isApiMode } from './runtime.js?v=20260921m';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260921m';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260921m'),
      import('./attendance.js?v=20260921m'),
      import('./inspection.js?v=20260921m'),
      import('./issues.js?v=20260921m'),
    ]);
