...
import { ROLE_COLORS } from '../../../core/constants.js?v=20260914i';
// 活动「仍在办」口径单一源（2026-09-13 收敛）：替代手写 !archived && status!=='cancelled'
import { isActivityLive } from '../../../core/constants.js?v=20260914i';
import { flashHighlight, escHtml as esc } from '../../../core/utils.js?v=20260914i';
...
import { deriveActivityLifecycleStatus, ACTIVITY_LIFECYCLE } from '../../../components/inspector.js?v=20260914i';
