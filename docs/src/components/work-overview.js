...
import { showToast, flashHighlight } from '../core/utils.js?v=20260921o';
import { dutyCardHtml } from './workforce-duty-card.js?v=20260921o';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260921o';
import { IssueStore } from '../services/issues.js?v=20260921o';
import { AuthStore } from '../services/auth.js?v=20260921o';
import { solidAccentStyle, dotDarkVars, isActivityEnded, isActivityArchived } from '../core/constants.js?v=20260921o';
import { loadActivities } from '../services/activity.js?v=20260921o';
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260921o';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260921o';
...
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260921o';
...
import { renderFilteredList } from './list-filter.js?v=20260921o';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260921o');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260921o');
