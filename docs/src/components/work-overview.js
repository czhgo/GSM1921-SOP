...
import { dutyCardHtml } from './workforce-duty-card.js?v=20260917c';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260917c';
import { IssueStore } from '../services/issues.js?v=20260917c';
import { AuthStore } from '../services/auth.js?v=20260917c';
import { solidAccentStyle, dotDarkVars, isActivityEnded, isActivityArchived } from '../core/constants.js?v=20260917c';
import { loadActivities } from '../services/activity.js?v=20260917c';
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260917c';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260917c';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260917c');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260917c');
