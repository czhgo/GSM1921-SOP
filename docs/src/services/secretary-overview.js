...
import { loadAttendanceRecords, loadActiveAttendanceRecords } from './attendance.js?v=20260914q';
import { loadActivities } from './activity.js?v=20260914q';
import { loadInspectionRecords, getOverdueRecords } from './inspection.js?v=20260914q';
import { TaskForceRecordStore } from './taskforce.js?v=20260914q';
import { loadActivityReviews, loadActiveActivityReviews } from './review.js?v=20260914q';
import { NoticeStore } from './notice.js?v=20260914q';
import { TodoStore, seedTodos, TodoCategory, TodoActionType, REALTIME_GROUP_DOMAIN, WORK_DOMAIN } from './todo.js?v=20260914q';
import { tokenOf } from '../core/version-token.js?v=20260914q'; // P0 域缓存失效（spec §二.3/§二.4）
import { PEOPLE } from '../mock/index.js?v=20260914q';
import { getPersonById } from './person.js?v=20260914q';
import { ROLE_LABELS, isActivityEnded, isActivityArchived } from '../core/constants.js?v=20260914q';
import { mockDB, AttendanceStatus, ReviewStatus } from '../core/domain.js?v=20260914q';
