...
import { dotDarkVars } from '../core/constants.js?v=20260921l';
import { flashHighlight, showToast } from '../core/utils.js?v=20260921l';
import { anchorDetailToTrigger } from './detail-anchor.js?v=20260921l';
