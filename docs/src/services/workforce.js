...
import { ROLE_LABELS } from '../core/constants.js?v=20260914k';
import { POLICY_DEFAULTS } from '../core/policy-defaults.js?v=20260914k';
import { WORK_MAP_MODULES, mergeWorkforceSnapshot, canDisableModule } from '../core/work-map.js?v=20260914k';
import { getPersonName } from './person.js?v=20260914k';
import { AuthStore } from './auth.js?v=20260914k';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260914k';
import { fetchVotesStrict } from './committee-vote.js?v=20260914k';
import { TodoStore, TodoCategory, TodoSourceType, WORK_DOMAIN } from './todo.js?v=20260914k';
