...
import { _personName, PEOPLE, inspectionToLong, getPersonById, getPersonName } from '../mock/index.js?v=20260807b';
import { mockDB, SourceType, ParticipationLevel } from '../core/domain.js?v=20260807b';
