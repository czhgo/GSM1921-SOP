...
import { MOCK_TASKFORCES, PEOPLE } from '../mock/index.js?v=20260911a';
import { isInitStateActive } from './init-reset.js?v=20260911a'; // C2 修复（2026-09-08）：init 态跳过演示种子兜底
import { getPersonName } from './person.js?v=20260911a';
import { evaluateWorkforceVotes } from './workforce.js?v=20260911a';
...
import { BranchService } from './runtime.js?v=20260911a';
import { NoticeStore } from './notice.js?v=20260911a';
import { defaultVoteConfig, resolveVoterIds } from './vote-config.js?v=20260911a';
import { loadActivities } from './activity.js?v=20260911a';
import { AuthStore } from './auth.js?v=20260911a';
