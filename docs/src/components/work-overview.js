...
import { showToast, flashHighlight } from '../core/utils.js?v=20260908c';
import { dutyCardHtml } from './workforce-duty-card.js?v=20260908c';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260908c';
import { IssueStore } from '../services/issues.js?v=20260908c';
import { AuthStore } from '../services/auth.js?v=20260908c';
import { solidAccentStyle, dotDarkVars } from '../core/constants.js?v=20260908c';
...
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260908c';
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260908c';
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260908c';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260908c');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260908c');
