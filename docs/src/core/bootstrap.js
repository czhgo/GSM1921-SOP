...
import { MilestoneStore } from '../services/milestones.js?v=20260901k';
import { getAccentColors, resolveAccentRole } from './constants.js?v=20260901k';
import { CrossPageState } from './cross-page-state.js?v=20260901k';
import { getBasePath } from './utils.js?v=20260901k';
import { enhanceSelects } from '../components/custom-select.js?v=20260901k';
import { registerApiAdapter, init } from './data-adapter.js?v=20260901k';
import { ApiAdapter } from './api-adapter.js?v=20260901k';
import { getCapabilities } from './registry.js?v=20260901k';
