...
import { persist, getAdapter, getAuthToken, getApiBaseUrl, getDataSource } from '../core/data-adapter.js?v=20260922h';
import { AuthStore } from './auth.js?v=20260922h';
import { NoticeStore } from './notice.js?v=20260922h';
import { resolveVoterIds } from './vote-config.js?v=20260922h';
