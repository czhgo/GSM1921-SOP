...
import { seedTodos } from '../services/todo.js?v=20260922j';
import { solidAccentStyle } from '../core/constants.js?v=20260922j';
import { openRecruitForm } from './tabs/org/taskforce-tab.js?v=20260922j';
// 副作用导入触发组织委员工作台能力注册（tab 清单；含 立项⑥B波 成员名册 tab）
import '../modules/capabilities/org-workspace.js?v=20260922j';
