...
import { fetchVotesStrict, presentIdsForItem, tallyForItem } from './committee-vote.js?v=20260922l';
// S-1（2026-09-09 支书批）：逐人结果中「通过者」需按人推导当前发展阶段（fromStage）——
// 单条议程的 fromStage / personStages 可能不覆盖全部对象（各自阶段不同），以成员档案现值兜底。
import { PersonStore } from './person.js?v=20260922l';
...
import { isInstitutionDoc, applyInstitutionAgendaResult } from './branch-doc.js?v=20260922l';
...
import { commitBrandDesignationResult, commitActivityApprovalResult } from './activity.js?v=20260922l';
