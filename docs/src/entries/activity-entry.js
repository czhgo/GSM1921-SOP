...
import { SignupStore, resolveSignupReviewer, SignupStatus, SIGNUP_STATUS_LABELS, SIGNUP_ROLE_LABELS } from '../services/signup.js?v=20260808i';
import { AuthStore } from '../services/auth.js?v=20260808i';
import { getPersonById } from '../mock/index.js?v=20260808i';
import { getBasePath, showToast } from '../core/utils.js?v=20260808i';
