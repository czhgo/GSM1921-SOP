...
import { _personName } from '../mock/index.js?v=20260812a';
import { badgeHtml } from './badge.js?v=20260812a';
import { dotDarkVars } from '../core/constants.js?v=20260812a';
import { flashHighlight } from '../core/utils.js?v=20260812a';
