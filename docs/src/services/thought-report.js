...
import { persist, flushSnapshot, getDataSource } from '../core/data-adapter.js?v=20260917b';
import { THOUGHT_REPORTS } from '../mock/index.js?v=20260917b';
import { POLICY_DEFAULTS } from '../core/policy-defaults.js?v=20260917b';
// 期次纯函数单一源 = core/period.js（服务层与通知模板共用，避免 core→services 环依赖）
import { PERIOD_RE, periodOf, periodLabel, comparePeriodDesc } from '../core/period.js?v=20260917b';
import { generateId } from '../core/id.js?v=20260917b';
// 支委层角色集合单一源（勿手写 5 支委名单——roles-sync 守卫会拦）
import { BRANCH_COMMISSION_ROLES } from '../core/constants.js?v=20260917b';
...
export { PERIOD_RE, periodOf, periodLabel, comparePeriodDesc, periodOptions } from '../core/period.js?v=20260917b';
