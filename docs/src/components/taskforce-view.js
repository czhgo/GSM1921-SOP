...
import { dotDarkVars } from '../core/constants.js?v=20260921g';
import { flashHighlight, showToast } from '../core/utils.js?v=20260921g';
import { anchorDetailToTrigger } from './detail-anchor.js?v=20260921g';
