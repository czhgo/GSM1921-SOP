...
import { BranchService } from '../services/runtime.js?v=20260915e'; // 副作用注册适配器 + BranchService 绑定（loadDB）
import { registerApiAdapter, setDataSource, init } from '../core/data-adapter.js?v=20260915e';
import { ApiAdapter } from '../core/api-adapter.js?v=20260915e';
import { AuthStore } from '../services/auth.js?v=20260915e';
import { getBranchById, getBranchIdOfPerson } from '../services/branch.js?v=20260915e';
import { mountOrgSetupWizard } from '../components/org-setup-wizard.js?v=20260915e';
