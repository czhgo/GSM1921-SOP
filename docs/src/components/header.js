...
import { getAccentColors, resolveAccentRole, ROLE_LABELS } from '../core/constants.js?v=20260901u';
import { getBasePath } from '../core/utils.js?v=20260901u';
import { icon } from '../core/icons.js?v=20260901u';
import { DATA_CHANGED_EVENT, DATA_LOADED_EVENT } from '../core/data-adapter.js?v=20260901u';
import { badgeHtml } from './badge.js?v=20260901u';
import { readLoginSnapshot } from '../core/login-snapshot.js?v=20260901u';
// P1 党委后台（2026-09-02）：header 品牌软编码——标题随支部配置档案更换（person→branchId→branches.config.headerTitle）
import { getHeaderTitle } from '../services/branch.js?v=20260901u';
...
function loadAuth() {
  if (!_authModule) _authModule = import('../services/auth.js?v=20260901u');
  return _authModule;
}
function loadNotice() {
  if (!_noticeModule) _noticeModule = import('../services/notice.js?v=20260901u');
