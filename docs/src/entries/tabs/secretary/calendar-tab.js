...
import { _fmtDate, showToast } from '../../../core/utils.js?v=20260901j';
import { populateMonthSelector, renderCalendarByActivities } from '../../../components/calendar.js?v=20260901j';
import { renderInspectorFromState } from '../../../components/inspector.js?v=20260901j';
import { computeSecretaryStats } from '../../../services/roles.js?v=20260901j';
import { PersonPicker } from '../../../components/person-picker.js?v=20260901j';
import { openModal, closeModal } from '../../../components/modal.js?v=20260901j';
import { DecisionTreeState, renderWorkflowPanel, writeActivityWithSOP } from '../../../services/decision-tree.js?v=20260901j';
...
import { getPersonName, PEOPLE } from '../../../mock/index.js?v=20260901j';
import { NoticeStore } from '../../../services/notice.js?v=20260901j';
import { BranchService } from '../../../services/runtime.js?v=20260901j';
import { ACTIVITY_CLASSIFICATION, classifyActivityType, getAccentColors, resolveAccentRole, dotDarkVars } from '../../../core/constants.js?v=20260901j';
import { badgeHtml } from '../../../components/badge.js?v=20260901j';
import { collectAgendaRows } from './agenda-form.js?v=20260901j';
import { defaultVoteConfig, isDecisionScenario, resolveVoterIds } from '../../../services/vote-config.js?v=20260901j';
import { getAdapter } from '../../../core/data-adapter.js?v=20260901j';
