...
export const VALIDATION_SITES = [
  ...
  { file: SRC + 'entries/tabs/secretary/calendar-tab.js', line: 1095, field: '活动名称', flow: 'secretary/写入活动', machine: true, msg: '请填写活动名称' },
  { file: SRC + 'entries/tabs/secretary/calendar-tab.js', line: 1096, field: '日期', flow: 'secretary/写入活动', machine: true, msg: '请选择日期' },
  { file: SRC + 'entries/tabs/secretary/calendar-tab.js', line: 1097, field: '活动地点', flow: 'secretary/写入活动', machine: true, msg: '请填写活动地点' },
  ...
  { file: SRC + 'entries/tabs/secretary/calendar-tab.js', line: 1059, field: '目标阶段', flow: 'secretary/写入活动·议程待讨论名单', machine: true, msg: '待讨论名单请选择目标阶段' },
