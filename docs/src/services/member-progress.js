...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260921o';
import { AttendanceStatus } from '../core/domain.js?v=20260921o';
import { isApiMode } from './runtime.js?v=20260921o';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260921o';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260921o'),
      import('./attendance.js?v=20260921o'),
      import('./inspection.js?v=20260921o'),
      import('./issues.js?v=20260921o'),
    ]);
