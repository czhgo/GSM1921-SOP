...
import { STATE, setState, registerRenderCallback, getAppState } from '../core/state.js?v=20260901t';
import { NoticeStore, renderNoticeList } from '../services/notice.js?v=20260901t';
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260901t';
import { getBasePath } from '../core/utils.js?v=20260901t';
import { loadAttendanceRecords, loadActiveAttendanceRecords } from '../services/attendance.js?v=20260901t';
...
import { DATA_CHANGED_EVENT } from '../core/data-adapter.js?v=20260901t';
import '../modules/capabilities/activity-calendar.js?v=20260822a'; // 副作用导入：注册首页活动日历能力
// ── 方案 B 入口拆分：dashboard 区块渲染模块 ──
import { renderDashboardStats } from '../components/dashboard/stats.js?v=20260901t';
import { renderActivityList, renderActivityCalendar, initActivityTabs, getInitialActivityView } from '../components/dashboard/activity-panel.js?v=20260901t';
import { renderTaskforceList } from '../components/dashboard/taskforce-list.js?v=20260901t';
import { renderGallery } from '../components/dashboard/gallery.js?v=20260901t';
