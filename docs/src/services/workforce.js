...
import { defaultVoteConfig, resolveVoterIds } from './vote-config.js?v=20260908c';
import { ROLE_LABELS } from '../core/constants.js?v=20260908c';
import { POLICY_DEFAULTS } from '../core/policy-defaults.js?v=20260908c';
import { WORK_MAP_MODULES, mergeWorkforceSnapshot } from '../core/work-map.js?v=20260908c';
import { getPersonName } from './person.js?v=20260908c';
import { AuthStore } from './auth.js?v=20260908c';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260908c';
