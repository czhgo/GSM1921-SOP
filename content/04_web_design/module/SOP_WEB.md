...
- **知情边界**：任何角色的信息可见范围精确等于其职责空间所需的最小充分信息（[P-012 分工的运行保障](../../01_strategy/SECRETARY_PRONOUNCEMENTS.md#p-012-分工的运行保障执行委托与知情监督的统一)）——按人视图按赋权链投影（L1 条线视角），不暴露他人操作细节；"看 ≠ 做"，监督停留方向把握（原 P-027②）
