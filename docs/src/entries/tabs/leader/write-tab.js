...
import { setState, getAppState } from '../../../core/state.js?v=20260921d';
import { BranchService } from '../../../services/runtime.js?v=20260921d';
import { DecisionTreeState, DECISION_TREE_CONFIGS, renderWorkflowPanel, writeActivityWithSOP, hostGroups as buildHostGroupOptions } from '../../../services/decision-tree.js?v=20260921d';
// 党小组常态清单唯一来源（活组、按 seq 升序）——承办党小组选项不再写死
import { groupOptions } from '../../../services/party-group.js?v=20260921d';
import { AuthStore } from '../../../services/auth.js?v=20260921d';
import { TodoStore, TodoSourceType } from '../../../services/todo.js?v=20260921d';
import { mockDB, OutputType, deriveOutputRoute } from '../../../core/domain.js?v=20260921d';
import { persist } from '../../../core/data-adapter.js?v=20260921d';
import { PersonPicker } from '../../../components/person-picker.js?v=20260921d';
import { recordFormShell } from '../../../components/forms.js?v=20260921d';
import { getBranchIdOfPerson, getBranchOutputBlocks, applyOutputBlockPolicy } from '../../../services/branch.js?v=20260921d';
import { badgeHtml } from '../../../components/badges.js?v=20260921d';
// 活动生命周期展示态单一源（草稿/已发布/进行中/待归档/已执行/已归档/已取消）——勿在本文件另造中文标签
import { activityLifecycleBadgeHtml } from '../../../components/inspector.js?v=20260921d';
import { showToast, escHtml } from '../../../core/utils.js?v=20260921d';
// 组织者的发布口（2026-09-19 批次 91 · SOP-B-17）：本人被指定为该场组织者时，本台即可发布本组通知
import { isActivityOrganizer, findActivityById, OUTDOOR_CHECKLIST, isOutdoorActivity, PUBLICITY_DRAFT_STATUS, PUBLICITY_DRAFT_LABELS, publicityDraftStatusOf, setPublicityDraftStatus } from '../../../services/activity.js?v=20260921d';
import { openModal, closeModal } from '../../../components/modal.js?v=20260921d';
import { openGroupNoticeComposer } from '../../../services/notice.js?v=20260921d';
import { solidAccentStyle, accDarkVars, accDarkParts, OUTPUT_BLOCK_DEFS, isActivityEnded, ACTIVITY_SUBTYPES, normalizeActivityType } from '../../../core/constants.js?v=20260921d';
import { filterByRole, getCurrentLeaderId, currentLeaderGroup } from './_shared.js?v=20260921d';
import { anchorDetailToTrigger } from '../../../components/detail-anchor.js?v=20260921d';
