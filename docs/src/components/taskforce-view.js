...
import { dotDarkVars } from '../core/constants.js?v=20260913v';
import { flashHighlight, showToast } from '../core/utils.js?v=20260913v';
import { anchorDetailToTrigger } from './detail-anchor.js?v=20260913v';
