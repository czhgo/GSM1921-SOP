import { setState, registerRenderCallback } from '../core/state.js?v=20260808f';
import { showToast } from '../core/utils.js?v=20260808f';
import { CrossPageState } from '../core/cross-page-state.js?v=20260808f';
import { bootstrapPage } from '../core/bootstrap.js?v=20260808f';
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS, ReviewStatus, SourceType, OutputType, deriveOutputRoute } from '../core/domain.js?v=20260808f';
import { persist } from '../core/data-adapter.js?v=20260808f';
import { attendanceToLong, attendanceToWide, inspectionToLong, inspectionToWide, reviewToDisplay, getPersonName } from '../mock/index.js?v=20260808f';
import { loadWorkspaceData } from '../core/data-loader.js?v=20260808f';
import { renderTabBar } from '../components/tab-bar.js?v=20260808f';
import { openFormModal } from '../components/modal.js?v=20260808f';
import { autoGenerateMakeupTask, loadMakeupTasks, saveMakeupTasks } from '../services/makeup.js?v=20260808f';
import { loadAttendanceRecords, loadActiveAttendanceRecords, saveAttendanceRecords } from '../services/attendance.js?v=20260808f';
import { loadInspectionRecords, loadActiveInspectionRecords, getOverdueRecords, confirmInspectionRecord, deleteInspectionRecord, getRecordsBySource } from '../services/inspection.js?v=20260808f';
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260808f';
import { loadActivities } from '../services/activity.js?v=20260808f';
import { loadActivityReviews, loadActiveActivityReviews, loadTaskforceReviews, updateReviewById } from '../services/review.js?v=20260808f';
import { renderMyDispatchTab, bindMyDispatchEvents } from '../services/issues.js?v=20260808f';
import { renderTodoList } from '../components/todo-list.js?v=20260808f';
import { TodoStore, TodoSourceType, TodoCategory, TodoActionType, seedTodos } from '../services/todo.js?v=20260808f';
import { enhanceSelects } from '../components/custom-select.js?v=20260808f';
