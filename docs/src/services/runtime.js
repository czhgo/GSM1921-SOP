...
import * as mockService from './mock.js?v=20260811d';
import { registerMockAdapter, registerApiAdapter, setDataSource, getDataSource } from '../core/data-adapter.js?v=20260811d';
import { MockAdapter } from '../core/mock-adapter.js?v=20260811d';
import { ApiAdapter } from '../core/api-adapter.js?v=20260811d';
