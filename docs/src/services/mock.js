...
import { mockDB, SCHEMA_VERSION } from '../core/domain.js?v=20260829q';
import { generateId } from '../core/id.js?v=20260829q';
import { getDataSource, persist } from '../core/data-adapter.js?v=20260829q';
...
export function createActivity(data) {
  return _withDelay(() => {
    ...
    if (!newItem.assignments || newItem.assignments.length === 0) {
      import('./todo.js?v=20260829q').then(({ LifecycleTodoDeriver }) => {
