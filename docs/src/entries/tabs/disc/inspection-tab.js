...
import { loadActiveInspectionRecords, getOverdueRecords, confirmInspectionRecord, deleteInspectionRecord, listInspectionSupervision } from '../../../services/inspection.js?v=20260920c';
import { inspectionToLong, inspectionToWide } from '../../../services/inspection.js?v=20260920c';
import { getPersonById, getPersonName } from '../../../services/person.js?v=20260920c';
import { SourceType, OutputType, deriveOutputRoute } from '../../../core/domain.js?v=20260920c';
...
import { renderFilteredList, personFacets, roleLabelOf } from '../../../components/list-filter.js?v=20260920c';
// 人×项目矩阵单一源（支书 2026-09-14 批次 35 裁定：宽表默认 + 矩阵推广到其它二元关系域）
import { renderRelationMatrix, MATRIX_COL_LIMIT } from '../../../components/relation-matrix.js?v=20260920c';
