...
import { ReferencesModule } from '../modules/references.js?v=20260919j';
import { renderSidebar } from '../components/sidebar.js?v=20260919j';
import { renderHeader } from '../components/header.js?v=20260919j';
import { BranchService } from '../services/runtime.js?v=20260919j'; // 注册 mock/api 适配器 + BranchService 绑定（loadDB）
