...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260921l';
import { AttendanceStatus } from '../core/domain.js?v=20260921l';
import { isApiMode } from './runtime.js?v=20260921l';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260921l';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260921l'),
      import('./attendance.js?v=20260921l'),
      import('./inspection.js?v=20260921l'),
      import('./issues.js?v=20260921l'),
    ]);
