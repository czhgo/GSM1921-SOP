...
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260811b';
import { IssueStore, REPORT_CATEGORIES } from '../services/issues.js?v=20260811b';
...
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260811b';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260811b';
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260811b';
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260811b';
import { PEOPLE } from '../mock/people.js?v=20260811b';
import { getPersonName } from '../mock/index.js?v=20260811b';
import { AttendanceStatus } from '../core/domain.js?v=20260811b';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260811b');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260811b');
