...
import { evaluateWorkforceVotes } from '../../docs/src/services/workforce.js?v=20260921c';
import { mergeWorkforceSnapshot, expandWorkforce } from '../../docs/src/core/work-map.js?v=20260921c';
