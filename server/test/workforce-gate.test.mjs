...
import { evaluateWorkforceVotes } from '../../docs/src/services/workforce.js?v=20260912b';
import { mergeWorkforceSnapshot, expandWorkforce } from '../../docs/src/core/work-map.js?v=20260912b';
