...
import { getAdapter, getDataSource, getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260922f';
import { AuthStore } from '../services/auth.js?v=20260922f';
import { loadActivities } from '../services/activity.js?v=20260922f';
import { PEOPLE } from '../mock/people.js?v=20260922f';
...
} from '../services/branch-doc.js?v=20260922f';
