...
import { persist, getDataSource, getApiBaseUrl, getAuthToken } from '../core/data-adapter.js?v=20260922a';
import { buildSystemNotice } from '../core/system-notice-templates.js?v=20260922a';
import { bumpToken } from '../core/version-token.js?v=20260922a'; // P0 域缓存失效（spec §二.3）
import { MOCK_NOTICES } from '../mock/index.js?v=20260922a';
import { isInitStateActive } from './init-reset.js?v=20260922a'; // C2 修复（2026-09-08）：init 态跳过演示种子兜底
import { showToast, getBasePath } from '../core/utils.js?v=20260922a';
import { AuthStore } from './auth.js?v=20260922a';
import { getPersonById, liveMembers } from './person.js?v=20260922a';
import { NoticeTodoDeriver, TodoStore, TodoSourceType, TodoStatus } from './todo.js?v=20260922a';
...
import { getOrganizedActivities, isActivityOrganizer } from './activity.js?v=20260922a';
import {
  NOTICE_PUBLISH_ROLES, NOTICE_MANAGE_ROLES, BRANCH_COMMISSION_ROLES,
  NOTICE_AUDIENCE_SENTINELS, ROLE_LABELS,
} from '../core/constants.js?v=20260922a';
