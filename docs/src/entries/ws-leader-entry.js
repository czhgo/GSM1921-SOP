...
import { attendanceToLong, inspectionToLong, PEOPLE, getPersonById, getPersonName } from '../mock/index.js?v=20260811c';
import { PersonPicker } from '../components/person-picker.js?v=20260811c';
import { DecisionTreeState, DECISION_TREE_CONFIGS, renderWorkflowPanel, writeActivityWithSOP } from '../services/decision-tree.js?v=20260811c';
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS, SourceType, ParticipationLevel, ReviewStatus, REVIEW_STATUS_LABELS, OutputType, deriveOutputRoute } from '../core/domain.js?v=20260811c';
import { persist } from '../core/data-adapter.js?v=20260811c';
import { loadMakeupTasks } from '../services/makeup.js?v=20260811c';
import { loadAttendanceRecords, loadActiveAttendanceRecords, saveAttendanceRecords } from '../services/attendance.js?v=20260811c';
import { loadInspectionRecords, loadActiveInspectionRecords, saveInspectionRecords } from '../services/inspection.js?v=20260811c';
...
import { loadActivityReviews, findActivityReviewIndex, updateActivityReview, addActivityReview } from '../services/review.js?v=20260811c';
import { renderMyDispatchTab, bindMyDispatchEvents, IssueStore } from '../services/issues.js?v=20260811c';
import { TodoStore, TodoSourceType, TodoStatus, seedTodos } from '../services/todo.js?v=20260811c';
import { AuthStore } from '../services/auth.js?v=20260811c';
import { resolveVisibleTargets } from '../services/visibility.js?v=20260811c';
...
function renderLeaderUI(state) {
  ...
  const tabBar = renderTabBar({
    ...
    tabs: [
      ...
      { id: 'tf-view', label: '专班查看', render: () => { const el = document.getElementById('leader-tab-content'); if (el) return import('../components/taskforce-view.js?v=20260811c').then(m => m.renderTaskforceView(el, { highlightId: _leaderNavTarget?.tfId || null, onLocated: () => { _leaderNavTarget = null; } })); }, groupLabel: '党建' },
