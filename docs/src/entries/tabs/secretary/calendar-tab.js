...
import { getAppState, setState } from '../../../core/state.js?v=20260901o';
import { _fmtDate, showToast } from '../../../core/utils.js?v=20260901o';
import { populateMonthSelector, renderCalendarByActivities } from '../../../components/calendar.js?v=20260901o';
import { renderInspectorFromState } from '../../../components/inspector.js?v=20260901o';
import { computeSecretaryStats } from '../../../services/roles.js?v=20260901o';
import { PersonPicker } from '../../../components/person-picker.js?v=20260901o';
import { openModal, closeModal } from '../../../components/modal.js?v=20260901o';
import { DecisionTreeState, renderWorkflowPanel, writeActivityWithSOP } from '../../../services/decision-tree.js?v=20260901o';
...
import { getPersonName, PEOPLE } from '../../../mock/index.js?v=20260901o';
import { NoticeStore } from '../../../services/notice.js?v=20260901o';
import { BranchService } from '../../../services/runtime.js?v=20260901o';
import { ACTIVITY_CLASSIFICATION, classifyActivityType, getAccentColors, resolveAccentRole, dotDarkVars } from '../../../core/constants.js?v=20260901o';
import { badgeHtml } from '../../../components/badge.js?v=20260901o';
import { collectAgendaRows } from './agenda-form.js?v=20260901o';
import { defaultVoteConfig, isDecisionScenario, resolveVoterIds } from '../../../services/vote-config.js?v=20260901o';
