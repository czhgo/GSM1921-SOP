...
import { ReferencesModule } from '../modules/references.js?v=20260921b';
import { renderSidebar } from '../components/sidebar.js?v=20260921b';
import { renderHeader } from '../components/header.js?v=20260921b';
import { BranchService } from '../services/runtime.js?v=20260921b'; // 注册 mock/api 适配器 + BranchService 绑定（loadDB）
