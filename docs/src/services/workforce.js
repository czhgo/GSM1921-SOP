...
import { WORK_MAP_MODULES, mergeWorkforceSnapshot } from '../core/work-map.js?v=20260912a';
import { getPersonName } from './person.js?v=20260912a';
import { AuthStore } from './auth.js?v=20260912a';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260912a';
