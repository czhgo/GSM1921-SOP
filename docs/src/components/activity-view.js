...
import { renderCalendarByActivities } from './calendar.js?v=20260910a';
import { _fmtDate, _currentYearMonth, flashHighlight, downloadCSV, showToast, escHtml as esc } from '../core/utils.js?v=20260910a';
import { badgeHtml } from './badges.js?v=20260910a';
import { ROLE_COLORS, dotDarkVars } from '../core/constants.js?v=20260910a';
import { activityLifecycleBadgeHtml } from './inspector.js?v=20260910a';
...
import { renderVoteWidget } from './vote-widget.js?v=20260910a';
