...
import { setState, getAppState } from '../../../core/state.js?v=20260829j';
import { BranchService } from '../../../services/runtime.js?v=20260829j';
import { DecisionTreeState, DECISION_TREE_CONFIGS, renderWorkflowPanel, writeActivityWithSOP } from '../../../services/decision-tree.js?v=20260829j';
import { AuthStore } from '../../../services/auth.js?v=20260829j';
import { TodoStore, TodoSourceType } from '../../../services/todo.js?v=20260829j';
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS, SourceType, ParticipationLevel, OutputType, deriveOutputRoute } from '../../../core/domain.js?v=20260829j';
import { persist } from '../../../core/data-adapter.js?v=20260829j';
import { loadAttendanceRecords, saveAttendanceRecords } from '../../../services/attendance.js?v=20260829j';
import { loadInspectionRecords, saveInspectionRecords } from '../../../services/inspection.js?v=20260829j';
import { PersonPicker } from '../../../components/person-picker.js?v=20260829j';
import { getPersonName, PEOPLE } from '../../../mock/index.js?v=20260829j';
import { badgeHtml } from '../../../components/badge.js?v=20260829j';
import { showToast } from '../../../core/utils.js?v=20260829j';
import { solidAccentStyle, accDarkVars, accDarkParts } from '../../../core/constants.js?v=20260829j';
import { filterByRole, getCurrentLeaderId } from './_shared.js?v=20260829j';
