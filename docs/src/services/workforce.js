...
import { WORK_MAP_MODULES, mergeWorkforceSnapshot, canDisableModule, ORG_SUBJECT_LABELS } from '../core/work-map.js?v=20260922j';
import { getPersonName } from './person.js?v=20260922j';
import { AuthStore } from './auth.js?v=20260922j';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260922j';
import { fetchVotesStrict } from './committee-vote.js?v=20260922j';
import { TodoStore, TodoCategory, TodoSourceType, WORK_DOMAIN } from './todo.js?v=20260922j';
