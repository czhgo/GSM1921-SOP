...
import { loadAttendanceRecords, loadActiveAttendanceRecords, listLowAttendanceSessions } from './attendance.js?v=20260922k';
import { loadActivities } from './activity.js?v=20260922k';
import { loadInspectionRecords, getOverdueRecords } from './inspection.js?v=20260922k';
import { TaskForceRecordStore } from './taskforce.js?v=20260922k';
import { loadActivityReviews, loadActiveActivityReviews } from './review.js?v=20260922k';
import { NoticeStore } from './notice.js?v=20260922k';
import { TodoStore, seedTodos, TodoCategory, TodoActionType, REALTIME_GROUP_DOMAIN, WORK_DOMAIN } from './todo.js?v=20260922k';
import { tokenOf } from '../core/version-token.js?v=20260922k'; // P0 域缓存失效（spec §二.3/§二.4）
import { PEOPLE } from '../mock/index.js?v=20260922k';
import { getPersonById } from './person.js?v=20260922k';
import { ROLE_LABELS, isActivityEnded, isActivityArchived } from '../core/constants.js?v=20260922k';
import { mockDB, AttendanceStatus, ReviewStatus } from '../core/domain.js?v=20260922k';
import { persist } from '../core/data-adapter.js?v=20260922k'; // 周报审核写口落盘（SOP-B-40 ②）
