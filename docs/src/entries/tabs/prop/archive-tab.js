...
import { solidAccentStyle, ARCHIVE_FALLBACK_ROLES } from '../../../core/constants.js?v=20260921g';
import { showToast, downloadCSV, downloadBlob, downloadUrl, _fmtDate, escHtml } from '../../../core/utils.js?v=20260921g';
import { persist, getAuthToken, getApiBaseUrl } from '../../../core/data-adapter.js?v=20260921g';
import { mockDB } from '../../../core/domain.js?v=20260921g';
import { bumpToken } from '../../../core/version-token.js?v=20260921g'; // P0 域缓存失效（spec §二.3）
import { loadActivities, listPublicityDrafts, setPublicityDraftStatus, PUBLICITY_DRAFT_STATUS } from '../../../services/activity.js?v=20260921g';
import { isApiMode } from '../../../services/runtime.js?v=20260921g';
...
import { addExternalDispatch, loadExternalDispatches } from '../../../services/external-dispatch.js?v=20260921g';
// A② 归档缺口判据单一源（支书台「宣传材料待归档」实时组同源）：已归档但无归档记录的活动
import { getArchiveGapActivities, getEndedUnarchivedActivities } from '../../../services/secretary-overview.js?v=20260921g';
