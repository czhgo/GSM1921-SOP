...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260921g';
import { AttendanceStatus } from '../core/domain.js?v=20260921g';
import { isApiMode } from './runtime.js?v=20260921g';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260921g';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260921g'),
      import('./attendance.js?v=20260921g'),
      import('./inspection.js?v=20260921g'),
      import('./issues.js?v=20260921g'),
    ]);
