...
import { defaultVoteConfig, resolveVoterIds } from './vote-config.js?v=20260917c';
import { ROLE_LABELS } from '../core/constants.js?v=20260917c';
import { POLICY_DEFAULTS } from '../core/policy-defaults.js?v=20260917c';
import { WORK_MAP_MODULES, mergeWorkforceSnapshot, canDisableModule } from '../core/work-map.js?v=20260917c';
import { getPersonName } from './person.js?v=20260917c';
import { AuthStore } from './auth.js?v=20260917c';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260917c';
import { fetchVotesStrict } from './committee-vote.js?v=20260917c';
import { TodoStore, TodoCategory, TodoSourceType, WORK_DOMAIN } from './todo.js?v=20260917c';
