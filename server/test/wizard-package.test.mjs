...
// ⚠️ 对 docs/src 的相对 import 必须带与源码一致的 ?v=20260914c query（模块缓存键一致性）。
import { test, before } from 'node:test';
import assert from 'node:assert/strict';

import { mockDB } from '../../docs/src/core/domain.js?v=20260914c';
import { registerMockAdapter } from '../../docs/src/core/data-adapter.js?v=20260914c';
import {
  buildConfigPackage,
  applyConfigPackage,
  PACKAGE_KIND,
  PACKAGE_VERSION,
} from '../../docs/src/services/org-config-package.js?v=20260914c';
import { getBranchById } from '../../docs/src/services/branch.js?v=20260914c';
