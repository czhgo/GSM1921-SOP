...
import { ReferencesModule } from '../modules/references.js?v=20260901i';
...
import { registerApiAdapter, setDataSource, init } from '../core/data-adapter.js?v=20260901i';
import { ApiAdapter } from '../core/api-adapter.js?v=20260901i';
