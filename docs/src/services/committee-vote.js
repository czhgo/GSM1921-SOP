...
import { persist, getAdapter, getAuthToken, getApiBaseUrl, getDataSource } from '../core/data-adapter.js?v=20260922l';
import { AuthStore } from './auth.js?v=20260922l';
import { NoticeStore } from './notice.js?v=20260922l';
import { resolveVoterIds } from './vote-config.js?v=20260922l';
