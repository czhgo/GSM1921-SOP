...
import { getMeetingRoster, getRosterStats, getMeetingRosterCandidates } from '../../../services/roster.js?v=20260922l';
import { solidAccentStyle, ROLE_LABELS, isActivityArchived, isActivityLive } from '../../../core/constants.js?v=20260922l';
import { loadActivities } from '../../../services/activity.js?v=20260922l';
// SOP-B-2（D-288）：考勤候选默认选中「已通过报名者」——报名名单的来源单一源 = SignupStore
import { getApprovedSignupPersonIds } from '../../../services/signup.js?v=20260922l';
import { autoGenerateMakeupTask } from '../../../services/makeup.js?v=20260922l';
...
import { pagerHtml } from '../../../components/pager.js?v=20260922l';
...
import { renderContent as renderMakeupContent } from './makeup-tab.js?v=20260922l';
