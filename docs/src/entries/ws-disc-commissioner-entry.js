import { setState, registerRenderCallback } from '../core/state.js?v=20260807h';
import { showToast } from '../core/utils.js?v=20260807h';
import { CrossPageState } from '../core/cross-page-state.js?v=20260807h';
import { bootstrapPage } from '../core/bootstrap.js?v=20260807h';
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS, ReviewStatus, SourceType, OutputType, deriveOutputRoute } from '../core/domain.js?v=20260807h';
import { persist } from '../core/data-adapter.js?v=20260807h';
import { attendanceToLong, attendanceToWide, inspectionToLong, inspectionToWide, reviewToDisplay, getPersonName } from '../mock/index.js?v=20260807h';
import { loadWorkspaceData } from '../core/data-loader.js?v=20260807h';
import { renderTabBar } from '../components/tab-bar.js?v=20260807h';
import { openFormModal } from '../components/modal.js?v=20260807h';
import { autoGenerateMakeupTask, loadMakeupTasks, saveMakeupTasks } from '../services/makeup.js?v=20260807h';
import { loadAttendanceRecords, saveAttendanceRecords } from '../services/attendance.js?v=20260807h';
import { loadInspectionRecords, getOverdueRecords, confirmInspectionRecord, deleteInspectionRecord, getRecordsBySource } from '../services/inspection.js?v=20260807h';
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260807h';
import { loadActivities } from '../services/activity.js?v=20260807h';
import { loadActivityReviews, loadTaskforceReviews, updateReviewById } from '../services/review.js?v=20260807h';
import { renderMyDispatchTab, bindMyDispatchEvents } from '../services/issues.js?v=20260807h';
import { renderTodoList } from '../components/todo-list.js?v=20260807h';
import { TodoStore, TodoSourceType } from '../services/todo.js?v=20260807h';
import { enhanceSelects } from '../components/custom-select.js?v=20260807h';
import { badgeHtml } from '../components/badge.js?v=20260807h';
...
function _renderTodoContent() {
  ...
  _todoAggregates = TodoStore.getGroupedByAction('disc-commissioner');
