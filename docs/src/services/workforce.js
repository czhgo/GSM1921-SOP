...
import { WORK_MAP_MODULES, mergeWorkforceSnapshot } from '../core/work-map.js?v=20260910a';
import { getPersonName } from './person.js?v=20260910a';
import { AuthStore } from './auth.js?v=20260910a';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260910a';
import { fetchVotesStrict } from './committee-vote.js?v=20260910a';
