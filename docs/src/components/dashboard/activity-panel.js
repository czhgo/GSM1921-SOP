...
import { _fmtDate, getBasePath } from '../../core/utils.js?v=20260920c';
...
import { isActivityArchived } from '../../core/constants.js?v=20260920c';
import { badgeHtml } from '../badges.js?v=20260920c';
import { deriveActivityLifecycleStatus, ACTIVITY_LIFECYCLE } from '../inspector.js?v=20260920c';
import { populateMonthSelector } from '../calendar.js?v=20260920c';
import { getCapabilities, mountCapability, getRuntimeEnv } from '../../core/registry.js?v=20260920c';
