...
import { WORK_MAP_MODULES, mergeWorkforceSnapshot } from '../core/work-map.js?v=20260911a';
import { getPersonName } from './person.js?v=20260911a';
import { AuthStore } from './auth.js?v=20260911a';
import { getBranchWorkforce, updateBranchWorkforce } from './branch.js?v=20260911a';
import { fetchVotesStrict } from './committee-vote.js?v=20260911a';
