...
import { getMeetingRoster, getRosterStats, getMeetingRosterCandidates } from '../../../services/roster.js?v=20260922g';
import { solidAccentStyle, ROLE_LABELS, isActivityArchived, isActivityLive } from '../../../core/constants.js?v=20260922g';
...
import { pagerHtml } from '../../../components/pager.js?v=20260922g';
// 人×项目矩阵单一源（支书 2026-09-14 批次 35 裁定：宽表默认 + 矩阵推广）
import { renderRelationMatrix } from '../../../components/relation-matrix.js?v=20260922g';
import { showToast, downloadCSV, triggerPrint, _fmtDate, escHtml as esc, getBasePath } from '../../../core/utils.js?v=20260922g';
import { DISC_COMMISSIONER_ID } from './_shared.js?v=20260922g';
import { HandoffStore } from '../../../services/handoff.js?v=20260922g';
...
import { renderContent as renderMakeupContent } from './makeup-tab.js?v=20260922g';
