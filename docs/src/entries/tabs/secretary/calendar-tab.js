...
import { populateMonthSelector, renderCalendarByActivities } from '../../../components/calendar.js?v=20260914b';
import { renderInspectorFromState } from '../../../components/inspector.js?v=20260914b';
import { computeSecretaryStats } from '../../../services/roles.js?v=20260914b';
...
import { DecisionTreeState, renderWorkflowPanel, writeActivityWithSOP } from '../../../services/decision-tree.js?v=20260914b';
...
import { ACTIVITY_CLASSIFICATION, classifyActivityType, normalizeActivityType, dotDarkVars, SCENARIO_WRITE_IDS, SCENARIO_LABELS } from '../../../core/constants.js?v=20260914b';
...
import { collectAgendaRows } from './agenda-form.js?v=20260914b';
import { defaultVoteConfig, isDecisionScenario, resolveVoterIds, isAnonymousForced } from '../../../services/vote-config.js?v=20260914b';
import { AuthStore } from '../../../services/auth.js?v=20260914b';
import { getBranchIdOfPerson, getBranchById, applyWorkflowBlockPolicy } from '../../../services/branch.js?v=20260914b';
// 支部文件读侧收敛点（2026-09-10）：会前草案下拉经 branch-doc 服务读取（按归属支部过滤，跨支部不可见）
import { listDocs as listBranchDocs } from '../../../services/branch-doc.js?v=20260914b';
// L3 S4（2026-09-03）：主题党日工作流块 manifest 驱动试点（入口守卫 + 表单元数据单一源）
import { BLOCK_MANIFESTS, THEME_PARTY_DAY_MANIFEST } from '../../../workflow/blocks/manifests.js?v=20260914b';
// B1（2026-09-12）：党委下钻支部的演示只读视图判定（单一源 = modules/branch-demo-nav.js）
import { isReadonlyBranchDrilldown } from '../../../modules/branch-demo-nav.js?v=20260914b';
