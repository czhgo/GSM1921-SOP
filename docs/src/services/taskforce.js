...
import { MOCK_TASKFORCES } from '../mock/index.js?v=20260922i';
import { isInitStateActive } from './init-reset.js?v=20260922i'; // C2 修复（2026-09-08）：init 态跳过演示种子兜底
import { getPersonName, liveMembers } from './person.js?v=20260922i';
import { evaluateWorkforceVotes } from './workforce.js?v=20260922i';
...
import { defaultVoteConfig, resolveVoterIds } from './vote-config.js?v=20260922i';
import { loadActivities } from './activity.js?v=20260922i';
import { AuthStore } from './auth.js?v=20260922i';
import { BRANCH_COMMISSION_ROLES } from '../core/constants.js?v=20260922i'; // 支委层应到名单单一源（勿手写）
