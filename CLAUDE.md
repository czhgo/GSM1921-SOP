...
> 🔴 **总纲 · 书记原话表达纪律（2026-08-15 书记裁决）**：书记原话可以复述，但有三条铁律——①**极端限定词禁止 AI 自造**：书记原话中的「最重要」「关键在于」「尤其是」等表达「侧重」的极端限定词，AI 不得擅自添加或套用（这类词是书记对重要性的判断，AI 无权制造）；②**「不是…而是…」反论必须经书记过目（审议）后才能写入**，不得缺少审议过程擅自使用排他对立式；③**禁止把「侧重」改写成「等号」或「对立」**：书记说「最重要的集中就是知情权」，AI 不得改写成「集中 = 知情权」（把侧重偷换成充要条件）或「集中不是指挥权，而是知情权」（把侧重偷换成排他对立）——「最重要」是侧重，不是唯一，改写成等号/对立会引入书记没说的内容，是「极大的 AI 懒政」，有毒且危险。
