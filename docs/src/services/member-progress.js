...
import { isTodoExpired, TodoStatus } from './todo.js?v=20260922a';
import { AttendanceStatus } from '../core/domain.js?v=20260922a';
import { isApiMode } from './runtime.js?v=20260922a';
import { getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260922a';
...
export async function loadMemberProgress({ personIds = [], today } = {}) {
  ...
  const [{ TodoStore }, { loadAttendanceRecords }, { loadActiveInspectionRecords }, { IssueStore }] =
    await Promise.all([
      import('./todo.js?v=20260922a'),
      import('./attendance.js?v=20260922a'),
      import('./inspection.js?v=20260922a'),
      import('./issues.js?v=20260922a'),
    ]);
