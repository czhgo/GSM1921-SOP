...
import { registerMockAdapter } from '../../docs/src/core/data-adapter.js?v=20260921k';
import { applyConfigCopy, getBranchById } from '../../docs/src/services/branch.js?v=20260921k';
import {
  buildConfigPackage,
  applyConfigPackage,
  PACKAGE_KIND,
  PACKAGE_VERSION,
} from '../../docs/src/services/org-config-package.js?v=20260921k';
