...
import { persist, getDataSource, getApiBaseUrl, getAuthToken } from '../core/data-adapter.js?v=20260922h';
import { buildSystemNotice } from '../core/system-notice-templates.js?v=20260922h';
import { bumpToken } from '../core/version-token.js?v=20260922h'; // P0 域缓存失效（spec §二.3）
import { MOCK_NOTICES } from '../mock/index.js?v=20260922h';
import { isInitStateActive } from './init-reset.js?v=20260922h'; // C2 修复（2026-09-08）：init 态跳过演示种子兜底
import { showToast, getBasePath } from '../core/utils.js?v=20260922h';
import { AuthStore } from './auth.js?v=20260922h';
import { getPersonById, liveMembers } from './person.js?v=20260922h';
import { NoticeTodoDeriver, TodoStore, TodoSourceType, TodoStatus } from './todo.js?v=20260922h';
...
import { getOrganizedActivities, isActivityOrganizer } from './activity.js?v=20260922h';
import {
