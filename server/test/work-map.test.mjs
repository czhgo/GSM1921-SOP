...
} from '../../docs/src/core/work-map.js?v=20260920a';
import { sanitizeConfigWorkforce } from '../../docs/src/core/config-clean.js?v=20260920a';
import { ROLE_KEYS } from '../../docs/src/core/constants.js?v=20260920a';
