...
import { _fmtDate, getBasePath } from '../../core/utils.js?v=20260919k';
...
import { isActivityArchived } from '../../core/constants.js?v=20260919k';
import { badgeHtml } from '../badges.js?v=20260919k';
import { deriveActivityLifecycleStatus, ACTIVITY_LIFECYCLE } from '../inspector.js?v=20260919k';
import { populateMonthSelector } from '../calendar.js?v=20260919k';
import { getCapabilities, mountCapability, getRuntimeEnv } from '../../core/registry.js?v=20260919k';
