...
import { getAppState, setState } from '../../../core/state.js?v=20260829m';
import { _fmtDate, showToast } from '../../../core/utils.js?v=20260829m';
import { populateMonthSelector, renderCalendarByActivities } from '../../../components/calendar.js?v=20260829m';
import { renderInspectorFromState } from '../../../components/inspector.js?v=20260829m';
import { computeSecretaryStats } from '../../../services/roles.js?v=20260829m';
import { PersonPicker } from '../../../components/person-picker.js?v=20260829m';
import { openModal, closeModal } from '../../../components/modal.js?v=20260829m';
import { DecisionTreeState, renderWorkflowPanel, writeActivityWithSOP } from '../../../services/decision-tree.js?v=20260829m';
...
import { loadAttendanceRecords } from '../../../services/attendance.js?v=20260829m';
...
import { ACTIVITY_CLASSIFICATION, classifyActivityType, getAccentColors, resolveAccentRole, dotDarkVars } from '../../../core/constants.js?v=20260829m';
