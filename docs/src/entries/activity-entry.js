...
import { SignupStore, canCloseActivitySignup, closeActivitySignup, SignupStatus } from '../services/signup.js?v=20260921p';
...
import { canProposeBrand, brandProposalOf, proposeBrandDesignation, withdrawBrandProposal, revokeBrandDesignation } from '../services/activity.js?v=20260921p';
// 追加复盘要求（2026-09-21 批次 135 · 裁定二「按推荐档落」）：支委会可额外要求本场组织者完成复盘；
// 判据与写口单一源 = services/activity.js；另有「交回状态」须读该场复盘记录（services/review.js）。
import { reviewRequestOf, isReviewReturned, isReviewRequestEligibleActivity, requestOrganizerReview, withdrawReviewRequest } from '../services/activity.js?v=20260921p';
import { loadActivityReviews } from '../services/review.js?v=20260921p';
import { getBasePath, escHtml as esc, showToast } from '../core/utils.js?v=20260921p';
import { getActivityTypeColors } from '../core/constants.js?v=20260921p';
import { getAppState } from '../core/state.js?v=20260921p';
...
import { canSignup as _canSignup, renderSignupSection, renderSignupList, bindSignupEvents, roleLabel } from '../components/signup-panel.js?v=20260921p';
import { renderShareButtonHtml, bindShareButton } from '../components/share-button.js?v=20260921p';
import { renderVoteWidget } from '../components/vote-widget.js?v=20260921p';
...
import { settleWrites } from '../core/pending-writes.js?v=20260921p';
