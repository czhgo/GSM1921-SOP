...
import { _fmtDate, getBasePath } from '../../core/utils.js?v=20260913v';
...
import { isActivityArchived } from '../../core/constants.js?v=20260913v';
import { badgeHtml } from '../badges.js?v=20260913v';
import { deriveActivityLifecycleStatus, ACTIVITY_LIFECYCLE } from '../inspector.js?v=20260913v';
import { populateMonthSelector } from '../calendar.js?v=20260913v';
import { getCapabilities, mountCapability, getRuntimeEnv } from '../../core/registry.js?v=20260913v';
