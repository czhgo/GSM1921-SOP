...
import { FUNCTION_GROUPS, FUNCTION_CATALOG } from './function-catalog.js?v=20260920d';
...
// 口径：只列 kind === 'feature'（支书 2026-09-02 裁定：flow/arch 仅在各自章节成图，避免与 feature 语义重叠）
...
export const FLOW_LINKS = {
  ...
  'flow-branch-committee': [
    'A[支书: 确定议题并提前通知] --> B[纪检委员: 签到考勤]',
    'B --> C[支书: 主持并记录会议决议]',
    'C --> D[宣传委员: 归档会议材料]',
    'D --> E[纪检委员: 跟进请假缺勤补课]',
  ],
  'flow-online-committee': [
    'A[支书: 创建线上支委会并定稿议程] --> B[委员: 异步表态（同意/异议/附言）]',
    'B --> C[支书: 汇总表态并截止]',
    'C --> D[支书: 记录会议决议]',
  ],
  'flow-group-meeting': [
  ...
  'flow-general-meeting': [
    'A[党小组组长: 统筹时间·确定会议主题] --> B[支书: 大群统一发布通知]',
    'B --> C[纪检委员: 签到考勤]',
    'C --> D[党员: 讨论议题并表决]',
    'D --> E[支书: 记录会议决议]',
    'E --> F[纪检委员: 考勤汇总·补课跟进]',
  ...
  // ── 事务型 ──
  'flow-taskforce': [
    'A[支书/组长/委员: 发起专班] --> B[组织委员: 招募统筹]',
    'B --> C[组织委员: 定人定责定岗]',
    'C --> D[专班成员: 执行分工并记录贡献]',
  ],
  'flow-development': [
    'A[支委会: 讨论推荐为发展对象] --> B[支部党员大会: 表决发展为预备党员]',
    'B --> C[支书: 记录议程「待讨论名单」通过]',
    'C --> D[组织委员: 审批成员变更申请]',
    'D --> E[支书: 确认并更新发展阶段]',
  ],
  'flow-inspection': [
