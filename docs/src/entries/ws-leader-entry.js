...
import { getAppState, setState, registerRenderCallback } from '../core/state.js?v=20260808k';
...
import { attendanceToLong, inspectionToLong, PEOPLE, getPersonById, getPersonName } from '../mock/index.js?v=20260808k';
import { PersonPicker } from '../components/person-picker.js?v=20260808k';
import { DecisionTreeState, DECISION_TREE_CONFIGS, renderWorkflowPanel, writeActivityWithSOP } from '../services/decision-tree.js?v=20260808k';
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS, SourceType, ParticipationLevel, ReviewStatus, REVIEW_STATUS_LABELS, OutputType, deriveOutputRoute } from '../core/domain.js?v=20260808k';
import { persist } from '../core/data-adapter.js?v=20260808k';
import { loadMakeupTasks } from '../services/makeup.js?v=20260808k';
...
import { loadActivityReviews, findActivityReviewIndex, updateActivityReview, addActivityReview } from '../services/review.js?v=20260808k';
import { renderMyDispatchTab, bindMyDispatchEvents } from '../services/issues.js?v=20260808k';
import { TodoStore, TodoSourceType, seedTodos } from '../services/todo.js?v=20260808k';
