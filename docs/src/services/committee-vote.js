...
import { persist, getAdapter, getAuthToken, getApiBaseUrl, getDataSource } from '../core/data-adapter.js?v=20260912a';
import { AuthStore } from './auth.js?v=20260912a';
import { NoticeStore } from './notice.js?v=20260912a';
import { resolveVoterIds } from './vote-config.js?v=20260912a';
