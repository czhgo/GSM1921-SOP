...
import { getAccentColors, resolveAccentRole, ROLE_LABELS } from '../core/constants.js?v=20260808f';
import { NoticeStore, resolveNoticeUrl } from '../services/notice.js?v=20260808f';
import { getBasePath } from '../core/utils.js?v=20260808f';
import { icon } from '../core/icons.js?v=20260808f';
import { DATA_CHANGED_EVENT, DATA_LOADED_EVENT } from '../core/data-adapter.js?v=20260808f';
