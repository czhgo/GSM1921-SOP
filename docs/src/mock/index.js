...
import { getPersonById, getPersonName } from '../services/person.js?v=20260808h';
...
export { ACTIVITIES } from './activities.js?v=20260808h';
export { ATTENDANCE_RECORDS, attendanceToLong, attendanceToWide } from './attendance.js?v=20260808h';
export { INSPECTION_RECORDS, inspectionToLong, inspectionToWide, inspectionToDisplay } from './inspection.js?v=20260808h';
export { REVIEW_RECORDS, TASKFORCE_REVIEW_RECORDS, reviewToDisplay } from './review.js?v=20260808h';
export { MOCK_NOTICES } from './notices.js?v=20260808h';
export { MOCK_TASKFORCES } from './taskforces.js?v=20260808h';
