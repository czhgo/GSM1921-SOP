...
async function collectAll(page) {
  return page.evaluate(async () => {
    const mock = await import('/src/mock/index.js?v=20260921a');
    const seed = await import('/src/mock/seed.js?v=20260921a');
    const accounts = await import('/src/mock/accounts.js?v=20260921a');
    return {
      PEOPLE: mock.PEOPLE,
