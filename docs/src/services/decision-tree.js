...
import { BranchService } from './runtime.js?v=20260829l';
import { showToast } from '../core/utils.js?v=20260829l';
import { sopDatabase, instantiateSOP, renderWorkflow } from '../workflow/index.js?v=20260829l';
...
import '../modules/capabilities/sop-scenarios.js?v=20260829l';
