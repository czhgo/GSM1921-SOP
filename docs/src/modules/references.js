...
import { getAdapter, getDataSource, getAuthToken, getApiBaseUrl } from '../core/data-adapter.js?v=20260921l';
import { AuthStore } from '../services/auth.js?v=20260921l';
import { loadActivities } from '../services/activity.js?v=20260921l';
import { PEOPLE } from '../mock/people.js?v=20260921l';
...
} from '../services/branch-doc.js?v=20260921l';
