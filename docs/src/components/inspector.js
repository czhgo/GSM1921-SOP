...
import { setState, STATE, getAppState } from '../core/state.js?v=20260922a';
import { ROLE_COLORS, ROLE_LABELS, ROLE_THEME_CLASS, COMMISSIONER_ROLES, SECRETARY_ROLES, ACTIVITY_CLASSIFICATION } from '../core/constants.js?v=20260922a';
import { _fmtChinese, showToast, escHtml as esc } from '../core/utils.js?v=20260922a';
import { icon } from '../core/icons.js?v=20260922a';
import { openModal, closeModal } from './modal.js?v=20260922a';
// 数据域接线收口（2026-09-03）：支部成员名单经 services/person.js 获取（原直连 mock PEOPLE）
// 实时视图（非快照）：成员增删即时可见——见 services/person.js liveMembers 说明
const PEOPLE = liveMembers();
import { getPersonById } from '../services/person.js?v=20260922a';
import { BranchService } from '../services/runtime.js?v=20260922a';
import { AuthStore } from '../services/auth.js?v=20260922a';
import { liveMembers, PersonStore, getPersonName } from '../services/person.js?v=20260922a';
import { statusBadgeHtml, bindStatusBadge, badgeHtml } from './badges.js?v=20260922a';
import { persist, getAuthToken, getApiBaseUrl, getAdapter } from '../core/data-adapter.js?v=20260922a';
import { recordAgendaResultForActivity } from '../services/agenda-follow-up.js?v=20260922a';
// 制度链（2026-09-21 批次 129）：制度草案议程项在「记录结果」旁给一个「报送党员大会表决」勾选位——
// 判据单一源在 branch-doc.js（勿在界面另写一份 purpose/status 判断）。
import { isInstitutionDraftAgendaItem } from '../services/branch-doc.js?v=20260922a';
...
import { canProposeBrand, brandProposalOf, proposeBrandDesignation, withdrawBrandProposal, revokeBrandDesignation, reviewRequestOf, isReviewReturned, isReviewRequestEligibleActivity } from '../services/activity.js?v=20260922a';
...
import { createEditableAgenda, normalizeEditedAgenda } from '../services/agenda-editing.js?v=20260922a';
// 议程更新后通知全员（活动锚定，targetType/targetId 供归档联动）
import { NoticeStore } from '../services/notice.js?v=20260922a';
import { fetchVotes, submitVote } from '../services/committee-vote.js?v=20260922a';
import { optionSetOf, resolveVoterIds, OPTION_SETS, isAnonymousActivity } from '../services/vote-config.js?v=20260922a';
import { renderVoteSummary } from './vote-summary-panel.js?v=20260922a';
...
import { loadActivityReviews } from '../services/review.js?v=20260922a';
import { mockDB, OutputType, deriveOutputRoute, ReviewStatus, AttendanceStatus } from '../core/domain.js?v=20260922a';
