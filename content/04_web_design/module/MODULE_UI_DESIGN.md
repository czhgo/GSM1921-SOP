...
- 意见建议处理流程图（意见反馈处置归支委会、由支书主持支委会，关联 [常见工作场景快速指南 §意见建议反馈](../../02_institution/sop/常见工作场景快速指南.md#意见建议反馈)）
...
> **D-241 更新（2026-08-30 支书决策）**：思想汇报已决策启动数字化——党员在系统内提交文本、算法自动归档归集，系统承载；工作模板目录可含思想汇报提交入口/记录模板（待实现）。
