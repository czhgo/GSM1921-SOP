...
- **2026-09-21（支书口径 · 批次 132）**：**① 会议考勤上传位按会议类型分**（支书原话「三会，支委会规模小可以不考勤。主要就是党小组会 那就是 会议组织者；如果是党员大会，那就是纪检委员。会议和活动不一样。」＋「考勤和补课的催办、上传主体主要还是纪检委员，支书也有权上传。党课比较特殊，不属于三会的范畴（是三会一课的一课）」）——**修正 2026-09-20「会议考勤一律收归组织者」的一刀切**：**支委会不考勤**、**党课 / 支部党员大会＝纪检委员**（支书 / 副支书有权上传）、**党小组会 / 组织生活会 / 主题党日＝该场活动组织者**；制度默认值 `policy-defaults.js` 的 `attendance.noAttendanceTypes`（新立）与 `recorderByType`（随之改准）**同批同步**，设置中心「考勤记录人」与界面判据此后一致（落地 `D-558`）。**② 品牌认定＝支委/党小组组长提案 → 支委会通过后确定**（支书原话「支委/党小组组长均可以提案，支委会（如果有党小组组长则是支委扩大会）通过后确定。」）——提案权在支委层与党小组组长，确定权在支委会；系统上**取消「点一下即认定」**（落地 `D-559`）。
