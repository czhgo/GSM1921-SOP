...
import { getAppState, setState, registerRenderCallback } from '../core/state.js?v=20260807i';
import { BranchService } from '../services/runtime.js?v=20260807i';
...
import { attendanceToLong, inspectionToLong, PEOPLE, getPersonById, getPersonName } from '../mock/index.js?v=20260807i';
import { PersonPicker } from '../components/person-picker.js?v=20260807i';
import { DecisionTreeState, DECISION_TREE_CONFIGS, renderWorkflowPanel, writeActivityWithSOP } from '../services/decision-tree.js?v=20260807i';
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS, SourceType, ParticipationLevel, ReviewStatus, REVIEW_STATUS_LABELS, OutputType, deriveOutputRoute } from '../core/domain.js?v=20260807i';
import { persist } from '../core/data-adapter.js?v=20260807i';
import { loadMakeupTasks } from '../services/makeup.js?v=20260807i';
import { loadAttendanceRecords, saveAttendanceRecords } from '../services/attendance.js?v=20260807i';
import { loadInspectionRecords, saveInspectionRecords } from '../services/inspection.js?v=20260807i';
...
import { loadActivityReviews, findActivityReviewIndex, updateActivityReview, addActivityReview } from '../services/review.js?v=20260807i';
import { renderMyDispatchTab, bindMyDispatchEvents } from '../services/issues.js?v=20260807i';
import { TodoStore, TodoSourceType, seedTodos } from '../services/todo.js?v=20260807i';
