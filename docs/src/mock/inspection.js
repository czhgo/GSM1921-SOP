...
import { getPersonName } from '../services/person.js?v=20260823b';
import { ACTIVITIES } from './activities.js?v=20260823b';
import { ParticipationLevel, PARTICIPATION_LEVEL_LABELS, SourceType, SOURCE_TYPE_LABELS } from '../core/domain.js?v=20260823b';
