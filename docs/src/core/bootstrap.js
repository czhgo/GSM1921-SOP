...
import { MilestoneStore } from '../services/milestones.js?v=20260901j';
import { getAccentColors, resolveAccentRole } from './constants.js?v=20260901j';
import { CrossPageState } from './cross-page-state.js?v=20260901j';
import { getBasePath } from './utils.js?v=20260901j';
import { enhanceSelects } from '../components/custom-select.js?v=20260901j';
import { registerApiAdapter, init } from './data-adapter.js?v=20260901j';
import { ApiAdapter } from './api-adapter.js?v=20260901j';
import { getCapabilities } from './registry.js?v=20260901j';
