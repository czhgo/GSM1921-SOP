...
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS } from '../core/domain.js?v=20260922a';
...
import { ATTENDANCE_RECORDS } from '../mock/index.js?v=20260922a';
import { isInitStateActive } from './init-reset.js?v=20260922a'; // C2 修复（2026-09-08）：init 态空态不回退演示种子
import { PersonStore, getPersonById, getPersonName } from './person.js?v=20260922a';
import { getRosterStats } from './roster.js?v=20260922a';
import { loadActivities, isActivityOrganizer } from './activity.js?v=20260922a';
