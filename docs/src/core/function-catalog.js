...
// 「党建」组按 2026-09-03 支书裁定保留：T1 口径下工作皆属党建，故工作台功能统一归「党建」组（其余按页面/工作形式分组）
...
export const FUNCTION_CATALOG = [
  // ══════════ 党建 ══════════
  { id: 'activity-create', name: '活动创建', group: '党建', role: 'secretary', tab: 'calendar', desc: '支书/党小组组长创建三会一课、主题党日等活动', usage: '工作台 → 活动管理 → 写入活动 → 选模板 → 创建', related: ['agenda', 'activity-signup'], generic: true, kind: 'feature' },
  ...
  { id: 'assign', name: '赋权管理', group: '党建', role: 'secretary', tab: 'assign', desc: '支书向下委托活动写入等权限，赋权链计算知情边界', usage: '支书工作台 → 赋权管理 → 添加/撤销赋权', related: ['activity-create', 'notification'], generic: true, kind: 'feature' },
  { id: 'notification', name: '通知发布', group: '党建', role: 'secretary', tab: 'notification', desc: '发布通知，自动派生成员待办；审批类变更同步广播', usage: '支书工作台 → 通知发布', related: ['todo', 'flow-development'], generic: true, kind: 'feature' },
  { id: 'online-vote', name: '线上异步表决', group: '党建', role: 'public', desc: '支委会/支部党员大会等决策活动的线上异步表决：选项集/参与范围可配，赞成过半数可记录通过', usage: '支书创建决策活动时会议形式选「线上异步表决」→ 配置参与范围 → 委员/党员在活动详情页表态 → 支书汇总并记录决议', related: ['three-meetings', 'agenda', 'activity-create', 'flow-online-committee', 'flow-general-meeting'], generic: true, kind: 'feature' },
  ...
  { id: 'talent', name: '人才库', group: '党建', role: 'org', tab: 'talent', desc: '发展观察视图：按发展阶段分组的成员观察卡（考察摘要/思想汇报归档/发展提示；读侧不动写，档案维护在成员名册）', usage: '组织委员工作台 → 人才库', related: ['development', 'inspection'], generic: true, kind: 'feature' },
  ...
  { id: 'makeup', name: '补课制度', group: '党建', role: 'disc', tab: 'attendance', desc: '缺勤成员通过补课任务恢复考勤状态', usage: '纪检委员工作台 → 考勤管理（补课分段）→ 提交补课任务 → 完成回写考勤', related: ['attendance-mgmt', 'flow-makeup'], generic: false, kind: 'feature' },
  ...
  { id: 'thought-report', name: '思想汇报', group: '党建', role: 'member', tab: 'thought-report', desc: '成员提交思想汇报，提交即入库归档至个人档案（不设人工归档门；篇幅建议 1500 字以上，少于 1200 字触发警告审阅、不影响提交）；组织委员可查看调用，必要时打回要求补充', usage: '成员工作台 → 思想汇报 → 选期次 + 写正文 → 提交（即归档）；组织台「思想汇报」查看台账宽表（人 × 期次；篇幅提醒只给提交人本人看，组织侧不留标记）', related: ['flow-thought-report', 'talent'], generic: true, kind: 'feature' },
  { id: 'member-change', name: '成员变更审批', group: '党建', role: 'org', tab: 'development', desc: '待讨论名单统一阶段转换，经组织委员审批、支书确认后更新', usage: '议程「待讨论名单」记录通过 → 组织委员审批 → 支书确认 → 阶段更新', related: ['agenda', 'flow-development'], generic: false, kind: 'feature' },
  // ══════════ 宣传与档案 ══════════
  ...
  // ══════════ 活动与专班 ══════════
  { id: 'taskforce-create', name: '专班发起', group: '活动与专班', role: 'secretary', tab: 'taskforce', desc: '发起专班（跨小组跨职能集中推进）', usage: '支书/组长/三委员 → 专班发起', related: ['taskforce-recruit', 'flow-taskforce'], generic: true, kind: 'feature' },
  ...
  { id: 'feedback', name: '意见反馈', group: '公共', role: 'public', desc: '提交建议与问题，支书反馈并跟进处理', usage: '公共页面 → 意见反馈', related: ['notification'], generic: true, kind: 'feature' },
  ...
  // ══════════ 角色工作台 ══════════
  { id: 'ws-secretary', name: '支书工作台', group: '角色工作台', role: 'secretary', desc: '今天/待办/全局概况/活动管理/支委会会议/赋权管理/通知发布/上报党委/党小组/知情查看/支部分工/反馈管理（12 tab，副支书共台；2026-09-20 批次 105 新增「支委会会议」线上召开入口页——D-526；2026-09-14 按行为性质四组重排——工作台/我的职责/知情查看/制度与答复；支部治理收口于设置中心「支部治理」）', usage: '登录 → 支书工作台（支书/副支书）', related: ['activity-create', 'assign', 'notification', 'todo'], generic: true, kind: 'feature' },
  { id: 'ws-org', name: '组织委员工作台', group: '角色工作台', role: 'org', desc: '今天/待办/工作概况/考察上传/思想汇报/专班管理/成员名册/人才库/发展数据/知情查看/我的处置（11 tab；2026-09-15 按行为性质四组分段——工作台/我的职责/知情查看/制度与答复；思想汇报前移——D8 裁决批二 2026-09-08）', usage: '登录 → 组织委员工作台', related: ['taskforce-recruit', 'development', 'talent', 'thought-report', 'todo'], generic: true, kind: 'feature' },
  { id: 'ws-prop', name: '宣传委员工作台', group: '角色工作台', role: 'prop', desc: '今天/待办/工作概况/宣传任务/项目看板/周报报送/档案归档/知情查看/我的处置（9 tab；2026-09-15 新增「知情查看」只读知情视图、按四组分段——工作台/我的职责/知情查看/制度与答复）', usage: '登录 → 宣传委员工作台', related: ['tasks', 'branch-doc', 'weekly', 'archive', 'todo'], generic: true, kind: 'feature' },
  { id: 'ws-disc', name: '纪检委员工作台', group: '角色工作台', role: 'disc', desc: '今天/待办/工作概况/考勤管理/活动监督复盘/考察管理/知情查看/我的处置（8 tab；2026-09-15 按四组分段——工作台/我的职责/知情查看/制度与答复；2026-09-15 补课并入「考勤管理」分段、2026-09-14 批次 25 专班与活动知情合并为「知情查看」）', usage: '登录 → 纪检委员工作台', related: ['attendance-mgmt', 'makeup', 'review', 'todo'], generic: true, kind: 'feature' },
  { id: 'ws-leader', name: '党小组组长工作台', group: '角色工作台', role: 'leader', desc: '今天/待办/工作概况/活动管理/考勤上传/考察上传/组员进展（含本组复盘状态）/知情查看/我的处置（9 tab；2026-09-15 按四组分段——工作台/我的职责/知情查看/制度与答复；复盘状态并入组员进展——复盘提交已归组织者/深度参与者，D8 裁决批二 2026-09-08）', usage: '登录 → 党小组组长工作台', related: ['activity-create', 'attendance-personal', 'review', 'todo'], generic: true, kind: 'feature' },
  { id: 'ws-visitor', name: '成员工作台', group: '角色工作台', role: 'member', desc: '今天/待办/工作概况/项目分工/活动动态/考勤概况/我的考察/思想汇报/我的复盘/知情查看/我的处置（11 tab，含组织者/深度参与者承载面；2026-09-15 新增「知情查看」「我的处置」、按四组分段——工作台/我的职责/知情查看/制度与答复）', usage: '登录 → 成员工作台', related: ['homepage', 'thought-report', 'review', 'todo'], generic: true, kind: 'feature' },
  ...
  { id: 'flow-development', name: '发展党员链路', group: '党建', desc: '支委会推荐发展对象 → 党员大会表决 → 记录议程通过 → 组织委员审批 → 支书确认更新阶段', related: ['development', 'member-change', 'agenda', 'flow-inspection'], generic: true, kind: 'flow' },
