...
import { MOCK_TASKFORCES } from '../mock/index.js?v=20260922h';
import { isInitStateActive } from './init-reset.js?v=20260922h'; // C2 修复（2026-09-08）：init 态跳过演示种子兜底
import { getPersonName, liveMembers } from './person.js?v=20260922h';
import { evaluateWorkforceVotes } from './workforce.js?v=20260922h';
...
import { BRANCH_COMMISSION_ROLES } from '../core/constants.js?v=20260922h'; // 支委层应到名单单一源（勿手写）
