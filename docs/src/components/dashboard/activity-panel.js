...
import { _fmtDate, getBasePath } from '../../core/utils.js?v=20260914a';
...
import { isActivityArchived } from '../../core/constants.js?v=20260914a';
import { badgeHtml } from '../badges.js?v=20260914a';
import { deriveActivityLifecycleStatus, ACTIVITY_LIFECYCLE } from '../inspector.js?v=20260914a';
import { populateMonthSelector } from '../calendar.js?v=20260914a';
import { getCapabilities, mountCapability, getRuntimeEnv } from '../../core/registry.js?v=20260914a';
