...
import { showToast, flashHighlight } from '../core/utils.js?v=20260908d';
import { dutyCardHtml } from './workforce-duty-card.js?v=20260908d';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260908d';
import { IssueStore } from '../services/issues.js?v=20260908d';
import { AuthStore } from '../services/auth.js?v=20260908d';
import { solidAccentStyle, dotDarkVars } from '../core/constants.js?v=20260908d';
import { loadActivities } from '../services/activity.js?v=20260908d';
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260908d';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260908d';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260908d');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260908d');
