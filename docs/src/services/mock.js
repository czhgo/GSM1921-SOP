...
import { mockDB, SCHEMA_VERSION } from '../core/domain.js?v=20260811a';
import { generateId } from '../core/id.js?v=20260811a';
import { getDataSource, persist } from '../core/data-adapter.js?v=20260811a';
...
export function createActivity(data) {
  return _withDelay(() => {
    ...
    if (!newItem.assignments || newItem.assignments.length === 0) {
      import('./todo.js?v=20260811a').then(({ LifecycleTodoDeriver }) => {
