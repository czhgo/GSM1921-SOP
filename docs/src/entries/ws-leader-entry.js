...
import { getAppState, setState, registerRenderCallback } from '../core/state.js?v=20260808f';
...
import { attendanceToLong, inspectionToLong, PEOPLE, getPersonById, getPersonName } from '../mock/index.js?v=20260808f';
import { PersonPicker } from '../components/person-picker.js?v=20260808f';
import { DecisionTreeState, DECISION_TREE_CONFIGS, renderWorkflowPanel, writeActivityWithSOP } from '../services/decision-tree.js?v=20260808f';
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS, SourceType, ParticipationLevel, ReviewStatus, REVIEW_STATUS_LABELS, OutputType, deriveOutputRoute } from '../core/domain.js?v=20260808f';
import { persist } from '../core/data-adapter.js?v=20260808f';
import { loadMakeupTasks } from '../services/makeup.js?v=20260808f';
import { loadAttendanceRecords, loadActiveAttendanceRecords, saveAttendanceRecords } from '../services/attendance.js?v=20260808f';
import { loadInspectionRecords, saveInspectionRecords } from '../services/inspection.js?v=20260808f';
...
import { loadActivityReviews, findActivityReviewIndex, updateActivityReview, addActivityReview } from '../services/review.js?v=20260808f';
import { renderMyDispatchTab, bindMyDispatchEvents } from '../services/issues.js?v=20260808f';
import { TodoStore, TodoSourceType, seedTodos } from '../services/todo.js?v=20260808f';
