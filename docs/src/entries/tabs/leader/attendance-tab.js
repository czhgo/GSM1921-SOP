...
import { loadActiveAttendanceRecords, canUploadAttendance, appendAttendanceRecords, loadAttendanceAppeals, resolveAttendanceAppeal, reconfirmReturnedRecord, MEETING_ATTENDANCE_TYPES } from '../../../services/attendance.js?v=20260922d';
import { loadMakeupTasks } from '../../../services/makeup.js?v=20260922d';
...
import { attendanceToLong } from '../../../services/attendance.js?v=20260922d';
...
import { showToast, escHtml as esc, getBasePath } from '../../../core/utils.js?v=20260922d';
// ③批（支书 2026-09-06）：党小组会考勤候选 = 本组应到名单（党员非滞留）；
// 滞留者「可见但不可选」（灰态 + 「滞留」徽标 + title 备注，同纪检口径）
import { getMeetingRosterCandidates, getRosterStats } from '../../../services/roster.js?v=20260922d';
import { solidAccentStyle, accDarkVars } from '../../../core/constants.js?v=20260922d';
import { currentLeaderGroup } from './_shared.js?v=20260922d';
