...
import { ACCENT_COLORS, ACCENT_PALETTE, resolveAccentRole } from '../core/constants.js?v=20260829l';
import { getThemePreference, setThemePreference, initTheme } from '../core/theme.js?v=20260829l';
import { readLoginSnapshot } from '../core/login-snapshot.js?v=20260829l';
import { DEPLOY_MODE } from '../config/deploy.js?v=20260829l';
...
function loadAuth() {
  if (!_authModule) _authModule = import('../services/auth.js?v=20260829l');
  return _authModule;
}
function loadPopover() {
  if (!_popoverModule) _popoverModule = import('./workspace-popover.js?v=20260829l');
