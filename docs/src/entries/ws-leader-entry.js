...
import { createWorkspaceShell } from '../components/workspace-shell.js?v=20260910a';
import { renderReportEntryHtml, bindReportEntry } from '../components/reporting.js?v=20260910a';
...
import { seedTodos } from '../services/todo.js?v=20260910a';
import { filterByRole } from './tabs/leader/_shared.js?v=20260910a';
