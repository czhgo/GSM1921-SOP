...
import { escHtml as esc, _fmtDate } from '../../../core/utils.js?v=20260910a';
import { icon } from '../../../core/icons.js?v=20260910a';
import { buildTodaySummary } from '../../../services/today-summary.js?v=20260910a';
import { mockDB } from '../../../core/domain.js?v=20260910a';
import { tokenOf } from '../../../core/version-token.js?v=20260910a'; // P0 域写版本戳（spec §二.4）
import { RESIDENCE_KEY } from '../../../services/roster.js?v=20260910a'; // 滞留覆盖 raw 源（roster 禁改不内改）
