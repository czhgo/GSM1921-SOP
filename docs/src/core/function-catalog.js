...
export const FUNCTION_CATALOG = [
  ...
  // ══════════ 角色工作台 ══════════
  { id: 'ws-secretary', name: '支书工作台', group: '角色工作台', role: 'secretary', desc: '今天/待办/全局概况/活动管理/赋权管理/通知发布/上报党委/党小组/知情查看/支部分工/反馈管理（11 tab，副支书共台；2026-09-14 按行为性质四组重排——工作台/我的职责/知情查看/制度与答复；支部治理收口于设置中心「支部治理」）', usage: '登录 → 支书工作台（支书/副支书）', related: ['activity-create', 'assign', 'notification', 'todo'], generic: true, kind: 'feature' },
