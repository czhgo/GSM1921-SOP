...
import { persist, getAdapter, getAuthToken, getApiBaseUrl, getDataSource } from '../core/data-adapter.js?v=20260922i';
import { AuthStore } from './auth.js?v=20260922i';
import { NoticeStore } from './notice.js?v=20260922i';
import { resolveVoterIds } from './vote-config.js?v=20260922i';
