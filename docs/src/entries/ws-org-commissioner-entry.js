...
import { createWorkspaceShell } from '../components/workspace-shell.js?v=20260921b';
import { renderReportEntryHtml, bindReportEntry } from '../components/reporting.js?v=20260921b';
...
import { seedTodos } from '../services/todo.js?v=20260921b';
import { solidAccentStyle } from '../core/constants.js?v=20260921b';
import { openRecruitForm } from './tabs/org/taskforce-tab.js?v=20260921b';
// 副作用导入触发组织委员工作台能力注册（tab 清单；含 立项⑥B波 成员名册 tab）
import '../modules/capabilities/org-workspace.js?v=20260921b';
