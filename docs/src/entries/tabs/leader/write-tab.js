...
import { setState, getAppState } from '../../../core/state.js?v=20260922e';
import { BranchService } from '../../../services/runtime.js?v=20260922e';
import { DecisionTreeState, DECISION_TREE_CONFIGS, renderWorkflowPanel, writeActivityWithSOP, hostGroups as buildHostGroupOptions } from '../../../services/decision-tree.js?v=20260922e';
// 党小组常态清单唯一来源（活组、按 seq 升序）——承办党小组选项不再写死
import { groupOptions } from '../../../services/party-group.js?v=20260922e';
import { AuthStore } from '../../../services/auth.js?v=20260922e';
import { TodoStore, TodoSourceType } from '../../../services/todo.js?v=20260922e';
import { mockDB, OutputType, deriveOutputRoute } from '../../../core/domain.js?v=20260922e';
import { persist } from '../../../core/data-adapter.js?v=20260922e';
import { PersonPicker } from '../../../components/person-picker.js?v=20260922e';
import { recordFormShell } from '../../../components/forms.js?v=20260922e';
import { getBranchIdOfPerson, getBranchOutputBlocks, applyOutputBlockPolicy } from '../../../services/branch.js?v=20260922e';
...
import { showToast, escHtml } from '../../../core/utils.js?v=20260922e';
// 组织者的发布口（2026-09-19 批次 91 · SOP-B-17）：本人被指定为该场组织者时，本台即可发布本组通知
import { isActivityOrganizer, findActivityById, OUTDOOR_CHECKLIST, isOutdoorActivity, PUBLICITY_DRAFT_STATUS, PUBLICITY_DRAFT_LABELS, publicityDraftStatusOf, setPublicityDraftStatus } from '../../../services/activity.js?v=20260922e';
import { openModal, closeModal } from '../../../components/modal.js?v=20260922e';
import { openGroupNoticeComposer } from '../../../services/notice.js?v=20260922e';
import { solidAccentStyle, accDarkVars, accDarkParts, OUTPUT_BLOCK_DEFS, isActivityEnded, ACTIVITY_SUBTYPES, normalizeActivityType } from '../../../core/constants.js?v=20260922e';
import { filterByRole, getCurrentLeaderId, currentLeaderGroup } from './_shared.js?v=20260922e';
import { anchorDetailToTrigger } from '../../../components/detail-anchor.js?v=20260922e';
