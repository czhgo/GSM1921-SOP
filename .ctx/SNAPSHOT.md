...
date: "2026-09-10"
version: "v25"
milestone: "2026-09-11 续批（第五批）：R-12 深色对比第四轮（组件侧 10 文件 + 特批修 styles.css 真缺陷：注释内 `*/` 提前闭合致深色 .doc-card 失效，help td 1.48→11.35；再特批 about.css 两处 4.15→5.55 / 3.22→6.51） + 黑话审查第 6 轮（6 候选逐条裁定：UI「闭环」回潮清理 13 处、去「抓手」整句重写、颗粒度→分层、设置页去工程语 12 处、范式→做法、确权→成员变更确认；同族扫净确权 0 残留） + 书记新裁定「数字不硬编码」（8 条真风化 + 同族残留改动态口径，断言同步） + 新增判据入库；乙部仅余 R-13（浅色灰字 245 处存量待核）；版本串 20260911a / CODE_VERSION 103"
---
...
> **上版**: v24 (2026-09-11)
> **变更来源**: 2026-09-10/11（四批 + 本批共五批，T-077 追加批次 1~6；见 v25/v24/v23/v22/v21 里程碑行；测试/文件计数一律以实测为准）
