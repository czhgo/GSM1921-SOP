...
import { AttendanceStatus, ATTENDANCE_STATUS_LABELS } from '../../../core/domain.js?v=20260901l';
import { attendanceToLong, getPersonName } from '../../../mock/index.js?v=20260901l';
import { solidAccentStyle } from '../../../core/constants.js?v=20260901l';
import { loadAttendanceRecords, loadActiveAttendanceRecords, saveAttendanceRecords } from '../../../services/attendance.js?v=20260901l';
import { loadActivities } from '../../../services/activity.js?v=20260901l';
import { autoGenerateMakeupTask } from '../../../services/makeup.js?v=20260901l';
...
import { showToast, downloadCSV, triggerPrint, _fmtDate } from '../../../core/utils.js?v=20260901l';
import { DISC_COMMISSIONER_ID } from './_shared.js?v=20260901l';
import { HandoffStore } from '../../../services/handoff.js?v=20260901l';
