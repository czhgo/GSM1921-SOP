...
import { renderSidebar } from '../components/sidebar.js?v=20260807g';
import { renderHeader } from '../components/header.js?v=20260807g';
import { AuthStore } from '../services/auth.js?v=20260807g';
import { IssueStore } from '../services/issues.js?v=20260807g';
import { MilestoneStore } from '../services/milestones.js?v=20260807g';
import { getAccentColors, resolveAccentRole } from './constants.js?v=20260807g';
import { CrossPageState } from './cross-page-state.js?v=20260807g';
import { getBasePath } from './utils.js?v=20260807g';
import { enhanceSelects } from '../components/custom-select.js?v=20260807g';
import { registerApiAdapter, setDataSource, init } from './data-adapter.js?v=20260807g';
import { ApiAdapter } from './api-adapter.js?v=20260807g';
