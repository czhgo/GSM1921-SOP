...
import { showToast, escHtml as esc, flashHighlight } from '../../../core/utils.js?v=20260922a';
// D2 裁决批二（2026-09-08）：概况汇报区只读摘要「去待办处理」→ 定位消费（展开该答复详情并滚动到视口）
import { PendingTarget } from '../../../core/pending-target.js?v=20260922a';
import { createTodoTab, createUrgeController } from '../../../components/todo-tab-shell.js?v=20260922a';
import { TodoStore, seedTodos, TodoCategory, REALTIME_GROUP_DOMAIN, WORK_DOMAIN } from '../../../services/todo.js?v=20260922a';
import { SecretaryTodoDeriver } from '../../../services/secretary-overview.js?v=20260922a';
import { badgeHtml } from '../../../components/badges.js?v=20260922a';
import { loadAttendanceRecords, saveAttendanceRecords } from '../../../services/attendance.js?v=20260922a';
import { loadInspectionRecords, saveInspectionRecords } from '../../../services/inspection.js?v=20260922a';
import { updateActivityReview, loadActivityReviews, renderActivityReviewFormHtml, submitActivityReviewForm } from '../../../services/review.js?v=20260922a';
...
import { bumpToken } from '../../../core/version-token.js?v=20260922a'; // P0 域缓存失效（spec §二.3）
import { getPersonById, getPersonName, PersonStore } from '../../../services/person.js?v=20260922a';
import { solidAccentStyle, ROLE_LABELS, isArchiveFallbackPage } from '../../../core/constants.js?v=20260922a';
...
import { TaskForceRecordStore, createTaskforceVoteActivity, findTaskforceVoteActivity } from '../../../services/taskforce.js?v=20260922a';
import { fetchVotes } from '../../../services/committee-vote.js?v=20260922a';
import { resolveVoterIds } from '../../../services/vote-config.js?v=20260922a';
...
import { preloadMemberChangeRequests, getCachedMemberChangeRequests, buildMcBulkRows, renderMcBulkRowsHtml, bindMcBulk } from '../../../components/member-change-panel.js?v=20260922a';
import { tryDirectJump } from '../../../components/todo-jump.js?v=20260922a';
import { buildOverdueRemindGroupNow } from '../../../services/resolution-followup.js?v=20260922a';
...
import { listPendingConfirmations, decideConfirmation, shouldShowSemesterDetainedRemind, semesterDetainedWindowsLabel, MC_ACTION_LABEL } from '../../../services/member-confirmation.js?v=20260922a';
import { getDetainedMembers, getResidenceOf } from '../../../services/roster.js?v=20260922a';
...
import { setState } from '../../../core/state.js?v=20260922a';
