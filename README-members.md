...
在「思想汇报」页提交后**立刻入库归档到你的个人档案**（不需要你再操作，也不用等谁审）。篇幅**建议 1500 字以上**；**少于 1200 字会触发警告审阅**（提醒相关人看一眼），但**不影响提交**。若组织委员事后认为需要补充，会**打回并附意见**，你按意见修改后**重新提交**即可（重交同样即入库）。

### 党小组组长：本组党小组会的考勤上传位在你这里

党小组会的考勤**由该场活动的组织者上传**——本组党小组会一般由你组织，上传位就在组长台「考勤上传」页（会前可先确认应到名单）；被指定为某场活动组织者的组员，也只会多出这两个上传位。纪检委员**只读掌握**各党小组会考勤、不代传不改录。组员的进展与待答复汇报在「组员进展」页处理。
...
- **思想汇报台账也是宽表**（组织委员「思想汇报」页下半）：第一列是人、列是**期次**（新→旧，只显示最近 6 期），格子里是状态徽标（已打回·待补充 ＞ 已入库），一个人一期交了两篇会标「N 篇」；**空白格显示「—」＝这一期没交**（谁漏交一眼可见）；右上角可切**「按人 / 按期次」**（按期次＝第一列变成期次，横着看这一期谁交了、谁没交）。点格子进阅读页：单篇直达该篇，多篇进这个人的按人视图。上半是**篇幅不足一览**（少于 1200 字的汇报，逐条点进阅读页看一眼；这些汇报都已正常入库，不影响提交、不生成待办）。
...
遇到问题或改进建议，点【意见反馈】提交；被指派处理的人会在「我的处置」收到并答复（组长台在「组员进展」内答复本组组员）。**自己提交过的反馈**也在成员台「我的处置」里——认领依据是提交时留在**本机浏览器**里的随机标识：它只答「这台设备提交过什么」、与「谁提交」无关，换设备或清除浏览器数据后旧记录就认不回了。

勾「**匿名提交**」＝**对外匿名**：列表与详情一律显示「匿名」；**真实提交人只有党委在必要时可查，且每次查看都会留下记录**——党支部内部（含支书）看不到真身，支书只负责处置（「处置」与「查看真身」是两项分开的权限）。
...
| **组织委员** | 收考察记录、查看调用思想汇报（篇幅不足的看一眼、必要时打回要求补充）、统筹专班与招募、管成员名册与人才库、看发展数据 → 组织委员工作台 |
