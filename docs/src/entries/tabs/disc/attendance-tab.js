...
import { getMeetingRoster, getRosterStats, getMeetingRosterCandidates } from '../../../services/roster.js?v=20260919j';
import { solidAccentStyle, ROLE_LABELS, isActivityArchived, isActivityLive } from '../../../core/constants.js?v=20260919j';
import { loadActivities } from '../../../services/activity.js?v=20260919j';
// SOP-B-2（D-288）：考勤候选默认选中「已通过报名者」——报名名单的来源单一源 = SignupStore
import { getApprovedSignupPersonIds } from '../../../services/signup.js?v=20260919j';
import { autoGenerateMakeupTask } from '../../../services/makeup.js?v=20260919j';
import { TodoStore, TodoSourceType } from '../../../services/todo.js?v=20260919j';
import { NoticeStore } from '../../../services/notice.js?v=20260919j';
import { enhanceSelects } from '../../../components/custom-select.js?v=20260919j';
import { badgeHtml } from '../../../components/badges.js?v=20260919j';
// 统一检索引擎（支书 2026-09-13 裁定）：第一列是人的表格一律接入（关键词 + 分面；≤8 行自动不渲染检索条）
// pagerHtml = 翻页控件单一源（批次 38：全站手写翻页一律并轨；叶子件，避免与矩阵相互成环）
import { renderFilteredList, personKeyword, personFacets, roleLabelOf } from '../../../components/list-filter.js?v=20260919j';
import { pagerHtml } from '../../../components/pager.js?v=20260919j';
// 人×项目矩阵单一源（支书 2026-09-14 批次 35 裁定：宽表默认 + 矩阵推广）
import { renderRelationMatrix } from '../../../components/relation-matrix.js?v=20260919j';
import { showToast, downloadCSV, triggerPrint, _fmtDate, escHtml as esc, getBasePath } from '../../../core/utils.js?v=20260919j';
import { DISC_COMMISSIONER_ID } from './_shared.js?v=20260919j';
import { HandoffStore } from '../../../services/handoff.js?v=20260919j';
...
import { renderContent as renderMakeupContent } from './makeup-tab.js?v=20260919j';
