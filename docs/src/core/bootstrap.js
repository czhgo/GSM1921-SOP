...
import { getAccentColors, resolveAccentRole } from './constants.js?v=20260901s';
import { CrossPageState } from './cross-page-state.js?v=20260901s';
import { getBasePath } from './utils.js?v=20260901s';
import { enhanceSelects } from '../components/custom-select.js?v=20260901s';
import { registerApiAdapter, init } from './data-adapter.js?v=20260901s';
import { ApiAdapter } from './api-adapter.js?v=20260901s';
import { getCapabilities } from './registry.js?v=20260901s';
