...
import { dotDarkVars } from '../core/constants.js?v=20260915f';
import { flashHighlight, showToast } from '../core/utils.js?v=20260915f';
import { anchorDetailToTrigger } from './detail-anchor.js?v=20260915f';
