...
import { persist, getAdapter, getAuthToken, getApiBaseUrl, getDataSource } from '../core/data-adapter.js?v=20260915g';
import { AuthStore } from './auth.js?v=20260915g';
import { NoticeStore } from './notice.js?v=20260915g';
import { resolveVoterIds } from './vote-config.js?v=20260915g';
