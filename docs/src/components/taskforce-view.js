...
import { dotDarkVars } from '../core/constants.js?v=20260914a';
import { flashHighlight, showToast } from '../core/utils.js?v=20260914a';
import { anchorDetailToTrigger } from './detail-anchor.js?v=20260914a';
