...
} from '../../docs/src/core/policy-defaults.js?v=20260921f';
// 批次 47-F 第二组并入：消费点导出面（原 policy-defaults-sync.test.mjs 的导入）
import { MEETING_ATTENDANCE_TYPES } from '../../docs/src/services/attendance.js?v=20260921f';
import { WORKFORCE_VOTE_DEFAULT } from '../../docs/src/services/workforce.js?v=20260921f';
import { getOverdueRecords } from '../../docs/src/services/inspection.js?v=20260921f';
import {
  sanitizeConfigPolicyOverrides, applyBranchPolicyOverrides,
} from '../../docs/src/core/config-clean.js?v=20260921f';
import {
  savePolicyOverrides, canManagePolicyOverrides, getBranchById,
} from '../../docs/src/services/branch.js?v=20260921f';
import {
  semesterDetainedWindowsLabel,
} from '../../docs/src/services/member-confirmation.js?v=20260921f';
import {
  leaderSemesterReportTermKey, isLeaderSemesterRemindWindow,
} from '../../docs/src/entries/tabs/today/today-tab.js?v=20260921f';
