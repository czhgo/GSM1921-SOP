...
import { loadAttendanceRecords, loadActiveAttendanceRecords } from './attendance.js?v=20260912c';
import { loadActivities } from './activity.js?v=20260912c';
import { loadInspectionRecords, getOverdueRecords } from './inspection.js?v=20260912c';
import { TaskForceRecordStore } from './taskforce.js?v=20260912c';
import { loadActivityReviews, loadActiveActivityReviews } from './review.js?v=20260912c';
import { NoticeStore } from './notice.js?v=20260912c';
import { TodoStore, seedTodos, TodoCategory, TodoActionType, REALTIME_GROUP_DOMAIN, WORK_DOMAIN } from './todo.js?v=20260912c';
import { tokenOf } from '../core/version-token.js?v=20260912c'; // P0 域缓存失效（spec §二.3/§二.4）
import { PEOPLE } from '../mock/index.js?v=20260912c';
import { getPersonById } from './person.js?v=20260912c';
import { ROLE_LABELS } from '../core/constants.js?v=20260912c';
import { mockDB, AttendanceStatus, ReviewStatus } from '../core/domain.js?v=20260912c';
