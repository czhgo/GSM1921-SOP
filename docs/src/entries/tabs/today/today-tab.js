...
import { escHtml as esc, _fmtDate } from '../../../core/utils.js?v=20260921m';
import { icon } from '../../../core/icons.js?v=20260921m';
import { buildTodaySummary } from '../../../services/today-summary.js?v=20260921m';
// 批次 47-I（Q-23-41 ②，支书 2026-09-15 裁定）：本组组员进展**由服务端汇总**——
// api 态打服务端汇总接口、mock 态调同一纯函数（单一入口 `loadMemberProgress`）。
import { loadMemberProgress } from '../../../services/member-progress.js?v=20260921m';
import { resolveVisibleTargets } from '../../../services/visibility.js?v=20260921m';
import { mockDB } from '../../../core/domain.js?v=20260921m';
import { tokenOf } from '../../../core/version-token.js?v=20260921m'; // P0 域写版本戳（spec §二.4）
import { RESIDENCE_KEY } from '../../../services/roster.js?v=20260921m'; // 滞留覆盖 raw 源（roster 禁改不内改）
import { PREVIEW_KEY } from '../../../services/org-base-data-preview.js?v=20260921m'; // 基础数据预览 raw 源
import { memoizeRender } from '../../../components/memoize-render.js?v=20260921m'; // P2 渲染守卫（spec §四.1）
