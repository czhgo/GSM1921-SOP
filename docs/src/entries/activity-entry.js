...
import { SignupStore } from '../services/signup.js?v=20260910a';
import { AuthStore } from '../services/auth.js?v=20260910a';
import { getPersonById } from '../services/person.js?v=20260910a';
import { getBasePath, escHtml as esc } from '../core/utils.js?v=20260910a';
...
import { canSignup as _canSignup, renderSignupSection, renderSignupList, bindSignupEvents, roleLabel } from '../components/signup-panel.js?v=20260910a';
import { renderShareButtonHtml, bindShareButton } from '../components/share-button.js?v=20260910a';
import { renderVoteWidget } from '../components/vote-widget.js?v=20260910a';
import { fetchVotes } from '../services/committee-vote.js?v=20260910a';
