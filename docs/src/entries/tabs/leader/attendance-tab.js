...
import { loadActiveAttendanceRecords, canUploadAttendance, appendAttendanceRecords, loadAttendanceAppeals, resolveAttendanceAppeal, reconfirmReturnedRecord, MEETING_ATTENDANCE_TYPES } from '../../../services/attendance.js?v=20260921o';
import { loadMakeupTasks } from '../../../services/makeup.js?v=20260921o';
import { loadActivities } from '../../../services/activity.js?v=20260921o';
// SOP-B-2（D-288）：考勤候选默认选中「已通过报名者」——报名名单的来源单一源 = SignupStore
import { getApprovedSignupPersonIds } from '../../../services/signup.js?v=20260921o';
...
import { attendanceToLong } from '../../../services/attendance.js?v=20260921o';
import { getPersonById, getPersonName } from '../../../services/person.js?v=20260921o';
...
import { getMeetingRosterCandidates, getRosterStats } from '../../../services/roster.js?v=20260921o';
import { solidAccentStyle, accDarkVars } from '../../../core/constants.js?v=20260921o';
import { currentLeaderGroup } from './_shared.js?v=20260921o';
import { autoGenerateMakeupTask } from '../../../services/makeup.js?v=20260921o';
