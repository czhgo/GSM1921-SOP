...
import { getAccentColors, resolveAccentRole } from './constants.js?v=20260901r';
import { CrossPageState } from './cross-page-state.js?v=20260901r';
import { getBasePath } from './utils.js?v=20260901r';
import { enhanceSelects } from '../components/custom-select.js?v=20260901r';
import { registerApiAdapter, init } from './data-adapter.js?v=20260901r';
import { ApiAdapter } from './api-adapter.js?v=20260901r';
import { getCapabilities } from './registry.js?v=20260901r';
