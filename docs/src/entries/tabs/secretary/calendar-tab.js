...
import { _fmtDate, showToast } from '../../../core/utils.js?v=20260901s';
import { populateMonthSelector, renderCalendarByActivities } from '../../../components/calendar.js?v=20260901s';
import { renderInspectorFromState } from '../../../components/inspector.js?v=20260901s';
import { computeSecretaryStats } from '../../../services/roles.js?v=20260901s';
...
import { DecisionTreeState, renderWorkflowPanel, writeActivityWithSOP } from '../../../services/decision-tree.js?v=20260901s';
...
import { getPersonName, PEOPLE } from '../../../mock/index.js?v=20260901s';
import { NoticeStore } from '../../../services/notice.js?v=20260901s';
import { BranchService } from '../../../services/runtime.js?v=20260901s';
import { ACTIVITY_CLASSIFICATION, classifyActivityType, getAccentColors, resolveAccentRole, dotDarkVars } from '../../../core/constants.js?v=20260901s';
import { badgeHtml } from '../../../components/badge.js?v=20260901s';
import { collectAgendaRows } from './agenda-form.js?v=20260901s';
import { defaultVoteConfig, isDecisionScenario, resolveVoterIds } from '../../../services/vote-config.js?v=20260901s';
import { getAdapter } from '../../../core/data-adapter.js?v=20260901s';
