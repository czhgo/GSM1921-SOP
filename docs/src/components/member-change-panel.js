...
import { getAdapter } from '../core/data-adapter.js?v=20260922i';
...
import { listPendingConfirmations, decideConfirmation, MC_ACTION_LABEL } from '../services/member-confirmation.js?v=20260922i';
