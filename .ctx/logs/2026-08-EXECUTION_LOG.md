...
- **变更文件**：`content/insights/工程演进与设计方法论.md`（本次 + commit 9cffeb8）、`CLAUDE.md`（9cffeb8：H7.4 门面避讳 + H1.2 简化）、`content/insights/党支部管理与实务经验沉淀.md`（9cffeb8：经验写法重构）、`.ctx/logs/2026-08-EXECUTION_LOG.md`（本条，补记 9cffeb8）
