...
import { fetchVotes, lockVotes, votedCountOf, tallyOf } from '../services/committee-vote.js?v=20260914i';
import { optionSetOf, isAnonymousActivity } from '../services/vote-config.js?v=20260914i';
...
} from './resolution-followup-manager.js?v=20260914i';
