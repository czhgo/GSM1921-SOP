...
import { mockDB, SourceType, SOURCE_TYPE_LABELS, PARTICIPATION_LEVEL_LABELS, ParticipationLevel } from '../core/domain.js?v=20260922b';
...
import { INSPECTION_RECORDS } from '../mock/index.js?v=20260922b';
import { isInitStateActive } from './init-reset.js?v=20260922b'; // C2 修复（2026-09-08）：init 态空态不回退演示种子
import { getPersonById, getPersonName } from './person.js?v=20260922b';
import { TodoStore, TodoSourceType } from './todo.js?v=20260922b';
