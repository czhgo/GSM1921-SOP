...
import { SignupStore } from '../services/signup.js?v=20260901z';
...
import { getActivityTypeColors } from '../core/constants.js?v=20260901z';
import { badgeHtml } from '../components/badge.js?v=20260901z';
import { enhanceSelects } from '../components/custom-select.js?v=20260901z';
import { canSignup as _canSignup, renderSignupSection, renderSignupList, bindSignupEvents, roleLabel } from '../components/signup-panel.js?v=20260901z';
import { renderShareButtonHtml, bindShareButton } from '../components/share-button.js?v=20260901z';
import { renderVoteWidget } from '../components/vote-widget.js?v=20260901z';
import { fetchVotes } from '../services/committee-vote.js?v=20260901z';
