...
import { showToast, flashHighlight } from '../core/utils.js?v=20260829h';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260829h';
import { IssueStore, REPORT_CATEGORIES } from '../services/issues.js?v=20260829h';
...
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260829h';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260829h';
import { TaskForceRecordStore } from '../services/taskforce.js?v=20260829h';
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260829h';
import { PEOPLE } from '../mock/people.js?v=20260829h';
import { getPersonName } from '../mock/index.js?v=20260829h';
import { AttendanceStatus } from '../core/domain.js?v=20260829h';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260829h');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260829h');
