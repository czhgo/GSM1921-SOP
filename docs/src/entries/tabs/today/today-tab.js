...
import { escHtml as esc, _fmtDate } from '../../../core/utils.js?v=20260921g';
import { icon } from '../../../core/icons.js?v=20260921g';
import { buildTodaySummary } from '../../../services/today-summary.js?v=20260921g';
// 批次 47-I（Q-23-41 ②，支书 2026-09-15 裁定）：本组组员进展**由服务端汇总**——
// api 态打服务端汇总接口、mock 态调同一纯函数（单一入口 `loadMemberProgress`）。
import { loadMemberProgress } from '../../../services/member-progress.js?v=20260921g';
...
import { RESIDENCE_KEY } from '../../../services/roster.js?v=20260921g'; // 滞留覆盖 raw 源（roster 禁改不内改）
