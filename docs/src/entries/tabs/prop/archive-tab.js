...
import { solidAccentStyle, ARCHIVE_FALLBACK_ROLES } from '../../../core/constants.js?v=20260914o';
import { showToast, downloadCSV, downloadBlob, downloadUrl, _fmtDate, escHtml } from '../../../core/utils.js?v=20260914o';
import { persist, getAuthToken, getApiBaseUrl } from '../../../core/data-adapter.js?v=20260914o';
...
import { isApiMode } from '../../../services/runtime.js?v=20260914o';
...
import { addExternalDispatch, loadExternalDispatches } from '../../../services/external-dispatch.js?v=20260914o';
// A② 归档缺口判据单一源（支书台「宣传材料待归档」实时组同源）：已归档但无归档记录的活动
import { getArchiveGapActivities, getEndedUnarchivedActivities } from '../../../services/secretary-overview.js?v=20260914o';
// 活动归档写口（与支书台活动管理同源：软删 archived=true + 级联完成下属任务）
import { BranchService } from '../../../services/runtime.js?v=20260914o';
// 统一检索引擎（支书 2026-09-13 裁定）：第一列是活动的表格一律接入（关键词 + 分面；≤8 行自动不渲染检索条）
import { renderFilteredList } from '../../../components/list-filter.js?v=20260914o';
