// role: [工程师]+[AI]
// server/test/wizard-package.test.mjs — 支部配置 JSON 覆盖件（立项④阶段二，2026-09-06 支书裁范围）
...
// ⚠️ 对 docs/src 的相对 import 必须带与源码一致的 ?v=20260914s query（模块缓存键一致性）。
import { test, before } from 'node:test';
import assert from 'node:assert/strict';

import { mockDB } from '../../docs/src/core/domain.js?v=20260914s';
import { registerMockAdapter } from '../../docs/src/core/data-adapter.js?v=20260914s';
import {
  buildConfigPackage,
  applyConfigPackage,
  PACKAGE_KIND,
  PACKAGE_VERSION,
} from '../../docs/src/services/org-config-package.js?v=20260914s';
import { getBranchById } from '../../docs/src/services/branch.js?v=20260914s';
