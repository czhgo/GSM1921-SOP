...
import { dotDarkVars } from '../core/constants.js?v=20260913f';
import { flashHighlight, showToast } from '../core/utils.js?v=20260913f';
import { anchorDetailToTrigger } from './detail-anchor.js?v=20260913f';
