...
import { getRosterStats, getResidenceOf, RESIDENCE, saveResidenceChange } from '../../../services/roster.js?v=20260912f';
import { submitMemberChange, submitTransferOut, listPendingConfirmations } from '../../../services/member-confirmation.js?v=20260912f';
import { PARTY_GROUP_OPTIONS, DEVELOP_STAGE_OPTIONS } from '../../../services/org-base-data-preview.js?v=20260912f';
...
import { openModal, closeModal, openFormModal } from '../../../components/modal.js?v=20260912f';
// 纯逻辑（可单测）：新增表单校验 / 行内保存 diff
import { validateMemberForm, diffMemberFields } from '../../../services/roster-ui-logic.js?v=20260912f';
...
// ════════════════════════════════════════════════════════════════
//  行内保存（C 批成员变更确认复核：阶段/在册切换 → 报书记确认；分组/滞留备注维护即时生效）
// ════════════════════════════════════════════════════════════════
