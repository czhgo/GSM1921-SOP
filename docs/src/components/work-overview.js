...
import { dutyCardHtml } from './workforce-duty-card.js?v=20260922h';
import { TodoStore, seedTodos, TodoStatus } from '../services/todo.js?v=20260922h';
import { IssueStore } from '../services/issues.js?v=20260922h';
import { AuthStore } from '../services/auth.js?v=20260922h';
import { solidAccentStyle, dotDarkVars, isActivityEnded, isActivityArchived } from '../core/constants.js?v=20260922h';
import { loadActivities } from '../services/activity.js?v=20260922h';
import { loadActiveAttendanceRecords } from '../services/attendance.js?v=20260922h';
import { loadInspectionRecords, getOverdueRecords } from '../services/inspection.js?v=20260922h';
...
import { listPendingByReceiver, confirmExternalDispatch } from '../services/external-dispatch.js?v=20260922h';
...
import { renderFilteredList } from './list-filter.js?v=20260922h';
...
async function _renderOverviewDetail(container, detail, accent, onBack) {
  ...
  if (detail.kind === 'activity') {
    const { renderActivityView } = await import('./activity-view.js?v=20260922h');
    renderActivityView(host, { highlightId: detail.id, accent });
  } else {
    const { renderTaskforceView } = await import('./taskforce-view.js?v=20260922h');
