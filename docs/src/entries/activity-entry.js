...
import { SignupStore, canCloseActivitySignup, closeActivitySignup, SignupStatus } from '../services/signup.js?v=20260921i';
import { AuthStore } from '../services/auth.js?v=20260921i';
import { getPersonById } from '../services/person.js?v=20260921i';
import { getBasePath, escHtml as esc, showToast } from '../core/utils.js?v=20260921i';
import { getActivityTypeColors } from '../core/constants.js?v=20260921i';
import { getAppState } from '../core/state.js?v=20260921i';
...
import { canSignup as _canSignup, renderSignupSection, renderSignupList, bindSignupEvents, roleLabel } from '../components/signup-panel.js?v=20260921i';
import { renderShareButtonHtml, bindShareButton } from '../components/share-button.js?v=20260921i';
...
import { settleWrites } from '../core/pending-writes.js?v=20260921i';
