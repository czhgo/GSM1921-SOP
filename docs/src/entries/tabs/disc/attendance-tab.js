...
import { AttendanceStatus, ATTENDANCE_STATUS_LABELS } from '../../../core/domain.js?v=20260912h';
import { attendanceToLong, loadAttendanceRecords, loadActiveAttendanceRecords, saveAttendanceRecords, canUploadAttendance, upsertMeetingAttendance, MEETING_ATTENDANCE_TYPES as MEETING_TYPES, ABSENCE_REASONS, recorderRolesOf, listGroupMeetingAttendance } from '../../../services/attendance.js?v=20260912h';
...
import { getMeetingRoster, getRosterStats, getMeetingRosterCandidates } from '../../../services/roster.js?v=20260912h';
import { solidAccentStyle, ROLE_LABELS } from '../../../core/constants.js?v=20260912h';
import { loadActivities } from '../../../services/activity.js?v=20260912h';
import { autoGenerateMakeupTask } from '../../../services/makeup.js?v=20260912h';
import { TodoStore, TodoSourceType } from '../../../services/todo.js?v=20260912h';
import { NoticeStore } from '../../../services/notice.js?v=20260912h';
import { enhanceSelects } from '../../../components/custom-select.js?v=20260912h';
import { badgeHtml } from '../../../components/badges.js?v=20260912h';
import { showToast, downloadCSV, triggerPrint, _fmtDate, escHtml as esc } from '../../../core/utils.js?v=20260912h';
import { DISC_COMMISSIONER_ID } from './_shared.js?v=20260912h';
import { HandoffStore } from '../../../services/handoff.js?v=20260912h';
