...
import { setState, STATE, getAppState } from '../core/state.js?v=20260921o';
import { ROLE_COLORS, ROLE_LABELS, ROLE_THEME_CLASS, COMMISSIONER_ROLES, SECRETARY_ROLES, ACTIVITY_CLASSIFICATION } from '../core/constants.js?v=20260921o';
import { _fmtChinese, showToast, escHtml as esc } from '../core/utils.js?v=20260921o';
import { icon } from '../core/icons.js?v=20260921o';
import { openModal, closeModal } from './modal.js?v=20260921o';
...
import { liveMembers, PersonStore, getPersonName } from '../services/person.js?v=20260921o';
import { statusBadgeHtml, bindStatusBadge, badgeHtml } from './badges.js?v=20260921o';
import { persist, getAuthToken, getApiBaseUrl, getAdapter } from '../core/data-adapter.js?v=20260921o';
...
import { isInstitutionDraftAgendaItem } from '../services/branch-doc.js?v=20260921o';
...
import { canProposeBrand, brandProposalOf, proposeBrandDesignation, withdrawBrandProposal, revokeBrandDesignation, reviewRequestOf, isReviewReturned, isReviewRequestEligibleActivity } from '../services/activity.js?v=20260921o';
...
import { createEditableAgenda, normalizeEditedAgenda } from '../services/agenda-editing.js?v=20260921o';
// 议程更新后通知全员（活动锚定，targetType/targetId 供归档联动）
import { NoticeStore } from '../services/notice.js?v=20260921o';
import { fetchVotes, submitVote } from '../services/committee-vote.js?v=20260921o';
import { optionSetOf, resolveVoterIds, OPTION_SETS, isAnonymousActivity } from '../services/vote-config.js?v=20260921o';
import { renderVoteSummary } from './vote-summary-panel.js?v=20260921o';
import { loadAttendanceRecords } from '../services/attendance.js?v=20260921o';
import { loadInspectionRecords } from '../services/inspection.js?v=20260921o';
import { loadActivityReviews } from '../services/review.js?v=20260921o';
import { mockDB, OutputType, deriveOutputRoute, ReviewStatus, AttendanceStatus } from '../core/domain.js?v=20260921o';
