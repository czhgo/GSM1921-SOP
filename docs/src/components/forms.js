...
// 支书定调「模块统一扎口」试点：同一域可以有若干实现文件（form-field 字段积木 / form-shell 外壳），
...
export { labelHtml, errorHtml, textField, textareaField, selectField, dateField } from './form-field.js?v=20260919k';
export { recordFormShell } from './form-shell.js?v=20260919k';
