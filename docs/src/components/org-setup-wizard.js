...
import { OUTPUT_BLOCK_DEFS, BRANCH_COMMISSION_ROLES, ROLE_LABELS, getAccentColors } from '../core/constants.js?v=20260912f';
// 副作用：注册支委层工作台能力（配置目录=其 tab 清单，单一源）
import '../modules/capabilities/secretary-workspace.js?v=20260909e';
import { BLOCK_MANIFESTS } from '../workflow/blocks/manifests.js?v=20260912f';
import { escHtml as esc, showToast, downloadBlob } from '../core/utils.js?v=20260912f';
...
} from '../services/branch.js?v=20260912f';
import { buildConfigPackage, applyConfigPackage } from '../services/org-config-package.js?v=20260912f';
import {
  buildPreviewTemplate, sanitizePreview, applyPreview, clearPreview, getPreviewState,
  PREVIEW_KIND, PREVIEW_VERSION,
} from '../services/org-base-data-preview.js?v=20260912f';
import { getRosterStats, isDetained } from '../services/roster.js?v=20260912f';
import { buildOrgWizardReport } from '../services/org-wizard-report.js?v=20260912f';
...
import { appointInauguralOfficers } from '../services/appointment.js?v=20260912f';
