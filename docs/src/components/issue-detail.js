...
import { IssueStore, ISSUE_CACHE_KEY } from '../services/issues.js?v=20260915f';
...
import { renderReactions, bindReactions } from './reactions.js?v=20260915f';
import { ISSUE_STATUS_LABELS, ISSUE_CLOSED_REASON_LABELS } from '../core/constants.js?v=20260915f';
import { badgeHtml } from './badges.js?v=20260915f';
