...
import { setState, getAppState } from '../../core/state.js?v=20260912a';
import { _fmtDate, getBasePath } from '../../core/utils.js?v=20260912a';
...
import { deriveActivityLifecycleStatus, ACTIVITY_LIFECYCLE } from '../inspector.js?v=20260912a';
import { populateMonthSelector } from '../calendar.js?v=20260912a';
import { getCapabilities, mountCapability, getRuntimeEnv } from '../../core/registry.js?v=20260912a';
