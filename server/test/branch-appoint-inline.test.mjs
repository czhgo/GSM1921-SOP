...
import { registerMockAdapter, setDataSource } from '../../docs/src/core/data-adapter.js?v=20260919g';
import { createBranch, getBranchById } from '../../docs/src/services/branch.js?v=20260919g';
import { PersonStore } from '../../docs/src/services/person.js?v=20260919g';
import { appointInauguralOfficers } from '../../docs/src/services/appointment.js?v=20260919g';
