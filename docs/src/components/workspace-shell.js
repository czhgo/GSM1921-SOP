...
import { getAppState, setState, registerRenderCallback } from '../core/state.js?v=20260901n';
import { bootstrapPage } from '../core/bootstrap.js?v=20260901n';
import { renderTabBar } from './tab-bar.js?v=20260901n';
import { flashHighlight } from '../core/utils.js?v=20260901n';
import { CrossPageState } from '../core/cross-page-state.js?v=20260901n';
import { getCapabilities } from '../core/registry.js?v=20260901n';
