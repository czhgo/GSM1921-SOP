...
import { getActivityTypeColors } from '../core/constants.js?v=20260829a';
import { badgeHtml } from '../components/badge.js?v=20260829a';
import { enhanceSelects } from '../components/custom-select.js?v=20260829a';
import { canSignup as _canSignup, renderSignupSection, renderSignupList, bindSignupEvents, roleLabel } from '../components/signup-panel.js?v=20260829a';
import { renderShareButtonHtml, bindShareButton } from '../components/share-button.js?v=20260829a';
