...
import { setState, getAppState } from '../../../core/state.js?v=20260901u';
import { BranchService } from '../../../services/runtime.js?v=20260901u';
import { DecisionTreeState, DECISION_TREE_CONFIGS, renderWorkflowPanel, writeActivityWithSOP } from '../../../services/decision-tree.js?v=20260901u';
import { AuthStore } from '../../../services/auth.js?v=20260901u';
import { TodoStore, TodoSourceType } from '../../../services/todo.js?v=20260901u';
import { mockDB, AttendanceStatus, ATTENDANCE_STATUS_LABELS, SourceType, ParticipationLevel, OutputType, deriveOutputRoute } from '../../../core/domain.js?v=20260901u';
import { persist } from '../../../core/data-adapter.js?v=20260901u';
import { loadAttendanceRecords, saveAttendanceRecords } from '../../../services/attendance.js?v=20260901u';
import { loadInspectionRecords, saveInspectionRecords } from '../../../services/inspection.js?v=20260901u';
...
import { solidAccentStyle, accDarkVars, accDarkParts } from '../../../core/constants.js?v=20260901u';
import { filterByRole, getCurrentLeaderId } from './_shared.js?v=20260901u';
