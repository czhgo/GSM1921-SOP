...
import { showToast, escHtml as esc, flashHighlight } from '../../../core/utils.js?v=20260922l';
// D2 裁决批二（2026-09-08）：概况汇报区只读摘要「去待办处理」→ 定位消费（展开该答复详情并滚动到视口）
import { PendingTarget } from '../../../core/pending-target.js?v=20260922l';
import { createTodoTab, createUrgeController } from '../../../components/todo-tab-shell.js?v=20260922l';
import { TodoStore, seedTodos, TodoCategory, REALTIME_GROUP_DOMAIN, WORK_DOMAIN } from '../../../services/todo.js?v=20260922l';
import { SecretaryTodoDeriver } from '../../../services/secretary-overview.js?v=20260922l';
import { badgeHtml } from '../../../components/badges.js?v=20260922l';
import { loadAttendanceRecords, saveAttendanceRecords } from '../../../services/attendance.js?v=20260922l';
import { loadInspectionRecords, saveInspectionRecords } from '../../../services/inspection.js?v=20260922l';
import { updateActivityReview, loadActivityReviews, renderActivityReviewFormHtml, submitActivityReviewForm } from '../../../services/review.js?v=20260922l';
...
import { getPersonById, getPersonName, PersonStore } from '../../../services/person.js?v=20260922l';
import { solidAccentStyle, ROLE_LABELS, isArchiveFallbackPage } from '../../../core/constants.js?v=20260922l';
// R1-A 点⑤（2026-09-09）：强调色渲染统一 person-aware 动态解析（替代模块级 resolveAccentRole 快照）
import { getAppliedAccentColors } from '../../../core/theme.js?v=20260922l';
import { IssueStore } from '../../../services/issues.js?v=20260922l';
import { TaskForceRecordStore, createTaskforceVoteActivity, findTaskforceVoteActivity } from '../../../services/taskforce.js?v=20260922l';
import { fetchVotes } from '../../../services/committee-vote.js?v=20260922l';
import { resolveVoterIds } from '../../../services/vote-config.js?v=20260922l';
import { renderReportInboxHtml, bindReportInbox } from '../../../components/reporting.js?v=20260922l';
// 2026-09-08 裁决批一（D1/D3）：成员变更=域内确认+批量去顶卡——顶卡面板移除，
// 确认位唯一化 = 「成员发展」域实时组内批量块（buildMcBulkRows/renderMcBulkRowsHtml/bindMcBulk）。
import { preloadMemberChangeRequests, getCachedMemberChangeRequests, buildMcBulkRows, renderMcBulkRowsHtml, bindMcBulk } from '../../../components/member-change-panel.js?v=20260922l';
import { tryDirectJump } from '../../../components/todo-jump.js?v=20260922l';
import { buildOverdueRemindGroupNow } from '../../../services/resolution-followup.js?v=20260922l';
...
import { listPendingConfirmations, decideConfirmation, shouldShowSemesterDetainedRemind, semesterDetainedWindowsLabel, MC_ACTION_LABEL } from '../../../services/member-confirmation.js?v=20260922l';
import { getDetainedMembers, getResidenceOf } from '../../../services/roster.js?v=20260922l';
...
import { setState } from '../../../core/state.js?v=20260922l';
