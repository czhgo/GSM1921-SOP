...
import { loadThoughtReports } from '../../../services/thought-report.js?v=20260922i';
import { PersonStore, getPersonName } from '../../../services/person.js?v=20260922i';
// 数据域接线收口（2026-09-03）：支部成员名单经 services/person.js 获取（原直连 mock PEOPLE）
import { getResidenceOf } from '../../../services/roster.js?v=20260922i';
...
import { listPendingConfirmations, lastApprovedStageChange } from '../../../services/member-confirmation.js?v=20260922i';
import { escHtml as esc, flashHighlight, getBasePath } from '../../../core/utils.js?v=20260922i';
