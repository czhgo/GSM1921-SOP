  ...
  scenarios: [
    {
      ...
      tasks: [
        ...
        { taskId: '1a-3', title: '布置对照检查材料',    executor: 'leader',           supervisor: null,         timeOffset: -5, desc: '通知本组党员在述职回顾基础上撰写个人对照检查材料，明确检查角度与格式要求。' },
        ...
        { taskId: '1a-5', title: '签到与刚性考勤',      executor: 'disc-commissioner',supervisor: 'leader',     timeOffset:  0, desc: '执行刚性考勤（三会一课范畴）。组长发布二维码后，纪检委员同步记录到场情况。事假须提前1天申请；病假可事后补假。缺勤须记录留档。' },
        { taskId: '1a-6', title: '自评互评与组长总结',  executor: 'all',              supervisor: null,         timeOffset:  0, desc: '个人自我批评（结合述职回顾展开）→ 相互批评（要有辣味，直指问题）→ 条条组长做总结发言。' },
        ...
        { taskId: '1a-8', title: '汇总组织生活会记录',  executor: 'leader',           supervisor: null,         timeOffset:  5, desc: '党小组组长会后收集过去一年承担较多工作的骨干同志的检查材料，汇总整理形成完整的组织生活会记录（含述职摘要+对照检查精选）。 - Source: knowledge/SOP/常见工作场景快速指南.md#活动建设组织生活会严肃政治会议' },
        { taskId: '1a-9', title: '档案归档',            executor: 'prop-commissioner',supervisor: 'leader',     timeOffset:  5, desc: '宣传委员归档全部会议材料（含签到表/考勤汇总/对照检查材料/宣传底稿/组织生活会记录），T+5天完成。' },
      ],
    },
    {
