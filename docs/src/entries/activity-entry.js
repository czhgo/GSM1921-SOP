...
import { SignupStore } from '../services/signup.js?v=20260912b';
import { AuthStore } from '../services/auth.js?v=20260912b';
import { getPersonById } from '../services/person.js?v=20260912b';
import { getBasePath, escHtml as esc } from '../core/utils.js?v=20260912b';
...
import { canSignup as _canSignup, renderSignupSection, renderSignupList, bindSignupEvents, roleLabel } from '../components/signup-panel.js?v=20260912b';
import { renderShareButtonHtml, bindShareButton } from '../components/share-button.js?v=20260912b';
import { renderVoteWidget } from '../components/vote-widget.js?v=20260912b';
